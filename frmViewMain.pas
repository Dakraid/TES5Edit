...
type
  ...
  TViewNodeFlag = (vnfDontShow, vnfIgnore, vnfUseSortOrder, vnfIsSorted,
    vnfIsAligned);
  ...
  TwbPluggyLinkState = (plsNone, plsReference, plsBase, plsInventory,
    plsEnchantment, plsSpell);
  ...
  TfrmMain = class(TForm)
    ...
    procedure splElementsMouseDown(Sender: TObject; Button: TMouseButton;
    ...
    { --- edFormIDSearch --- }
    procedure edFormIDSearchKeyDown(Sender: TObject; var Key: Word;
      Shift: TShiftState);
    ...
    procedure edEditorIDSearchKeyDown(Sender: TObject; var Key: Word;
      Shift: TShiftState);

    { --- vstNav --- }
    procedure vstNavBeforeItemErase(Sender: TBaseVirtualTree;
      TargetCanvas: TCanvas; Node: PVirtualNode; ItemRect: TRect;
      var ItemColor: TColor; var EraseAction: TItemEraseAction);
    procedure vstNavChange(Sender: TBaseVirtualTree; Node: PVirtualNode);
    procedure vstNavCompareNodes(Sender: TBaseVirtualTree;
      Node1, Node2: PVirtualNode; Column: TColumnIndex; var Result: Integer);
    procedure vstNavFreeNode(Sender: TBaseVirtualTree; Node: PVirtualNode);
    procedure vstNavGetText(Sender: TBaseVirtualTree; Node: PVirtualNode;
      Column: TColumnIndex; TextType: TVSTTextType; var CellText: string);
    procedure vstNavHeaderClick(Sender: TVTHeader; HitInfo: TVTHeaderHitInfo);
    procedure vstNavIncrementalSearch(Sender: TBaseVirtualTree;
      Node: PVirtualNode; const SearchText: string; var Result: Integer);
    procedure vstNavInitChildren(Sender: TBaseVirtualTree; Node: PVirtualNode;
      var ChildCount: Cardinal);
    procedure vstNavInitNode(Sender: TBaseVirtualTree;
      ParentNode, Node: PVirtualNode;
      var InitialStates: TVirtualNodeInitStates);
    procedure vstNavPaintText(Sender: TBaseVirtualTree;
    ...
    { --- vstView --- }
    procedure vstViewAdvancedHeaderDraw(Sender: TVTHeader;
      var PaintInfo: THeaderPaintInfo; const Elements: THeaderPaintElements);
    procedure vstViewBeforeCellPaint(Sender: TBaseVirtualTree;
      TargetCanvas: TCanvas; Node: PVirtualNode; Column: TColumnIndex;
      CellPaintMode: TVTCellPaintMode; CellRect: TRect; var ContentRect: TRect);
    procedure vstViewBeforeItemErase(Sender: TBaseVirtualTree;
      TargetCanvas: TCanvas; Node: PVirtualNode; ItemRect: TRect;
      var ItemColor: TColor; var EraseAction: TItemEraseAction);
    procedure vstViewCheckHotTrack(Sender: TBaseVirtualTree;
      HotNode: PVirtualNode; HotColumn: TColumnIndex; var Allow: Boolean);
    procedure vstViewClick(Sender: TObject);
    procedure vstViewCollapsing(Sender: TBaseVirtualTree; Node: PVirtualNode;
      var Allowed: Boolean);
    procedure vstViewDblClick(Sender: TObject);
    procedure vstViewDragAllowed(Sender: TBaseVirtualTree; Node: PVirtualNode;
      Column: TColumnIndex; var Allowed: Boolean);
    procedure vstViewDragDrop(Sender: TBaseVirtualTree; Source: TObject;
      DataObject: IDataObject; Formats: TFormatArray; Shift: TShiftState;
      Pt: TPoint; var Effect: Integer; Mode: TDropMode);
    procedure vstViewDragOver(Sender: TBaseVirtualTree; Source: TObject;
      Shift: TShiftState; State: TDragState; Pt: TPoint; Mode: TDropMode;
      var Effect: Integer; var Accept: Boolean);
    procedure vstViewEditing(Sender: TBaseVirtualTree; Node: PVirtualNode;
      Column: TColumnIndex; var Allowed: Boolean);
    procedure vstViewFocusChanged(Sender: TBaseVirtualTree; Node: PVirtualNode;
      Column: TColumnIndex);
    procedure vstViewFocusChanging(Sender: TBaseVirtualTree;
      OldNode, NewNode: PVirtualNode; OldColumn, NewColumn: TColumnIndex;
      var Allowed: Boolean);
    procedure vstViewFreeNode(Sender: TBaseVirtualTree; Node: PVirtualNode);
    procedure vstViewGetEditText(Sender: TBaseVirtualTree; Node: PVirtualNode;
      Column: TColumnIndex; var CellText: string);
    procedure vstViewGetHint(Sender: TBaseVirtualTree; Node: PVirtualNode;
      Column: TColumnIndex; var LineBreakStyle: TVTTooltipLineBreakStyle;
      var HintText: string);
    procedure vstViewGetText(Sender: TBaseVirtualTree; Node: PVirtualNode;
      Column: TColumnIndex; TextType: TVSTTextType; var CellText: string);
    procedure vstViewHeaderClick(Sender: TVTHeader; HitInfo: TVTHeaderHitInfo);
    procedure vstViewHeaderDropped(Sender: TVTHeader;
      SourceColumn, TargetColumn: TColumnIndex; var Handled: Boolean);
    procedure vstViewHeaderDrawQueryElements(Sender: TVTHeader;
      var PaintInfo: THeaderPaintInfo; var Elements: THeaderPaintElements);
    procedure vstViewInitChildren(Sender: TBaseVirtualTree; Node: PVirtualNode;
      var ChildCount: Cardinal);
    procedure vstViewInitNode(Sender: TBaseVirtualTree;
      ParentNode, Node: PVirtualNode;
      var InitialStates: TVirtualNodeInitStates);
    procedure vstViewKeyDown(Sender: TObject; var Key: Word;
      Shift: TShiftState);
    procedure vstViewNewText(Sender: TBaseVirtualTree; Node: PVirtualNode;
      Column: TColumnIndex; NewText: string);
    procedure vstViewPaintText(Sender: TBaseVirtualTree;
      const TargetCanvas: TCanvas; Node: PVirtualNode; Column: TColumnIndex;
      TextType: TVSTTextType);
    ...
    { --- vstSpreadSheet --- }
    procedure vstSpreadSheetWeaponInitNode(Sender: TBaseVirtualTree;
      ParentNode, Node: PVirtualNode;
      var InitialStates: TVirtualNodeInitStates);
    procedure vstSpreadsheetArmorInitNode(Sender: TBaseVirtualTree;
      ParentNode, Node: PVirtualNode;
      var InitialStates: TVirtualNodeInitStates);
    procedure vstSpreadSheetAmmoInitNode(Sender: TBaseVirtualTree;
      ParentNode, Node: PVirtualNode;
      var InitialStates: TVirtualNodeInitStates);

    procedure vstSpreadSheetCheckHotTrack(Sender: TBaseVirtualTree;
      HotNode: PVirtualNode; HotColumn: TColumnIndex; var Allow: Boolean);
    procedure vstSpreadSheetClick(Sender: TObject);
    procedure vstSpreadSheetCompareNodes(Sender: TBaseVirtualTree;
      Node1, Node2: PVirtualNode; Column: TColumnIndex; var Result: Integer);
    procedure vstSpreadSheetDragAllowed(Sender: TBaseVirtualTree;
      Node: PVirtualNode; Column: TColumnIndex; var Allowed: Boolean);
    procedure vstSpreadSheetDragDrop(Sender: TBaseVirtualTree; Source: TObject;
      DataObject: IDataObject; Formats: TFormatArray; Shift: TShiftState;
      Pt: TPoint; var Effect: Integer; Mode: TDropMode);
    procedure vstSpreadSheetDragOver(Sender: TBaseVirtualTree; Source: TObject;
      Shift: TShiftState; State: TDragState; Pt: TPoint; Mode: TDropMode;
      var Effect: Integer; var Accept: Boolean);
    procedure vstSpreadSheetEditing(Sender: TBaseVirtualTree;
      Node: PVirtualNode; Column: TColumnIndex; var Allowed: Boolean);
    procedure vstSpreadSheetFreeNode(Sender: TBaseVirtualTree;
      Node: PVirtualNode);
    procedure vstSpreadSheetGetEditText(Sender: TBaseVirtualTree;
      Node: PVirtualNode; Column: TColumnIndex; var CellText: string);
    procedure vstSpreadSheetGetHint(Sender: TBaseVirtualTree;
      Node: PVirtualNode; Column: TColumnIndex;
      var LineBreakStyle: TVTTooltipLineBreakStyle; var HintText: string);
    procedure vstSpreadSheetGetText(Sender: TBaseVirtualTree;
      Node: PVirtualNode; Column: TColumnIndex; TextType: TVSTTextType;
      var CellText: string);
    procedure vstSpreadSheetIncrementalSearch(Sender: TBaseVirtualTree;
      Node: PVirtualNode; const SearchText: string; var Result: Integer);
    procedure vstSpreadSheetNewText(Sender: TBaseVirtualTree;
      Node: PVirtualNode; Column: TColumnIndex; NewText: string);
    procedure vstSpreadSheetPaintText(Sender: TBaseVirtualTree;
      const TargetCanvas: TCanvas; Node: PVirtualNode; Column: TColumnIndex;
      TextType: TVSTTextType);
    ...
    procedure bnMainMenuMouseDown(Sender: TObject; Button: TMouseButton;
      Shift: TShiftState; X, Y: Integer);
  ...
  protected
    ...
    function CopyInto(AsNew, AsWrapper, AsSpawnRate, DeepCopy,
      AllowOverwrite: Boolean; const aElements: TDynElements;
      aAfterCopyCallback: TAfterCopyCallback = nil): TDynElements;
    ...
    procedure ConflictLevelForContainer(const aContainer: IwbDataContainer;
      out aConflictAll: TConflictAll; out aConflictThis: TConflictThis);
    ...
    function GetUniqueLinksTo(const aNodeDatas: PViewNodeDatas;
      aNodeCount: Integer): TDynMainRecords;

    procedure InitChildren(const aNodeDatas: PViewNodeDatas;
      aNodeCount: Integer; var aChildCount: Cardinal);
    procedure InitNodes(const aNode: PVirtualNode;
      const aNodeDatas, aParentDatas: PViewNodeDatas; aNodeCount: Integer;
      aIndex: Cardinal; var aInitialStates: TVirtualNodeInitStates);
    procedure InitConflictStatus(aNode: PVirtualNode; aInjected: Boolean;
      aNodeDatas: PViewNodeDatas = nil);
    procedure InheritStateFromChildren(Node: PVirtualNode;
      NodeData: PNavNodeData);

    function NodeDatasForMainRecord(const aMainRecord: IwbMainRecord)
      : TDynViewNodeDatas;
    function NodeDatasForContainer(const aContainer: IwbDataContainer)
      : TDynViewNodeDatas;

    procedure ShowChangeReferencedBy(OldFormID: TwbFormID; NewFormID: TwbFormID;
      const ReferencedBy: TDynMainRecords; aSilent: Boolean);
    function GetTargetElement(Target: TBaseVirtualTree;
      var TargetNode: PVirtualNode; TargetColumn: Integer;
      out TargetIndex: Integer; out TargetElement: IwbElement): Boolean;
    function PerformDrop(TargetTree: TBaseVirtualTree; TargetNode: PVirtualNode;
      TargetColumn: Integer; const SourceElement: IwbElement): Boolean;
    function GetSourceElement(Source: TObject;
      out SourceElement: IwbElement): Boolean;

    function GetAddElement(out TargetNode: PVirtualNode;
      out TargetIndex: Integer; out TargetElement: IwbElement): Boolean;

    procedure ClearConflict(Sender: TBaseVirtualTree; Node: PVirtualNode;
    ...
    function AddRequiredMaster(const aMasterFile: IwbFile;
      const aTargetFile: IwbFile): Boolean;
    function AddRequiredMasters(const aSourceElement: IwbElement;
      const aTargetFile: IwbFile; aAsNew: Boolean; aSilent: Boolean = False)
      : Boolean; overload;
    function AddRequiredMasters(aMasters: TStrings; const aTargetFile: IwbFile;
      aSilent: Boolean = False): Boolean; overload;

    function CheckForErrorsLinear(const aElement: IwbElement;
      LastRecord: IwbMainRecord): IwbMainRecord;
    function CheckForErrors(const aIndent: Integer;
      const aElement: IwbElement): Boolean;

    function AddNewFileName(aFileName: string; aIsESL: Boolean)
      : IwbFile; overload;
    function AddNewFileName(aFileName: string; aTemplate: PwbModuleInfo)
      : IwbFile; overload;
    function AddNewFile(out aFile: IwbFile; aIsESL: Boolean): Boolean; overload;
    function AddNewFile(out aFile: IwbFile; aTemplate: PwbModuleInfo)
      : Boolean; overload;

    function SaveChanged(aSilent: Boolean = False;
      aShowMessageIfNothing: Boolean = False): TwbSaveResult;
    ...
    function FindNodeOrAncestorForElement(const aElement: IwbElement)
      : PVirtualNode;
    function FindNodeForElementIn(aParent: PVirtualNode;
      const aElement: IwbElement): PVirtualNode;
    ...
    function ByRefSelectionIncludesNonCopyNewRecords
      (aSelection: TDynMainRecords): Boolean;
    function ByRefSelectionIncludesAnyDeepCopyRecords
      (aSelection: TDynMainRecords): Boolean;
    function ByRefSelectionIncludesOnlyDeepCopyRecords
      (aSelection: TDynMainRecords): Boolean;
    ...
    procedure CheckHistoryRemove(const aList: IInterfaceList;
      const aMainRecord: IwbMainRecord);
    ...
    procedure ApplyScript(const aScriptName: string; aScript: string;
      aExtension: string);
    procedure ExecuteJv(const aScriptName: string; aScript: string);
    procedure CreateActionsForScripts;
    function LOOTDirtyInfo(const aInfo: TLOOTPluginInfo;
      aFileChanged: Boolean): string;
    function BOSSDirtyInfo(const aInfo: TLOOTPluginInfo): string;

    procedure PerformLongAction(const aDesc, aProgress: string;
      const aAction: TProc);
    procedure PerformActionOnSelectedFiles(const aDesc: string;
      const aAction: TProc<IwbFile>);
  ...
  private
    ...
    procedure DoSetActiveContainer(const aContainer: IwbDataContainer);
      overload;
    ...
    function ValidateCRC(const aFileName: string;
      const aValidCRCs: TDynCardinalArray; out aFileCRC: Cardinal): Boolean;

    procedure UpdateActions; override;

    procedure ApplicationMessage(var Msg: TMsg; var Handled: Boolean);
    procedure vstCreateEditor(const aElement: IwbElement;
  ...
  public
    ...
    procedure PostPluggyChange(aFormID, aBaseFormID, aInventoryFormID,
      aEnchantmentFormID, aSpellFormID: TwbFormID);
  end;
  ...
  protected
    ...
    procedure Execute; override;
  public
    constructor Create(var aList: TStringList; aFileStates: TwbFileStates = []
      ); overload;
    constructor Create(aFileName: string; aMaster: string; aLoadOrder: Integer;
      aFileStates: TwbFileStates = []); overload;
    destructor Destroy; override;
  end;
...
threadvar LastUpdate: UInt64;
ProcessMessagesLockCount:
Integer;
...
begin
  if wbShowCaption > 0 then
    if (wbCurrentAction <> '') or (wbCurrentProgress <> '') or
      (wbShowStartTime > 0) then
    begin
      t := wbCurrentProgress;
      ...
      begin
        ...
        if wbLocalStartTime <> wbStartTime then
          t := t + ', Total Elapsed Time: ' + FormatDateTime('nn:ss',
            Now - wbStartTime);
      end;
...
begin
  ...
  if LastUpdate + 500 < CurrentTick then
  begin
    if s = '' then
      if wbLastMessageAt <> 0 then
        if wbCurrentAction <> '' then
        begin
          ...
          if wbLastMessageAt + MaxMessageInterval < CurrentTick then
          begin
...
begin
  ...
  begin
    ...
    s := aElement._File.FileFormIDtoLoadOrderFormID(aElement._File.NewFormID,
      True).ToString(False);
  end;

  try
    if InputQuery('New FormID',
      'Please enter the new FormID in hex. e.g. 0404CC43. The FormID needs to be a load order corrected form ID.',
      s) then
      try
...
begin
  ...
  begin
    ...
    lBackup := wbBackupPath + ExtractFileName(aTo) + '.backup.' +
      FormatDateTime('yyyy_mm_dd_hh_nn_ss', Now);
    s := lBackup;
    i := 1;
    while FileExists(lBackup) and (i < 1000) do
    begin
      lBackup := s + '_' + i.ToString;
      Inc(i);
    end;
    if not wbDontBackup then
    begin
      // backup original file
      wbProgress('Renaming "' + lTo + '" to "' + lBackup + '".');
      if not RenameFile(lTo, lBackup) then
      begin
    ...
    begin
      ...
      if not SysUtils.DeleteFile(lTo) then
      begin
  ...
  if not RenameFile(lFrom, lTo) then
  begin
    s := 'Could not rename "' + lFrom + '" to "' + lTo + '".';
    wbProgress(s);
    if not aSilent then
      MessageBox(0, PChar('Could not rename "' + lFrom + '" to "' + lTo + '".'),
        'Error', 0);
    Exit;
  end;
...
begin
  ...
  for i := 0 to Pred(FilesToRename.Count) do
    if not DoRenameModule(FilesToRename.ValueFromIndex[i],
      FilesToRename.Names[i], False) then
      AnyError := True;

  if AnyError then
  begin
    MessageBox(0,
      PChar('One or more errors occured during renaming of saved modules.' +
      #13#13 + 'Please check the files in your data path: ' + wbDataPath),
      'Error', 0);
...
var
  Intf: IInterface;
begin
  if Assigned(BackHistory) and (BackHistory.Count > 0) then
  begin
...
var
  Intf: IInterface;
begin
  if Assigned(ForwardHistory) and (ForwardHistory.Count > 0) then
  begin
...
var
  ...
  Present: Boolean;
begin
  if not wbrequireLoadorder then
  begin
    k := aFile.LoadOrder;
    if k >= 0 then
      ...
      begin
        ...
        for j := Low(Files) to high(Files) do
          if sameText(Files[j].FileName, aFile.Masters[i, True].FileName) then
          begin
            Present := True;
            Break;
          end;
        if not Present then
        begin
          if aFile.Masters[i, True].LoadOrder = -1 then
          begin
...
function TfrmMain.AddNewFileName(aFileName: string;
  aTemplate: PwbModuleInfo): IwbFile;
var
  LoadOrder: Integer;
begin
  Result := nil;
...
begin
  ...
  Result := False;
  s := '';
  if InputQuery('New Module File', 'Filename without extension:', s) then
  begin
    if s = '' then
      Exit;
    if aIsESL then
...
function TfrmMain.AddNewFile(out aFile: IwbFile;
  aTemplate: PwbModuleInfo): Boolean;
var
  s: string;
begin
  aFile := nil;
...
function TfrmMain.AddRequiredMaster(const aMasterFile: IwbFile;
  const aTargetFile: IwbFile): Boolean;
var
  sl: TStringList;
begin
  if Assigned(aMasterFile) then
  begin
...
function TfrmMain.AddRequiredMasters(aMasters: TStrings;
  const aTargetFile: IwbFile; aSilent: Boolean = False): Boolean;
var
  sl: TStringList;
  i, j: Integer;
  WasEnabled: Boolean;
  ...
  try
    ...
    begin
      ...
      for i := 0 to Pred(sl.Count) do
        if IwbFile(Pointer(sl.Objects[i])).LoadOrder >= aTargetFile.LoadOrder
        then
          raise Exception.Create('The required master "' + sl[i] +
            '" can not be added to "' + aTargetFile.FileName +
            '" as it has a higher load order');

      Result := aSilent;
      if not Result then
        Result := MessageDlg
          ('To continue the following files need to be added to "' +
          aTargetFile.FileName + '" as masters:'#13#13 + sl.Text +
          #13'Do you want to continue?', mtConfirmation, [mbYes, mbNo],
          0) = mrYes;
      ...
      begin
        ...
        try
          ...
          if sl.Count = 1 then
            wbCurrentAction := 'Adding ' + IwbFile(Pointer(sl.Objects[0])).Name
              + ' as new master to ' + aTargetFile.Name
          else
            wbCurrentAction := 'Adding ' + sl.Count.ToString +
              ' new masters to ' + aTargetFile.Name;
          AddMessage('[' + FormatDateTime('nn:ss', Now - wbStartTime) + '] ' +
            wbCurrentAction);
          DoProcessMessages;
          ...
          AddMessage('[' + FormatDateTime('nn:ss', Now - wbStartTime) +
            '] Done adding and sorting masters.');
        finally
...
function TfrmMain.AddRequiredMasters(const aSourceElement: IwbElement;
  const aTargetFile: IwbFile; aAsNew: Boolean;
...
begin
  ...
  try
    ...
    begin
      ...
      Result := aSilent or
        (MessageDlg('To continue the following files need to be added to "' +
        aTargetFile.FileName + '" as masters:'#13#13 + sl.Text +
        #13'Do you want to continue?', mtConfirmation, [mbYes, mbNo],
        0) = mrYes);
...
{$ENDIF WIN64}
  ...
  begin
    ...
    if (PluggyLinkState = plsNone) or Assigned(PluggyLinkThread) and
      (PluggyLinkThread.Terminated) then
      FreeAndNil(PluggyLinkThread);

    if (PluggyLinkState <> plsNone) then
      if not Assigned(PluggyLinkThread) then
      begin
  ...
  begin
    ...
    try
      ...
      begin
        _File := Files[i];
        if not(csRefsBuild in _File.ContainerStates) then
        begin
          pgMain.ActivePage := tbsMessages;
  ...
  function TfrmMain.ByRefSelectionIncludesAnyDeepCopyRecords
    (aSelection: TDynMainRecords): Boolean;
  var
    i: Integer;
  ...
  function TfrmMain.ByRefSelectionIncludesNonCopyNewRecords
    (aSelection: TDynMainRecords): Boolean;
  var
    i: Integer;
    MainRecord: IwbMainRecord;
  ...
  begin
    ...
    begin
      ...
      if (Signature = 'CELL') or (Signature = 'WRLD') or (Signature = 'ROAD') or
        (Signature = 'LAND') or (Signature = 'PGRD') or (Signature = 'NAVM') or
        (Signature = 'NAVI') then
        Exit;
    end;
    Result := False;
  ...
  function TfrmMain.ByRefSelectionIncludesOnlyDeepCopyRecords
    (aSelection: TDynMainRecords): Boolean;
  begin
    Result := False;
  end;

  procedure TfrmMain.ConflictLevelForMainRecord(const aMainRecord
    : IwbMainRecord; out aConflictAll: TConflictAll;
    out aConflictThis: TConflictThis);
  ...
  var
    ...
    begin
      ...
      if not Supports(NodeDatas[0].Element, IwbMainRecord, MainRecordMaster)
      then
        Exit;
      if MainRecordMaster.Modified then
        Exit;

      if not Supports(NodeDatas[1].Element, IwbMainRecord, MainRecordOverride)
      then
        Exit;
  ...
  begin
    ...
    begin
      ...
      if (Length(NodeDatas) = 1) and not wbTranslationMode then
      begin
        aConflictAll := caOnlyOne;
        NodeDatas[0].ConflictAll := caOnlyOne;
        NodeDatas[0].ConflictThis := ctOnlyOne;
      end
      else if Length(NodeDatas) = 2 then
      begin
  ...
  procedure TfrmMain.ConflictLevelForContainer(const aContainer
    : IwbDataContainer; out aConflictAll: TConflictAll;
    out aConflictThis: TConflictThis);
  ...
  begin
    ...
    begin
      ...
      else if wbQuickShowConflicts and (Length(NodeDatas) = 2) then
      begin
        aConflictAll := caOverride;
        NodeDatas[0].ConflictAll := caOverride;
        NodeDatas[1].ConflictAll := caOverride;
      ...
      for i := Low(NodeDatas) to High(NodeDatas) do
        with NodeDatas[i] do
          if Assigned(Element) and (Element as IwbDataContainer = aContainer)
          then
            aConflictThis := NodeDatas[i].ConflictThis;
    end;
  end;

  function TfrmMain.ConflictLevelForNodeDatas(const aNodeDatas: PViewNodeDatas;
    aNodeCount: Integer; aSiblingCompare, aInjected: Boolean): TConflictAll;
  var
    Element: IwbElement;
      ...
      try
        ...
        begin
          ...
          begin
            ...
            OptionalAndMissing := OptionalAndMissing or
              (esOptionalAndMissing in Element.ElementStates);
          ...
          if (ThisPriority = cpOverride) and
            (aNodeDatas[i].ConflictThis > ctOverride) then
          ...
          2:
            begin
              ...
              if (Assigned(Element) <> Assigned(CompareElement)) or
                ...
                Result := caOverride
              else if (UniqueValues.IndexOf('') >= 0) and
                Assigned(CompareElement) and (CompareElement.SortKey[True] <> '')
              then
                Result := caOverride
              else
                Result := caConflict;
        ...
        if Result < caConflict then
          for i := 0 to Pred(aNodeCount) do
            if aNodeDatas[i].ConflictThis >= ctIdenticalToMasterWinsConflict
            then
            begin
              Result := caConflict;
              Break;
        ...
        if (Result > caNoConflict) and OptionalAndMissing and
          (ElementTypes <= [etArray, etStruct, etValue]) and
          (dtEmpty in DefTypes) and ((DefTypes - [dtEmpty]).Count = 1) and
          ((DefTypes - [dtEmpty, dtString .. dtInteger, dtFloat, dtArray,
          dtStruct]).Count = 0) then
        begin
  ...
  begin
    ...
    begin
      ...
      LeveledListEntries := MainRecord.ElementByName['Leveled List Entries']
        as IwbContainerElementRef;
      Assert(Assigned(LeveledListEntries));

      for i := 0 to Pred(LeveledListEntries.ElementCount) do
        if Supports(LeveledListEntries.Elements[i], IwbContainerElementRef,
          LeveledListEntry) and sameText(LeveledListEntry.Name,
          'LVLO - Leveled List Entry') then
        begin
      ...
      for i := Low(Entries) to High(Entries) do
        ...
        begin
          LeveledListEntry := LeveledListEntries.Assign(Low(Integer),
            Entries[i], False) as IwbContainerElementRef;
  ...
  function TfrmMain.CopyInto(AsNew, AsWrapper, AsSpawnRate, DeepCopy,
    AllowOverwrite: Boolean; const aElements: TDynElements;
    aAfterCopyCallback: TAfterCopyCallback): TDynElements;
  var
  ...
  begin
    ...
    try
      ...
      begin
        if not Elements[i].CanCopy then
        begin
          if j < 0 then
          begin
        ...
        begin
          ...
          if DeepCopy then
            if Supports(Elements[i], IwbMainRecord, MainRecord) and
              Supports(MainRecord.ChildGroup, IwbGroupRecord, GroupRecord) then
              GroupRecord.ReportRequiredMasters(sl, AsNew);
          Container := Elements[i].Container;
          while Assigned(Container) do
          begin
            Container.ReportRequiredMasters(sl, AsNew, False, True);
            if Container.ElementType = etGroupRecord then
              with Container as IwbGroupRecord do
              begin
      ...
      AllowOverwrite := AllowOverwrite and
        (not(AsNew or AsWrapper or AsSpawnRate));

      PrevOverwriteResult := mrNone;
      PrevDeleteResult := mrNone;

      if AllowOverwrite then
        _wbCanOverwriteCallback :=
          function(const aTarget, aSource: IwbElement): TwbCanOverwriteAction
          var
            MainRecord: IwbMainRecord;
            s: string;
          begin
            ...
            begin
              case PrevOverwriteResult of
                ...
                PrevOverwriteResult :=
                  MessageDlg('Do you want to overwrite:' + CRLF + CRLF +
                  aTarget.FullPath + CRLF + CRLF + 'with' + CRLF + CRLF +
                  aSource.FullPath + '?', mtConfirmation,
                  mbYesNo + mbYesAllNoAllCancel, 0, mbNo);
                if PrevOverwriteResult in [mrYes, mrYesToAll] then
                  Result := coCopy
                else
                  Result := coSkip;
                if PrevOverwriteResult = mrCancel then
                begin
                  wbProgress('Aborting...');
                  Abort;
                end;
              ...
              if Supports(aSource, IwbMainRecord, MainRecord) then
                ...
                begin
                  case PrevDeleteResult of
                    ...
                    if Assigned(aTarget) then
                      s := 'The source' + CRLF + CRLF + aSource.FullPath + CRLF
                        + CRLF + 'is flagged as deleted. Do you want to remove the target '
                        + CRLF + CRLF + aTarget.FullPath + CRLF + CRLF +
                        'instead of copying the deleted record?'
                    else
                      s := 'The source' + CRLF + CRLF + aSource.FullPath + CRLF
                        + CRLF + 'is flagged as deleted, and the target doesn''t exist.'
                        + CRLF + CRLF +
                        'Do you want to skip copying this record?';
                    PrevDeleteResult := MessageDlg(s, mtConfirmation,
                      mbYesNo + mbYesAllNoAllCancel, 0, mbNo);
                    if PrevDeleteResult in [mrYes, mrYesToAll] then
                      Result := coDelete;
                    if PrevDeleteResult = mrCancel then
                    begin
                      wbProgress('Aborting...');
                      Abort;
                    end;
            ...
            case Result of
              coCopy:
                if Assigned(aTarget) then
                  wbProgress('Overwriting "%s" with "%s"',
                    [aTarget.FullPath, aSource.FullPath]);
              coDelete:
                if Assigned(aTarget) then
          ...
          try
            with TfrmModuleSelect.Create(Self) do
              try

                AllModules := wbModulesByLoadOrder(True).FilteredByFlag(mfValid)
                  .FilteredBy(
                  function(a: PwbModuleInfo): Boolean
                  begin
                ...
                Multiple := (Length(Elements) > 1) or
                  (Elements[0].ElementType <> etMainRecord);
                EditorID := '';
                ...
                begin
                  ...
                  begin
                    if not AllowOverwrite then
                      AllModules := AllModules.FilteredBy(
                        function(a: PwbModuleInfo): Boolean
                        var
                          i: Integer;
                        begin
                          ...
                          begin
                            ...
                            if Result then
                              for i := 0 to Pred(Master.OverrideCount) do
                              begin
                                Result := not a._File.Equals(Master.Overrides
                                  [i]._File);
                                if not Result then
                                  Exit;
                              end;
                  ...
                  begin
                    ...
                    repeat
                      if AsWrapper then
                      begin
                        if not InputQuery('EditorID',
                          'Please enter the EditorID for the wrapped copy',
                          EditorID) then
                          Exit;
                      end
                      else
                      begin
                        if not InputQuery('EditorID',
                          'Please change the EditorID', EditorID) then
                          Exit;
                      end;
                      if EditorID = '' then
                        Break;
                      ...
                      if AsWrapper then
                        ShowMessage
                          ('You need to specify a different EditorID for the wrapped copy.')
                      else if MessageDlg
                        ('Are you sure you don''t want to change the EditorID?'
                ...
                PerformLongAction(Operation, '',
                  ...
                  begin
                    ...
                    begin
                      if mfTemplate in SelectedModules[i].miFlags then
                      begin
                        TargetFile := nil;
                        ...
                        if Assigned(TargetFile) then
                          _PreviousCopyIntoSelectedModules[i] :=
                            TargetFile.ModuleInfo;
                      end
                      else
                      ...
                      begin
                        ...
                        begin
                          ...
                          if DeepCopy then
                            if Supports(Elements[j], IwbMainRecord, MainRecord)
                              and Supports(MainRecord.ChildGroup,
                              IwbGroupRecord, GroupRecord) then
                              GroupRecord.ReportRequiredMasters(sl, AsNew);
                          ...
                          begin
                            ...
                            if Container.ElementType = etGroupRecord then
                              ...
                              begin
                                ...
                                begin
                                  MainRecord :=
                                    MainRecord.HighestOverrideVisibleForFile
                                    [TargetFile];
                                  MainRecord.ReportRequiredMasters(sl, AsNew);
                                end;
                              end;
                      ...
                      if Assigned(TargetFile) and AddRequiredMasters(sl,
                        TargetFile, mfTemplate in SelectedModules[i].miFlags)
                      then
                      begin
                        ...
                        begin
                          ...
                          begin
                            ...
                            wbCurrentProgress := Format('[%s] into [%s]',
                              [MainRecord.FullPath, TargetFile.FullPath]);
                            wbProgress(Operation + ' ' + wbCurrentProgress);

                            MainRecord2 := wbCopyElementToFile(MainRecord,
                              TargetFile, True, True, EditorIDPrefixRemove,
                              EditorIDPrefix, EditorIDSuffix, False)
                              as IwbMainRecord;
                            wbProgress('');
                            ...
                            EditorID := MainRecord.EditorID;
                            MainRecord := wbCopyElementToFile(MainRecord,
                              TargetFile, False, False, '', '', '',
                              AllowOverwrite) as IwbMainRecord;
                            wbProgress('');
                            Assert(Assigned(MainRecord));
                            MainRecord.Assign(Low(Integer), nil, False);
                            LeveledListEntries := MainRecord.ElementByName
                              ['Leveled List Entries']
                              as IwbContainerElementRef;
                            Assert(Assigned(LeveledListEntries));
                            Assert(LeveledListEntries.ElementCount = 1);
                            LeveledListEntry := LeveledListEntries.Elements[0]
                              as IwbContainerElementRef;
                            Assert(Assigned(LeveledListEntry));
                            LeveledListEntry.ElementByName['Reference']
                              .EditValue := MainRecord2.EditValue;
                            LeveledListEntry.ElementByName['Count']
                              .EditValue := '1';
                            LeveledListEntry.ElementByName['Level']
                              .EditValue := '1';
                        ...
                        begin
                          for j := Low(Elements) to High(Elements) do
                            try
                              if DeepCopy and Supports(Elements[j],
                                IwbMainRecord, MainRecord) and
                                Assigned(MainRecord.ChildGroup) then
                              begin
                                wbProgress(Operation + ' ' + wbCurrentProgress);
                                lResult[j] :=
                                  wbCopyElementToFile(MainRecord.ChildGroup,
                                  TargetFile, AsNew, True, EditorIDPrefixRemove,
                                  EditorIDPrefix, EditorIDSuffix,
                                  AllowOverwrite);
                                wbProgress('');
                              end
                              else
                              begin
                                wbCurrentProgress := Format('[%s] into [%s]',
                                  [Elements[j].FullPath, TargetFile.FullPath]);
                                wbProgress(Operation + ' ' + wbCurrentProgress);
                                CopiedElement :=
                                  wbCopyElementToFile(Elements[j], TargetFile,
                                  AsNew, True, EditorIDPrefixRemove,
                                  EditorIDPrefix, EditorIDSuffix,
                                  AllowOverwrite);
                                wbProgress('');
                              ...
                              on E: EAbort do
                                raise;
                              on E: Exception do
                                wbProgress('Error while copying [%s]: [%s] %s',
                                  [Elements[j].FullPath, E.ClassName,
                                  E.Message]);
                            end;
                        end
                        else
                        begin
                          MainRecord := nil;
                          if DeepCopy and Supports(Elements[0], IwbMainRecord,
                            MainRecord) and Assigned(MainRecord.ChildGroup) then
                          begin
                            wbCurrentProgress := Format('[%s] into [%s]',
                              [MainRecord.ChildGroup.FullPath,
                              TargetFile.FullPath]);
                            wbProgress(Operation + ' ' + wbCurrentProgress);
                            lResult[0] :=
                              wbCopyElementToFile(MainRecord.ChildGroup,
                              TargetFile, AsNew, True, '', '', '',
                              AllowOverwrite);
                            wbProgress('');
                          end
                          else
                          begin
                            wbCurrentProgress := Format('[%s] into [%s]',
                              [Elements[0].FullPath, TargetFile.FullPath]);
                            wbProgress(Operation + ' ' + wbCurrentProgress);
                            CopiedElement := wbCopyElementToFile(Elements[0],
                              TargetFile, AsNew, True, '', '', '',
                              AllowOverwrite);
                            wbProgress('');
                            if Assigned(CopiedElement) then
                            ...
                            if not Supports(CopiedElement, IwbMainRecord,
                              MainRecord) then
                              MainRecord := nil;
                          end;
    ...
    function TfrmMain.CheckForErrorsLinear(const aElement: IwbElement;
    LastRecord: IwbMainRecord): IwbMainRecord;
    var
      Error: string;
      Container: IwbContainerElementRef;
    ...
    begin
      ...
      begin
        ...
        begin
          Inc(ErrorsCount);
          wbCurrentProgress := Format('Processed Records: %d, Errors found: %d',
            [CheckedCount, ErrorsCount]);
    ...
    function TfrmMain.CheckForErrors(const aIndent: Integer;
    const aElement: IwbElement): Boolean;
    var
      Error: string;
      Container: IwbContainerElementRef;
    ...
    begin
      ...
      begin
        Error := aElement.Check;
        wbProgress(StringOfChar(' ', aIndent * 2) + aElement.Name +
          ' -> ' + Error);
      end
      else
        wbProgress('');
      ...
      if Supports(aElement, IwbContainerElementRef, Container) then
        for i := Pred(Container.ElementCount) downto 0 do
          Result := CheckForErrors(aIndent + 1, Container.Elements[i])
            or Result;

      if Result and (Error = '') then
      begin
        wbProgress(StringOfChar(' ', aIndent * 2) +
          'Above errors were found in :' + aElement.Name);
      end;
    end;

    procedure TfrmMain.CheckHistoryRemove(const aList: IInterfaceList;
    const aMainRecord: IwbMainRecord);
    var
      i: Integer;
      Intf: IInterface;
    ...
    procedure TfrmMain.mniNavCheckForCircularLeveledListsClick(Sender: TObject);
      ...
      begin
        ...
        for i := 0 to Pred(aGroup.ElementCount) do
          if Supports(aGroup.Elements[i], IwbMainRecord, MainRecord) then
            try
    ...
    begin
      ...
      PerformLongAction('Checking for Errors', '',
        procedure
        var
          Nodes: TNodeArray;
          NodeData: PNavNodeData;
        ...
        begin
          ...
          begin
            ...
            if Assigned(NodeData) then
              ...
              begin
                wbCurrentAction := 'Checking for Errors in ' +
                  NodeData.Container.Name;
                wbProgress(wbCurrentAction);
                CheckForErrorsLinear(NodeData.Container, nil)
              end
              else if Assigned(NodeData.Element) then
              begin
                wbCurrentAction := 'Checking for Errors in ' +
    ...
    begin
      ShowMessage
        ('This function has been made obsolete by the introduction of Quick Auto Clean mode.'
        + CRLF + CRLF +
    ...
    begin
      ...
      PerformActionOnSelectedFiles('cleaning masters',
        procedure(aFile: IwbFile)
        begin
          aFile.CleanMasters;
        end);
    end;
    ...
    begin
      ...
      with odModule do
      begin
        Title := 'Please select the file you want to compare to "' +
          _File.FileName + '"...';
        FileName := '';
        InitialDir := Settings.ReadString('CompareTo', 'InitialDir',
          wbDataPath);
        if not Execute then
          Exit;

        CompareFile := FileName;
        Settings.WriteString('CompareTo', 'InitialDir',
          ExtractFilePath(CompareFile));
        Settings.UpdateFile;
        ...
        if not sameText(ExtractFilePath(CompareFile), fPath) or
          (mfHasFile in wbModuleByName(ExtractFileName(CompareFile)).miFlags)
        then
        begin
          s := fPath + ExtractFileName(CompareFile);
          if FileExists(s) or (mfHasFile in wbModuleByName(ExtractFileName(s))
            .miFlags) then // Finds a unique name
            for i := 0 to 255 do
            begin
              s := fPath + ChangeFileExt
                (ChangeFileExt(ExtractFileName(CompareFile), '') + IntToHex(i,
                3), ExtractFileExt(CompareFile));
              if not(FileExists(s) or
                (mfHasFile in wbModuleByName(ExtractFileName(s)).miFlags)) then
                Break;
            end;
          if FileExists(s) or (mfHasFile in wbModuleByName(ExtractFileName(s))
            .miFlags) then
      ...
      wbStartTime := Now;
      TLoaderThread.Create(CompareFile, _File.FileName,
        _File.LoadOrder, States);
    end;
    ...
    begin
      ...
      with odModule do
      begin
        Title := 'Please select a newer verion of "' + _File.FileName +
          '" to create a delta patch...';
        FileName := '';
        InitialDir := Settings.ReadString('CreateDeltaPatch', 'InitialDir',
          wbDataPath);
        if not Execute then
          Exit;

        CompareFile := FileName;
        Settings.WriteString('CreateDeltaPatch', 'InitialDir',
          ExtractFilePath(CompareFile));
        Settings.UpdateFile;

        if not wbIsPlugin(CompareFile) then
        begin
          ShowMessage('Delta patch can only be created for modules');
          Exit;
        end;
        ...
        repeat
          if not InputQuery('Delta Patch Filename',
            'Please specify the name of the delta patch (without extension)', s)
          then
            Exit;
    ...
    begin
      ...
      try
        for i := Low(Files) to High(Files) do
          if Supports(Files[i].GroupBySignature['IDLE'], IwbContainerElementRef,
            Container) then
          begin
            for j := 0 to Pred(Container.ElementCount) do
              if Supports(Container.Elements[j], IwbMainRecord, MainRecord) then
              begin
                MainRecord := MainRecord.WinningOverride;
                if not MainRecord.IsTagged then
                begin
                  MainRecord.Tag;
                  s := Trim(LowerCase((MainRecord.ElementEditValues
                    ['MODL\MODL'])));
        ...
        with TfrmFileSelect.Create(nil) do
          try
            ...
            for i := 0 to Pred(CheckListBox1.Items.Count) do
              ...
              begin
                ...
                repeat
                  if not InputQuery('Model Prefix',
                    'Please change the model prefix', NewModelPrefix) then
                    Exit;
                until not sameText(OldModelPrefix, NewModelPrefix);

                NewElements := CopyInto(True, False, False, True, False,
                  OldElements);
                ...
                for j := Low(NewElements) to High(NewElements) do
                begin
                  if not Supports(OldElements[j], IwbMainRecord, OldMainRecord)
                  then
                    Assert(False);
                  if not Supports(NewElements[j], IwbMainRecord, NewMainRecord)
                  then
                    Assert(False);
                ...
                begin
                  ...
                  s := Trim(LowerCase((NewMainRecord.ElementValues
                    ['MODL\MODL'])));
                  s := NewModelPrefix + Copy(s, Succ(Length(OldModelPrefix)),
                    High(Integer));
                  NewMainRecord.ElementEditValues['MODL\MODL'] := s;

                  for k := Low(OldFormIDs) to High(OldFormIDs) do
                    NewMainRecord.CompareExchangeFormID(OldFormIDs[k],
                      NewFormIDs[k]);
                end;
              end;
          finally
    ...
    begin
      ...
      begin
        NodeData := vstNav.GetNodeData(SelectedNodes[i]);
        if NodeData.Element.CanCopy then
        begin
      ...
      CopyInto(Sender = mniNavCopyAsNewRecord, Sender = mniNavCopyAsWrapper,
        Sender = mniNavCopyAsSpawnRateOverride,
        (Sender = mniNavDeepCopyAsOverride) or
        (Sender = mniNavDeepCopyAsOverrideWithOverwriting),
        (Sender = mniNavCopyAsOverrideWithOverwrite) or
        (Sender = mniNavDeepCopyAsOverrideWithOverwriting), Elements);

      for i := Low(SelectedNodes) to High(SelectedNodes) do
        vstNav.IterateSubtree(SelectedNodes[i], ClearConflict, nil);
      InvalidateElementsTreeView(SelectedNodes);
      PostResetActiveTree;
      if (Length(Elements) > 1) or (Elements[0].ElementType <> etMainRecord)
      then
        vstNav.Invalidate;
    end;
    ...
    var
      ...
      procedure UpdateOrderedTargetList(LeftList, RightList,
      ...
      begin
            ...
            1 .. High(Integer):
              begin
                if not TargetList.Find(RightList[Right], Index) then
                  TargetList.AddObject(RightList[Right],
                    RightList.Objects[Right]);
                Inc(Right);
              end;
          end;

        while (Left < LeftList.Count) do
        begin
          if TargetList.Find(LeftList[Left], Index) then
            TargetList.Delete(Index);
          Inc(Left);
        ...
        while (Right < RightList.Count) do
        begin
          if not TargetList.Find(RightList[Right], Index) then
      ...
      function ListsEqual(Left, Right: TStringList;
      ForOrderedList: Boolean = False): Boolean;
      var
        i: Integer;
      begin
        ...
        if Result then
          for i := 0 to Pred(Left.Count) do
            if not sameText(Left[i], Right[i]) then
            begin
              Result := False;
              Exit;
            end;
      ...
      procedure CheckGroup(const aGroup: IwbGroupRecord;
      const aListNames: array of string; const aCntNames: array of string;
      aAsSet: Boolean = False);
      var
        ...
        begin
          ...
          try
            if aAsSet and not IsOrderedList then
            begin
              Result.Sorted := True;
            ...
            for i := 0 to Pred(Entries.ElementCount) do
              if Supports(Entries.Elements[i], IwbContainerElementRef, Entry)
              then
              begin
        ...
        for i := 0 to Pred(aGroup.ElementCount) do
          if Supports(aGroup.Elements[i], IwbMainRecord, MainRecord) then
            try
              ...
              begin
                IsOrderedList := False;
                if Supports(Master.ElementByName[aListNames[l]],
                  IwbSortableContainer, SortableContainer) then
                  if not SortableContainer.Sorted then
                  begin
                    EditorID := Master.EditorID;
                    if Length(EditorID) > Length(OrderedList) then
                      Delete(EditorID, 1, Length(EditorID) -
                        Length(OrderedList));
                ...
                TargetLists[l] :=
                  BuildList(Master.ElementByName[aListNames[l]]);
                for j := 0 to Pred(Master.OverrideCount) do
                begin
                  MainRecord := Master.Overrides[j];
                  CurrentList :=
                    BuildList(MainRecord.ElementByName[aListNames[l]]);
                  CurrentMasters :=
                    MainRecord.MasterRecordsFromMasterFilesAndSelf;
                  CurrentMaster := nil;
                  for k := High(CurrentMasters) downto Low(CurrentMasters) do
                    if not MainRecord.Equals(CurrentMasters[k]) then
                    begin
                  ...
                  if not Assigned(CurrentMaster) then
                    Continue;
                  CurrentMasterList :=
                    BuildList(CurrentMaster.ElementByName[aListNames[l]]);

                  if IsOrderedList then
                  begin
                    if not ListsEqual(CurrentMasterList, CurrentList, True) then
                    begin
                      ListsEqual(CurrentMasterList, CurrentList, True);
                      IsFaultyOrderedList := True
                    end
                    else
                      UpdateOrderedTargetList(CurrentMasterList, CurrentList,
                        TargetLists[l]);
                  end
                  else
                    UpdateTargetList(CurrentMasterList, CurrentList,
                      TargetLists[l]);
              ...
              if IsFaultyOrderedList then
              begin
                PostAddMessage('Error: Can''t merge faulty ordered list ' +
                  Master.Name);
              end
              else
              begin
                ...
                for l := Low(aListNames) to High(aListNames) do
                  if Assigned(TargetLists[l]) and Assigned(WinningLists[l]) then
                    if not ListsEqual(TargetLists[l], WinningLists[l]) then
                    begin
                      if not Assigned(TargetRecord) then
                        TargetRecord := wbCopyElementToFile(MainRecord,
                          TargetFile, False, True, '', '', '', False)
                          as IwbMainRecord;

                      TargetRecord.RemoveElement(aListNames[l]);
                      for j := 0 to Pred(TargetLists[l].Count) do
                        wbCopyElementToRecord
                          (IwbElement(Pointer(TargetLists[l].Objects[j])),
                          TargetRecord, True, True);

                      // update counts
                      if (l <= High(aCntNames)) and (aCntNames[l] <> '') then
                      begin
                        TargetRecord.Add(aCntNames[l], True);
                        CountElement := TargetRecord.ElementByPath
                          [aCntNames[l]];
                        if Assigned(CountElement) then
                          if Supports(TargetRecord.ElementByName[aListNames[l]],
                            IwbContainerElementRef, Entries) then
    ...
    begin
      ...
      begin
        if MessageDlg('Merged patch is unsupported for ' + wbGameName2 +
          ...
          + 'Do you want to continue?', mtWarning, mbYesNo, 0) <> mrYes then
          Exit;
      end;
      ...
      try
        ...
        for i := Low(Files) to Pred(High(Files)) do
          with Files[i] do
            if LoadOrder > LastLoadOrder then
            begin
      ...
      try
        ...
        for i := Succ(Low(Files)) to Pred(High(Files)) do
          with Files[i] do
          begin
            ...
            CheckGroup(GroupBySignature['CREA'], ['Items', 'Factions'],
              ['COCT']);
            ...
            if wbGameMode >= gmTES5 then
              CheckGroup(GroupBySignature['NPC_'],
                ['Items', 'Factions', 'Actor Effects', 'Perks',
                'KWDA - Keywords'], ['COCT', '', 'SPCT', 'PRKZ', 'KSIZ'])
            else
              CheckGroup(GroupBySignature['NPC_'],
            ...
            if wbGameMode >= gmTES5 then
            begin
              CheckGroup(GroupBySignature['ALCH'], ['KWDA - Keywords'],
                ['KSIZ']);
              CheckGroup(GroupBySignature['ARMO'], ['KWDA - Keywords'],
                ['KSIZ']);
              CheckGroup(GroupBySignature['AMMO'], ['KWDA - Keywords'],
                ['KSIZ']);
              CheckGroup(GroupBySignature['BOOK'], ['KWDA - Keywords'],
                ['KSIZ']);
              CheckGroup(GroupBySignature['FLOR'], ['KWDA - Keywords'],
                ['KSIZ']);
              CheckGroup(GroupBySignature['FURN'], ['KWDA - Keywords'],
                ['KSIZ']);
              CheckGroup(GroupBySignature['INGR'], ['KWDA - Keywords'],
                ['KSIZ']);
              CheckGroup(GroupBySignature['MGEF'], ['KWDA - Keywords'],
                ['KSIZ']);
              CheckGroup(GroupBySignature['MISC'], ['KWDA - Keywords'],
                ['KSIZ']);
              CheckGroup(GroupBySignature['SCRL'], ['KWDA - Keywords'],
                ['KSIZ']);
              CheckGroup(GroupBySignature['SLGM'], ['KWDA - Keywords'],
                ['KSIZ']);
              CheckGroup(GroupBySignature['SPEL'], ['KWDA - Keywords'],
                ['KSIZ']);
              CheckGroup(GroupBySignature['WEAP'], ['KWDA - Keywords'],
                ['KSIZ']);
            end;
          end;
    ...
    begin
      ...
      Modules := nil;
      if Sender = mniViewCreateModGroup then
      begin
      ...
      AddCRCs := MessageDlg('Do you want to include the current CRC32s?',
        mtConfirmation, [mbYes, mbNo], 0) = mrYes;
      SetLength(lModGroup.mgItems, j);
      for i := Low(Modules) to High(Modules) do
        with lModGroup.mgItems[i] do
        begin
          mgiModule := Modules[i];
      ...
      with TfrmModGroupEdit.Create(Self) do
        try
          ModGroup := @lModGroup;
          AllowCancel;
      ...
      with TfrmModuleSelect.Create(Self) do
        try
          ...
          AllowCancel;
          Caption :=
            'In which module''s .modgroups file should the new ModGroup be stored?';
          MaxSelect := 1;
          MinSelect := 1;
          repeat
            AllModules.ExcludeAll(mfTagged);
          ...
          FileName := wbDataPath + ChangeFileExt(SelectedModules[0].miName,
            '.modgroups');
          with TStringList.Create do
            try
    ...
    begin
      ...
      begin
        ...
        if Assigned(NodeData.Element) and (NodeData.Element.ElementType = etFile)
        then
        begin
          SetLength(FormIDs, 0);
          ...
          begin
            for n := 0 to Pred(Group.ElementCount) do
              if Supports(Group.Elements[n], IwbMainRecord, MainRecord) then
              begin
                ...
                if Assigned(QustFlags) and (QustFlags.NativeValue and 1 > 0)
                then
                  if not Assigned(MainRecord.Master) or
                    (MainRecord.Master.ElementNativeValues['DNAM\Flags'] and
                    1 = 0) then
                  begin
          ...
          if Length(FormIDs) = 0 then
            PostAddMessage('Skipped: ' + _File.FileName +
              ' doesn''t need sequence file')
          else
            try
              try
                p := wbDataPath + 'Seq\';
                if not DirectoryExists(p) then
                  if not ForceDirectories(p) then
                    raise Exception.Create
                      ('Unable to create SEQ directory in game''s Data');
                s := p + ChangeFileExt(_File.FileName, '.seq');
                FileStream := TBufferedFileStream.Create(s, fmCreate);
                FileStream.WriteBuffer(FormIDs[0],
                  Length(FormIDs) * SizeOf(Cardinal));
      ...
      PostAddMessage('[Create SEQ file done] Processed Plugins: ' +
        IntToStr(Count) + ', Sequence Files Created: ' + IntToStr(j));
    end;
    ...
    begin
      ...
      with TfrmModGroupSelect.Create(Self) do
        try
          ...
          if MessageDlg
            ('Are you sure you want to delete the following ModGroups?' + CRLF +
            CRLF + SelectedModGroups.ToString + CRLF + CRLF +
            'This can not be undone!', mtConfirmation, mbYesNo, 0, mbNo) <> mrYes
          then
            Exit;

          for i := Low(SelectedModGroups) to High(SelectedModGroups) do
            with SelectedModGroups[i]^ do
              with TMemIniFile.Create(mgModGroupsFile.mgfFileName) do
                try
                  EraseSection(mgName);
                  UpdateFile;
                finally
    ...
    begin
      ...
      with TfrmModGroupEdit.Create(Self) do
        try
          ModGroup := @lModGroup;
          AllowCancel;
          Caption := 'Editing ModGroup "' + ModGroup.mgName + '" from "' +
            ModGroup.mgModGroupsFile.mgfFileName + '"...';
          if ShowModal <> mrOK then
            Exit;
        finally
          Free;
      ...
      sl := TStringList.Create;
      try
        with TMemIniFile.Create(pModGroup.mgModGroupsFile.mgfFileName) do
          try
    ...
    begin
      ...
      begin
        NodeData := vstNav.GetNodeData(SelectedNodes[i]);
        if Assigned(NodeData.Element) and
          (NodeData.Element.ElementType = etMainRecord) then
        begin
          InjectionSourceFiles := NodeData.Element.InjectionSourceFiles;
          if Length(InjectionSourceFiles) = 1 then
          begin
            if not Assigned(ReferenceFile) then
              ReferenceFile := InjectionSourceFiles[0]
            else if not ReferenceFile.Equals(InjectionSourceFiles[0]) then
              Continue;
            Elements[j] := NodeData.Element;
            Inc(j);
          end;
        ...
        if AddRequiredMasters(sl, ReferenceFile) then
          ...
          begin
            wbCopyElementToFile(Elements[j], ReferenceFile, False, True, '', '',
              '', False);
            if Elements[j].RemoveInjected(False) then
            begin
              pgMain.ActivePage := tbsMessages;
              AddMessage('Injected references in ' + Elements[j].Name +
                ' could not all be removed automatically.');
            end;
          end;
      finally
        sl.Free;
    ...
    begin
      ...
      try
        FocusedElements := nil;
        if Assigned(NavFocusedElement) then
        begin
        ...
        begin
          ...
          with NodeData^ do
          begin
            if Assigned(Element) and (Element.ElementGeneration <> ElementGen)
              or Assigned(Container) and
              (Container.ElementGeneration <> ContainerGen) then
            begin
        ...
        NodeData := vstNav.GetNodeData(vstNav.FocusedNode);
        for i := Low(FocusedElements) to High(FocusedElements) do
        begin
          if Assigned(NodeData) then
    ...
    begin
      ...
      try
        ...
        while Assigned(Node) do
        begin
          if (Node.ChildCount > 0) and not vstNav.Expanded[Node] then
          begin
            NodeData := vstNav.GetNodeData(Node);
    ...
    begin
      ...
      if (wbToolMode in [tmEdit, tmTranslate]) or aForce then
      begin
        if Assigned(vstNav) and
          (toAutoFreeOnCollapse in vstNav.TreeOptions.AutoOptions) then
        begin

          if aForce or
            (wbLoaderDone and ((vstNavLastCollapsedChildrenCleanup <>
            vstNavInitChildrenGeneration) or (vstNavLastCheckedForChanges <>
            wbGlobalModifedGeneration))) then
          begin
            vstNav.BeginUpdate;
            try
              if aForce or (vstNavLastCollapsedChildrenCleanup <>
                vstNavInitChildrenGeneration) or
                (vstNavLastCheckedForChanges <> wbGlobalModifedGeneration) then
              begin
                NavCleanupCollapsedNodeChildren;
                vstNavLastCollapsedChildrenCleanup :=
                  vstNavInitChildrenGeneration;
              end;
              if aForce or
                (vstNavLastCheckedForChanges <> wbGlobalModifedGeneration) then
              begin
    ...
    begin
      ...
      if Length(TDirectory.GetFiles(wbCachePath, IntToHex64(wbCRC32App,
        8) + '_*' + wbRefCacheExt)) > 0 then
        Exit;
      ...
      if MessageDlg('The Reference Cache contains ' + i.ToString +
        ...
        '. Do you want to remove them?', mtConfirmation, mbYesNo, 0) = mrYes
      then
        for i := Low(Files) to High(Files) do
          try
    ...
    begin
      ...
      try
        ...
        try
          ...
          with vstView.Header.Columns do
          begin
            BeginUpdate;
            try
              Clear;
              ...
              begin
                Text := '';
                Width := Trunc(ColumnWidth * (GetCurrentPPIScreen /
                  PixelsPerInch));
    ...
    procedure TfrmMain.ClearConflict(Sender: TBaseVirtualTree;
    ...
    function TfrmMain.ConflictLevelForChildNodeDatas(const aNodeDatas
      : TDynViewNodeDatas; aSiblingCompare, aInjected: Boolean): TConflictAll;
    var
      ChildCount: Cardinal;
      i, j: Integer;
      NodeDatas: TDynViewNodeDatas;
    ...
    begin
      ...
      if ChildCount > 0 then
        ...
        begin
          ...
          InitialStates := [];
          InitNodes(nil, @NodeDatas[0], @aNodeDatas[0], Length(aNodeDatas), i,
            InitialStates);
            ...
            begin
              ...
              if (i >= j) and (i - j < ElementCount) then
                with (Element.Def as IwbRecordDef).Members[i - j] do
                  if (wbTranslationMode and (not(dfTranslatable in DefFlags)))
    ...
    begin
      ...
      if wbIsSkyrim or wbIsFallout3 or wbIsFallout4 then
      begin
        try
      ...
      if wbGameMode = gmTES4 then
        try
          frmMain.PostAddMessage('[' + FormatDateTime('hh:nn:ss',
            Now - wbStartTime) + '] LOD Generator: starting');

          Worldspaces := nil;
          for i := Low(Files) to High(Files) do
          begin
            _File := Files[i];
            if Supports(_File.GroupBySignature['WRLD'], IwbContainerElementRef,
              Group) then
            begin
          ...
          if Length(Worldspaces) > 1 then
          begin
            wbMergeSortPtr(@Worldspaces[0], Length(Worldspaces),
              CompareElementsFormIDAndLoadOrder);

            j := 0;
            for i := Succ(Low(Worldspaces)) to High(Worldspaces) do
            begin
              if Worldspaces[j].LoadOrderFormID <> Worldspaces[i].LoadOrderFormID
              then
                Inc(j);
              if j <> i then
          ...
          try
            try
              ...
              begin
                frmMain.PostAddMessage('[' + FormatDateTime('hh:nn:ss',
                  Now - wbStartTime) + '] LOD Generator: <Error: ' +
                  E.Message + '>');
                raise;
              end;
            end;
    ...
    begin
      ...
      if FileExists(wbScriptToRun) then
      begin
        ...
        with TStringList.Create do
          try
            ...
            ApplyScript(ExtractFileName(wbScriptToRun), Text,
              ExtractFileExt(ExtractFileName(wbScriptToRun)));
          finally
            Free;
          end;
      end
    ...
    function dfResourceOpenData(const aContainerName,
      aFileName: string): TBytes;
    begin
    ...
    begin
      ...
      vstView.TreeOptions.PaintOptions := vstView.TreeOptions.PaintOptions +
        [toAdvHotTrack];
      ...
      vstSpreadSheetWeapon.TreeOptions.PaintOptions :=
        vstSpreadSheetWeapon.TreeOptions.PaintOptions +
        [toZebra, toAdvHotTrack];
      ...
      vstSpreadsheetArmor.TreeOptions.PaintOptions :=
        vstSpreadsheetArmor.TreeOptions.PaintOptions + [toZebra, toAdvHotTrack];

      vstSpreadSheetAmmo.OnGetEditText := vstSpreadSheetGetEditText;
      vstSpreadSheetAmmo.OnCheckHotTrack := vstSpreadSheetCheckHotTrack;
      vstSpreadSheetAmmo.TreeOptions.PaintOptions :=
        vstSpreadSheetAmmo.TreeOptions.PaintOptions + [toZebra, toAdvHotTrack];

      AddMessage(wbApplicationTitle + ' (' + IntToHex64(wbCRC32App, 8) +
        ') starting session ' + FormatDateTime('yyyy-mm-dd hh:nn:ss', Now));

      if wbShouldLoadMOHookFile then
      begin
        AddMessage('Using Mod Organizer Profile: ' + wbMOProfile);
        if not wbLoadMOHookFile then
        begin
      ...
      if not FileExists(wbTheGameIniFileName) then
      begin
      ...
      begin
        ...
        if not DirectoryExists(wbSavePath) then
        begin
      ...
      if wbCreationClubContentFileName <> '' then
      begin
        wbCreationClubContentFileName :=
          ExtractFilePath(ExcludeTrailingPathDelimiter(wbDataPath)) +
          wbCreationClubContentFileName;
        if FileExists(wbCreationClubContentFileName) then
        begin
          with TStringList.Create do
            try
          ...
          AddMessage('Using Creation Club Content list: ' +
            wbCreationClubContentFileName);
        end;
      end;

      AddMessage('Using plugin list: ' + wbPluginsFileName);
      if not FileExists(wbPluginsFileName) then
      begin
      ...
      AddMessage('Using translatable string encoding: ' +
        wbEncodingTrans.EncodingName);
      if wbGameMode >= gmTES5 then
        AddMessage('Using VMAD string encoding: ' +
          wbEncodingVMAD.EncodingName);
      ...
      for i := 0 to Pred(vstNav.Header.Columns.Count) do
        vstNav.Header.Columns[i].Width := Settings.ReadInteger(Name,
          'vstNavColumnWidth' + IntToStr(i), vstNav.Header.Columns[i].Width);
      ...
      if wbToolMode in [tmEdit, tmView, tmTranslate] then
      begin

{$IFDEF WIN64}
        if Settings.ReadBool('Init', 'First64Start', True) then
        begin
          if MessageDlg('You have started the 64bit version.' + CRLF + CRLF +
            ...
            'The 32bit version is generally faster and uses less memory than the 64bit version.'
...
{$ENDIF WIN64}
        ...
        with TfrmRichEdit.Create(Self) do
        begin
          Caption := 'What''s New?';
          try
            ...
            if (i < wbWhatsNewVersion) and not wbAutoLoad then
            begin
              ShowModal;
            ...
            pnlMain.Margins.Top := edSearch.Top + edSearch.Height +
              reMain.Margins.Left;
      ...
      try
        ...
        try
          ...
          with frmFileSelect do
            try
              case wbToolSource of
                tsSaves:
                  begin
                    case wbGameMode of
                      ...
                      gmTES5, gmEnderal, gmTES5VR, gmSSE:
                        begin
                          saveExt := '.ess';
                          coSaveExt := '.skse';
                        end;
                    ...
                    if FindFirst(ExpandFileName(wbSavePath + '\*' + saveExt),
                      faAnyfile, R) = 0 then
                      try
                        repeat
                          ...
                          begin
                            ...
                            if (coSaveExt <> '') and
                              FileExists(ExpandFileName(wbSavePath + '\' + s))
                            then
                    ...
                    if (coSaveExt <> '') then
                      if FindFirst
                        (ExpandFileName(wbSavePath + '\*' + coSaveExt),
                        faAnyfile, R) = 0 then
                        try
                          repeat
                            if R.Attr and faDirectory <> faDirectory then
                ...
                tsPlugins:
                  begin
                    ...
                    if (wbToolMode in [tmMasterUpdate, tmMasterRestore]) and
                      (Length(Modules) > 1) and wbIsFallout3 then
                    begin
                      AgeDateTime := Modules[0].miDateTime;
                      for i := 1 to High(Modules) do
                      begin
                        AgeDateTime := AgeDateTime + (1 / 24 / 60);
                        TFile.SetLastWriteTime
                          (wbDataPath + Modules[i].miOriginalName, AgeDateTime);
                      end;
                    end;
                  end;
              end;

              if ((wbToolMode in wbPluginModes) or wbQuickClean) and
                (wbGameMode in [gmTES4, gmFO3, gmFO4, gmFO4VR, gmFO76, gmFNV,
                gmTES5, gmTES5VR, gmSSE, gmEnderal]) then
              begin
                ...
                if (wbPluginToUse <> '') or not wbQuickClean then
                  with wbModuleByName(wbPluginToUse)^ do
                    ...
                    begin
                      ShowMessage('Selected plugin "' + wbPluginToUse +
                        '" does not exist');
                      // which we checked previously anyway :(
                      frmMain.Close;
                      Exit;
                    end;

                // More plugins requested ?
                while wbFindNextValidCmdLinePlugin(wbParamIndex, s,
                  wbDataPath) do
                begin
              ...
              begin
                if (wbToolMode in wbPluginModes) or
                  (wbAutoLoad and (GetAsyncKeyState(VK_CONTROL) >= 0)) then
                  try
                    if wbQuickClean then
                      if Length(wbModulesByLoadOrder.FilteredByFlag
                        (mfTaggedForPluginMode)) <> 1 then
                      begin
                        ShowMessage
                    ...
                    sl.AddStrings
                      (wbModulesByLoadOrder.SimulateLoad.ToStrings(False));
                  except
                  end;
                  ...
                  with TfrmModuleSelect.Create(Self) do
                    try
                      ...
                      begin
                        MinSelect := 1;
                        MaxSelect := 1;
                        AllModules := wbModulesByLoadOrder(False)
                          .FilteredByFlag(mfValid);
                        Caption :=
                          'Please check or double click the module that you want to '
                          + wbSubMode;
                      end
                      else
                      ...
                      begin
                        if Length(AllModules) < 1 then
                          ShowMessage
                            ('There are no modules in the data folder.');
                        frmMain.Close;
                        Exit;
                      end;
                    finally
          ...
          if wbQuickClean then
          begin
            if Length(wbModulesByLoadOrder.FilteredByFlag(mfTaggedForPluginMode)
              ) <> 1 then
            begin
              MessageDlg
                ('Exactly one plugin must be selected in QuickClean mode',
                mtError, [mbAbort], 0);
              frmMain.Close;
              Exit;
            end;
            ...
            if sl.Count <> 1 then
            begin
              MessageDlg('Exactly one plugin must be selected with this source',
                mtError, [mbAbort], 0);
              frmMain.Close;
              Exit;
            end;
          ...
          begin
            ...
            case wbGameMode of
              gmFNV:
                if sameText(ExtractFileExt(s), coSaveExt) then
                  SwitchToCoSave;
              gmFO3:
                if sameText(ExtractFileExt(s), coSaveExt) then
                  SwitchToCoSave
                ...
                begin
                  MessageDlg('Save are not supported yet "' + s +
                    '". Please check the selection.', mtError, [mbAbort], 0);
                  frmMain.Close;
                  Exit;
                end;
              gmFO4:
              ...
              MessageDlg('CoSave are not supported yet "' + s +
                '". Please check the the selection.', mtError, [mbAbort], 0);
              frmMain.Close;
              Exit;
            end;
            sl.Clear;
          ...
          else { wbToolSource = tsPlugins }
          begin
            Modules.ActivateMasters;
            // Activate all required masters in their current load order position first
            Modules := Modules.SimulateLoad;
            // Simulate a load, which might re-order masters
            sl.Clear;
          ...
          begin
            wbBuildRefs := False;
            AddMessage
              ('The SHIFT key is pressed, skip building references for all plugins!');
          end;
          ...
          wbPatron := Settings.ReadBool('Options', 'Patron', wbPatron);
          wbNoGitHubCheck := Settings.ReadBool('Options', 'NoGitHubCheck',
            wbNoGitHubCheck);
          wbNoNexusModsCheck := Settings.ReadBool('Options', 'NoNexusModsCheck',
            wbNoNexusModsCheck);
        ...
        on E: Exception do
        begin
          AddMessage('Fatal: Error loading plugin list: <' + E.ClassName + ': '
            + E.Message + '>');
          Exit;
        end;
      end;
      ...
      ShowUnsavedHint := Settings.ReadBool('Options', 'ShowUnsavedHint',
        ShowUnsavedHint);
      if not wbTranslationMode then
      begin
        wbHideUnused := Settings.ReadBool('Options', 'HideUnused',
          wbHideUnused);
        wbHideIgnored := Settings.ReadBool('Options', 'HideIgnored',
          wbHideIgnored);
        wbHideNeverShow := Settings.ReadBool('Options', 'HideNeverShow',
          wbHideNeverShow);
      end;
      wbActorTemplateHide := Settings.ReadBool('Options', 'ActorTemplateHide',
        wbActorTemplateHide);
      ColumnWidth := Settings.ReadInteger('Options', 'ColumnWidth',
        ColumnWidth);
      RowHeight := Settings.ReadInteger('Options', 'RowHeight', RowHeight);
      SetDefaultNodeHeight
        (Trunc(RowHeight * (GetCurrentPPIScreen / PixelsPerInch)));
      ...
      wbFocusAddedElement := Settings.ReadBool('Options', 'FocusAddedElement',
        wbFocusAddedElement);
      wbRequireCtrlForDblClick := Settings.ReadBool('Options',
        'RequireCtrlForDblClick', wbRequireCtrlForDblClick);
      wbRemoveOffsetData := Settings.ReadBool('Options', 'RemoveOffsetData',
        wbRemoveOffsetData);
      wbShowGroupRecordCount := Settings.ReadBool('Options',
        'ShowGroupRecordCount', wbShowGroupRecordCount);
      wbShowFileFlags := Settings.ReadBool('Options', 'ShowFileFlags',
        wbShowFileFlags);
      wbAutoCompareSelectedLimit := Settings.ReadInteger('Options',
        'AutoCompareSelectedLimit', wbAutoCompareSelectedLimit);
      tmrPendingSetActive.Interval := Settings.ReadInteger('Options',
        'NavChangeDelay', tmrPendingSetActive.Interval);
      wbClampFormID := Settings.ReadBool('Options', 'ClampFormID',
        wbClampFormID);
      wbResetModifiedOnSave := Settings.ReadBool('Options',
        'ResetModifiedOnSave', wbResetModifiedOnSave);
      wbAlwaysSaveOnam := Settings.ReadBool('Options', 'AlwaysSaveOnam',
        wbAlwaysSaveOnam) or wbAlwaysSaveOnamForce;
      wbAlignArrayElements := Settings.ReadBool('Options', 'AlignArrayElements',
        wbAlignArrayElements);
      wbManualCleaningHide := Settings.ReadBool('Options', 'ManualCleaningHide',
        wbManualCleaningHide);
      wbManualCleaningAllow := Settings.ReadBool('Options',
        'ManualCleaningAllow', wbManualCleaningAllow);
      wbCollapseRecordHeader := Settings.ReadBool('Options',
        'CollapseRecordHeader', wbCollapseRecordHeader);
      wbCollapseObjectBounds := Settings.ReadBool('Options',
        'CollapseObjectBounds', wbCollapseObjectBounds);
      wbCollapseModels := Settings.ReadBool('Options', 'CollapseModels',
        wbCollapseModels);
      wbCollapseFactions := Settings.ReadBool('Options', 'CollapseFactions',
        wbCollapseFactions);
      wbCollapseFactionRelations := Settings.ReadBool('Options',
        'CollapseFactionRelations', wbCollapseFactionRelations);
      wbCollapseItems := Settings.ReadBool('Options', 'CollapseItems',
        wbCollapseItems);
      wbCollapseLeveledItems := Settings.ReadBool('Options',
        'CollapseLeveledItems', wbCollapseLeveledItems);
      wbCollapseEquipSlots := Settings.ReadBool('Options', 'CollapseEquipSlots',
        wbCollapseEquipSlots);
      wbCollapseObjectProperties := Settings.ReadBool('Options',
        'CollapseObjectProperties', wbCollapseObjectProperties);
      wbCollapseScriptProperties := Settings.ReadBool('Options',
        'CollapseScriptProperties', wbCollapseScriptProperties);
      wbCollapseConditions := Settings.ReadBool('Options', 'CollapseConditions',
        wbCollapseConditions);
      wbCollapseBenignArray := Settings.ReadBool('Options',
        'CollapseBenignArray', wbCollapseBenignArray);
      wbCollapseRGBA := Settings.ReadBool('Options', 'CollapseRGBA',
        wbCollapseRGBA);
      wbCollapseVec3 := Settings.ReadBool('Options', 'CollapseVec3',
        wbCollapseVec3);
      wbShrinkButtons := Settings.ReadBool('Options', 'ShrinkButtons',
        wbShrinkButtons);
      ...
      wbUDRSetScale := Settings.ReadBool('Options', 'UDRSetScale',
        wbUDRSetScale);
      wbUDRSetScaleValue := Settings.ReadFloat('Options', 'UDRSetScaleValue',
        wbUDRSetScaleValue);
      wbUDRSetZ := Settings.ReadBool('Options', 'UDRSetZ', wbUDRSetZ);
      wbUDRSetZValue := Settings.ReadFloat('Options', 'UDRSetZValue',
        wbUDRSetZValue);
      wbUDRSetMSTT := Settings.ReadBool('Options', 'UDRSetMSTT', wbUDRSetMSTT);
      wbUDRSetMSTTValue := Settings.ReadInteger('Options', 'UDRSetMSTTValue',
        wbUDRSetMSTTValue);
      for ConflictThis := Low(TConflictThis) to High(TConflictThis) do
        wbColorConflictThis[ConflictThis] :=
          Settings.ReadInteger('ColorConflictThis',
          GetEnumName(TypeInfo(TConflictThis), Integer(ConflictThis)),
          Integer(wbColorConflictThis[ConflictThis]));
      for ConflictAll := Low(TConflictAll) to High(TConflictAll) do
        wbColorConflictAll[ConflictAll] :=
          Settings.ReadInteger('ColorConflictAll',
          GetEnumName(TypeInfo(TConflictAll), Integer(ConflictAll)),
          Integer(wbColorConflictAll[ConflictAll]));

      HideNoConflict := Settings.ReadBool('View', 'HodeNoConflict', False);
      mniViewHideNoConflict.Checked := HideNoConflict;

      StickViewNodeLabel := Settings.ReadString('View',
        'StickViewNodeLabel', '');

      case Settings.ReadInteger('View', 'ColumnWidth', 0) of
        1:
          mniViewColumnWidthFitAll.Checked := True;
        2:
          mniViewColumnWidthFitText.Checked := True;
        3:
          mniViewColumnWidthFitSmart.Checked := True;
      else
      ...
      case Settings.ReadInteger('Nav', 'FilesSort', 0) of
        1:
          mniNavHeaderFilesLoadOrder.Checked := True;
        2:
          mniNavHeaderFilesFileName.Checked := True;
      else
      ...
      case Settings.ReadInteger('Nav', 'INFOSort', 0) of
        1:
          mniNavHeaderINFObyFormID.Checked := True;
      else
      ...
      begin
        ...
        else if Settings.ReadInteger('Patreon', 'SnoozeDate', 0) <> Trunc(Now)
        then
          if wbPatron then
          begin
            ...
            jbhPatreon.ActivateHint(bnPatreon,
              'Your support is essential to ensure further xEdit development.',
              'Patreon', 15000);
    ...
    procedure TfrmMain.edEditorIDSearchKeyDown(Sender: TObject; var Key: Word;
    Shift: TShiftState);
    var
      EditorID: string;
      Node: PVirtualNode;
      ...
      begin
        ...
        begin
          ...
          if Assigned(NodeData) and Assigned(NodeData.Element) and
            not NodeData.Element.IsHidden then
            if StartsWith(vstNav.Text[Node, 1, False], EditorID) then
            begin
              if not vstNav.FullyVisible[Node] then
              begin
                vstNav.FullyVisible[Node] := True;
                Node := vstNav.NodeParent[Node];
              end
    ...
    begin
      ...
      begin
        ...
        try
          ...
          while Assigned(Node) do
          begin
            IsVisible[Node] := not((SearchText <> '') and not Text[Node, 0,
              False].ToLowerInvariant.Contains(SearchText));
    ...
    procedure TfrmMain.edFileNameFilterKeyDown(Sender: TObject; var Key: Word;
    Shift: TShiftState);
    var
        ...
        VK_RETURN, VK_UP:
          begin
            ...
            if Assigned(FocusedNode) then
              for Node in vstNav.VisibleNodes(nil) do
              begin
    ...
    procedure TfrmMain.edFilterNoBeepOnEnterKeyPress(Sender: TObject;
    var Key: Char);
    begin
    ...
    procedure TfrmMain.edFormIDSearchKeyDown(Sender: TObject; var Key: Word;
    Shift: TShiftState);
    var
      s: string;
      FormID: TwbFormID;
    ...
    begin
      ...
      begin
        ...
        if not FormID.IsNull then
        begin
          _File := nil;
          j := Low(Files);
          while (j <= High(Files)) and not Assigned(_File) do
          begin
            if Files[j].LoadOrderFileID = FileID then
              _File := Files[j];
            Inc(j);
          end;
          while Assigned(_File) do
          begin
      ...
      begin
        ...
        if Assigned(ContainsChilds) then
          ContainsChilds^ := ContainsChilds^ or
            (Assigned(NodeData.Container) and
            (NodeData.Container.ElementCount > 0));
    ...
    begin
      ...
      if not Result then
        with TfrmEditWarning.Create(Self) do
          try
    ...
    procedure TfrmMain.edViewFilterNameKeyDown(Sender: TObject; var Key: Word;
    Shift: TShiftState);
      ...
      begin
        ...
        if Assigned(FocusedNode) then
          for Node in vstView.VisibleNodes(nil) do
          begin
            if Node = FocusedNode then
              Exit;
          end;
      ...
      try
        ...
        begin
          ...
          if Assigned(NodeDatas) then
            for i := Low(ActiveRecords) to High(ActiveRecords) do
              with NodeDatas[i] do
                if Assigned(Container) and (Container.Collapsed = tbTrue) then
                begin
    ...
    function TfrmMain.FindNodeForElement(const aElement: IwbElement)
      : PVirtualNode;
    var
      Container: IwbContainer;
      Node: PVirtualNode;
    ...
    begin
      ...
      NodeData := vstNav.GetNodeData(Node);
      if Assigned(NodeData) then
        if aElement.Equals(NodeData.Element) or
          aElement.Equals(NodeData.Container) then
          Exit(Node);
                ...
                if CELL.Signature = 'CELL' then
                  if CELL.IsPersistent then
                    if Supports(CELL.Container, IwbGroupRecord, WorldGRUP) then
                      if Supports(WorldGRUP.ChildrenOf, IwbMainRecord, WRLD)
                      then
                        if WRLD.Signature = 'WRLD' then
                        begin
    ...
    function TfrmMain.FindNodeForElementIn(aParent: PVirtualNode;
    const aElement: IwbElement): PVirtualNode;
    var
      NodeData: PNavNodeData;
    begin
    ...
    function TfrmMain.FindNodeOrAncestorForElement(const aElement: IwbElement)
      : PVirtualNode;
    var
      Container: IwbContainer;
      Node: PVirtualNode;
    ...
    begin
      SaveLog(wbProgramPath + wbAppName + wbToolName + '_log.txt',
        aAllowReplace);
      if wbLogFile <> '' then
        SaveLog(wbLogFile, aAllowReplace);
    end;

    procedure TfrmMain.SaveModGroupsSelection(const aModGroups
      : TwbModGroupPtrs);
    var
      i: Integer;
    begin
    ...
    begin
      ...
      if Assigned(CheckGitHubReleaseThread) then
      begin
      ...
      if Assigned(CheckNexusModsReleaseThread) then
      begin
      ...
      begin
        ...
        if Assigned(vstNav) then
          for i := 0 to Pred(vstNav.Header.Columns.Count) do
            Settings.WriteInteger(Name, 'vstNavColumnWidth' + IntToStr(i),
              vstNav.Header.Columns[i].Width);
    ...
    begin
      ...
      if Screen.IconFont.Size <> OldSize then
      begin
        Font := TFont.Create;
        try
    ...
    procedure wbLoadAndApplyFontAndScale(aIni: TMemIniFile;
    aSection, aName: string; aWinControl: TWinControl);
    var
      OldSize: Integer;
      NewSize: Integer;
      lFont: TFont;
    ...
    begin
      ...
      try
        ...
        if (lFont.Name <> cFont.Name) or (lFont.CharSet <> cFont.CharSet) or
          (lFont.Color <> cFont.Color) or (lFont.Size <> cFont.Size) or
          (lFont.Style <> cFont.Style) then
        begin
          NewSize := lFont.Size;
          lFont.Size := OldSize;
          cFont.Assign(lFont);
    ...
    begin
        ...
        try
          if not Assigned(Settings) and (wbSettingsFileName <> '') then
            if ForceDirectories(ExtractFilePath(wbSettingsFileName)) then
              Settings := TMemIniFile.Create(wbSettingsFileName);
          if Assigned(Settings) then
            TStyleManager.TrySetStyle(Settings.ReadString('UI', 'Theme',
              TStyleManager.ActiveStyle.Name), False);
        except
        end;
      ...
      try
        ...
        begin
          ...
          wbLoadAndApplyFontAndScale(Settings, 'UI', 'FontMessages',
            mmoMessages);
          ...
          begin
            ...
            if (k > 100) and (l > 100) then
            begin
              Rect := Screen.DesktopRect;
              if (i + 16 >= Rect.Left) and (j + 16 >= Rect.Top) and
                ((i + k) - 16 <= Rect.Right) and ((j + l) - 16 <= Rect.Bottom)
              then
              begin
                Left := i;
                Top := j;
            ...
            WindowState := TWindowState(Settings.ReadInteger(Name,
      ...
      if wbThemesSupported then
        with TVclStylesSystemMenu.Create(Self) do
        begin
    ...
    begin
      ...
      if Assigned(vstSpreadSheetWeapon) then
        vstSpreadSheetWeapon.UpdateHotTrack;
      if Assigned(vstSpreadsheetArmor) then
        vstSpreadsheetArmor.UpdateHotTrack;
      if Assigned(vstSpreadSheetAmmo) then
      ...
      if (Shift = [ssAlt]) and (Key in [VK_UP, VK_DOWN, VK_LEFT, VK_RIGHT]) then
      begin
        ...
        try
          ...
          FocusFile := nil;
          if (Pred(Column) >= Low(ActiveRecords)) and
            (Pred(Column) <= High(ActiveRecords)) then
          ...
          begin
            ...
            if (StickViewNodeLabel = '*') or not Assigned(FoundViewLabelNode)
            then
            begin
            ...
            if Assigned(FocusFile) then
              for i := Low(ActiveRecords) to High(ActiveRecords) do
                with ActiveRecords[i] do
                  if Assigned(Element) and FocusFile.Equals(Element._File) then
                  begin
                    Column := Succ(i);
                    FocusFile := nil;
                    Break;
                  ...
                  with ActiveRecords[i] do
                    ...
                    begin
                      ...
                      if Assigned(_File) and
                        (_File.LoadOrder >= FocusFile.LoadOrder) then
                      begin
                        Column := Succ(i);
                        FocusFile := nil;
                        Break;
    ...
    begin
      pnlViewTop.Height := fpnlViewFilterKeep.Top +
        fpnlViewFilterKeep.Height + 8;
    end;

    function TfrmMain.GetAddElement(out TargetNode: PVirtualNode;
    out TargetIndex: Integer; out TargetElement: IwbElement): Boolean;
    var
      NodeDatas: PViewNodeDatas;
      Container: IwbContainerElementRef;
    begin
      ...
      begin
        ...
        begin
          ...
          begin
            if (TargetIndex < High(Integer)) and
              Supports(TargetElement, IwbContainerElementRef, Container) then
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if Assigned(TargetElement) then
          begin
            if (TargetIndex >= 0) and Supports(TargetElement,
              IwbContainerElementRef, Container) then
              Dec(TargetIndex, Container.AdditionalElementCount);
            Break;
          end;
        end;
    ...
    begin
      ...
      for i := 0 to Pred(lvReferencedBy.Items.Count) do
      begin
        ListItem := lvReferencedBy.Items[i];
        if Assigned(ListItem) and Assigned(ListItem.Data) and ListItem.Selected
        then
        begin
    ...
    function TfrmMain.GetSourceElement(Source: TObject;
    out SourceElement: IwbElement): Boolean;
    var
      SourceTree: TVirtualEditTree;
    ...
    begin
      ...
      SourceElement := SourceNodeDatas[Pred(SourceTree.DragColumn)
        ].Element as IwbElement;
    ...
    begin
      ...
      Result := CmpPtr(IwbElement(Item1).ElementID,
        IwbElement(Item2).ElementID);
    end;

    function TfrmMain.GetUniqueLinksTo(const aNodeDatas: PViewNodeDatas;
    aNodeCount: Integer): TDynMainRecords;
    var
      i, j, k: Integer;
      Element: IwbElement;
    ...
    begin
      ...
      begin
        Element := aNodeDatas[i].Element;
        if Assigned(Element) and Supports(Element.LinksTo, IwbMainRecord,
          Result[j]) then
        begin
      ...
      case j of
        ...
        for i := 1 to Pred(j) do
          if Result[i].ElementID <> LastID then
          begin
    ...
    procedure TfrmMain.InheritStateFromChildren(Node: PVirtualNode;
    NodeData: PNavNodeData);
    var
    ...
    procedure TfrmMain.InitChildren(const aNodeDatas: PViewNodeDatas;
    aNodeCount: Integer; var aChildCount: Cardinal);
    var
    ...
    begin
      ...
      begin
        if Assigned(FirstContainer) then
          PostAddMessage
            ('Warning: Comparing a mix of sorted, unsorted, and/or alignable entries for "'
            + FirstContainer.Path + '" in "' +
            FirstContainer.ContainingMainRecord.Name + '"');
        SortedCount := 0;
        AlignableCount := 0;
      end;
      ...
      begin
        ...
        try
          ...
          begin
            ...
            if Supports(NodeData.Container, IwbSortableContainer, Sortables[i])
            then
            begin
              ...
              case Container.ElementType of
                etMainRecord, etSubRecordStruct:
                  begin
                    ...
                    begin
                      PostAddMessage('Error: Container.ElementCount {' +
                        IntToStr(Container.ElementCount) + '} > aChildCount {' +
                        IntToStr(aChildCount) + '} for ' + Container.Path +
                        ' in ' + Container.ContainingMainRecord.Name);
                      for j := 0 to Pred(Container.ElementCount) do
                        PostAddMessage('  #' + IntToStr(j) + ': ' +
                          Container.Elements[j].Name);
                      // Assert(Cardinal(Container.ElementCount) <= aChildCount);
                    end;
                  end;
                etSubRecordArray, etSubRecord, etArray:
                  begin

                    with aNodeDatas[i].Container do
                    begin
            ...
            begin
              ...
              begin
                ...
                begin
                  NodeData := @aNodeDatas[i];
                  Container := NodeData.Container;
                  if Assigned(Container) and (Container.ElementCount > 0) then
                  begin
                    if not Assigned(FirstContainer) then
                    begin
                      FirstContainer := Container;
                      ...
                      begin
                        ...
                        for j := 0 to Pred(ElementCount) do
                        begin
                          if not AllKeys.Find(Elements[j].SortKey[False],
                            LeftKeys[j]) then
                            Assert(False);
                    ...
                    begin
                      ...
                      with TDiff.Create(nil) do
                        try
                          AllowModify := False;
                          if not Execute(PInteger(@LeftKeys[0]),
                            PInteger(@RightKeys[0]), Length(LeftKeys),
                            Length(RightKeys)) then
                            Assert(False);

                          for j := Pred(i) downto 0 do
                            if Length(KeyedElements[j]) > 0 then
                            begin
    ...
    procedure TfrmMain.InitConflictStatus(aNode: PVirtualNode;
    aInjected: Boolean; aNodeDatas: PViewNodeDatas = nil);
    ...
    begin
      HasElement := False;
      lDontShow := False;
      if not Assigned(aNodeDatas) then
      begin
      ...
      if not Assigned(ChildNode) then
        aNodeDatas[0].ConflictAll := ConflictLevelForNodeDatas(aNodeDatas,
          Length(ActiveRecords), ComparingSiblings, aInjected)
      else
        while Assigned(ChildNode) do
        begin
      ...
      begin
        ...
        begin
          if vnfDontShow in aNodeDatas[i].ViewNodeFlags then
            lDontShow := True;
          if Assigned(aNodeDatas[i].Container) then
          begin
            lDontShow := False;
            Break;
          end;
        ...
        case ConflictThis of
          ctUnknown:
            vstView.IsVisible[aNode] := not lDontShow and not wbTranslationMode;
          ctIgnored:
            vstView.IsVisible[aNode] := not wbHideIgnored;
          ctNotDefined:
            begin
              ...
              begin
                ...
                if (j >= i) and ((j - i) < ElementCount) then
                  with (Element.Def as IwbRecordDef).Members[j - i] do
                  begin
                    if (wbTranslationMode and (not(dfTranslatable in DefFlags)))
                      or (wbTranslationMode and
                      (ConflictPriority[nil] = cpIgnore)) then
                    begin
                      ConflictThis := ctIgnored;
                    ...
                    if (ConflictThis <> ctIgnored) and HasDontShow then
                    begin
                      lDontShow := True;
                      for k := Low(ActiveRecords) to High(ActiveRecords) do
                      begin
              ...
              if ConflictThis = ctNotDefined then
              begin
                ...
                begin
                  ...
                  j := Integer(aNode.Index);
                  if (j >= i) and ((j - i) < ElementCount) then
                    with (Element.Def as IwbRecordDef)
                      .Members[Integer(aNode.Index) - i] do
                      if ConflictPriority[nil] = cpIgnore then
                        ConflictThis := ctIgnored;
                end;
              end;

              vstView.IsVisible[aNode] :=
                ((ConflictThis <> ctIgnored) or not wbHideIgnored) and
                not lDontShow;
            end;
        else
    ...
    procedure TfrmMain.InitNodes(const aNode: PVirtualNode;
    const aNodeDatas: PViewNodeDatas; const aParentDatas: PViewNodeDatas;
    aNodeCount: Integer; aIndex: Cardinal;
    ...
    begin
      ...
      begin
        ...
        if Assigned(Container) then
        begin
          if (vnfUseSortOrder in ParentData.ViewNodeFlags) or
            (Supports(Container, IwbSortableContainer, SortableContainer) and
        ...
        if Assigned(NodeData.Element) then
        begin
          if Assigned(aNode) and Assigned(ViewFocusedElement) and
            not Assigned(NodeForViewFocusedElement) then
            if ViewFocusedElement.Equals(NodeData.Element) then
            begin
              NodeForViewFocusedElement := aNode;
              ColumnForViewFocusedElement := Succ(i);
            end;
          if NodeData.Element.DontShow then
          begin
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            ConflictLevelForMainRecord(MainRecord, NodeData.ConflictAll,
              NodeData.ConflictThis);
    ...
    var
      ...
      begin
        ...
        Result := False;
        for i := 1 to Pred(vstView.Header.Columns.Count) do
        begin
          CellText := '';
    ...
    procedure TfrmMain.jbhGitHubCloseBtnClick(Sender: TObject;
    var CanClose: Boolean);
    begin
      if Assigned(Settings) and (GitHubVersion.Major > 0) then
      begin
    ...
    procedure TfrmMain.jbhNexusModsCloseBtnClick(Sender: TObject;
    var CanClose: Boolean);
    begin
      if Assigned(Settings) and (NexusModsVersion.Major > 0) then
      begin
        Settings.WriteString('NexusMods', 'SnoozeVersion',
          NexusModsVersion.ToString);
    ...
    procedure TfrmMain.jbhPatreonCloseBtnClick(Sender: TObject;
    var CanClose: Boolean);
    begin
      if Assigned(Settings) then
      begin
    ...
    procedure TfrmMain.jbhSaveCloseBtnClick(Sender: TObject;
    var CanClose: Boolean);
    begin
      SetSaveInterval;
    end;
    ...
    begin
      ...
      begin
        ...
        while Assigned(Node) and (Node <> vstNav.RootNode) do
        begin
          NodeData := vstNav.GetNodeData(Node);
          if Assigned(NodeData) then
          begin
    ...
    begin
      ...
      if (pgMain.ActivePage = tbsView) or (pgMain.ActivePage = tbsReferencedBy)
      then
      begin
        ...
        else if (Length(CompareRecords) > 0) then
      ...
      if Assigned(MainRecord) then
        if Assigned(Element) then
          aInterface := TMainRecordElementHistoryEntry.Create
            (MainRecord, Element)
        else
    ...
    procedure TfrmMain.lvReferencedByColumnClick(Sender: TObject;
    Column: TListColumn);
    begin
    ...
    procedure TfrmMain.lvReferencedByCompare(Sender: TObject;
    Item1, Item2: TListItem; Data: Integer; var Compare: Integer);
    begin
      if not Assigned(ReferencedBySortColumn) or
        (ReferencedBySortColumn.Index = 0) then
        Compare := CompareText(Item1.Caption, Item2.Caption)
      else
        Compare := CompareText(Item1.SubItems[Pred(ReferencedBySortColumn.Index)
          ], Item2.SubItems[Pred(ReferencedBySortColumn.Index)])
    end;
    ...
    begin
      ...
      if GetAddElement(TargetNode, TargetIndex, TargetElement) then
      begin
        if not EditWarn then
          Exit;
    ...
    begin
      ...
      with TfrmFileSelect.Create(Self) do
        try
          ...
          for i := Low(ActiveRecords) to High(ActiveRecords) do
            if i <> Pred(SourceColumn) then
              if Assigned(ActiveRecords[i].Element) then
                CheckListBox1.AddItem(ActiveRecords[i].Element.Name,
                  Pointer(i));
    ...
    procedure TfrmMain.mniViewCopyMultipleToSelectedRecordsClick
      (Sender: TObject);
    var
    ...
    begin
      ...
      SetLength(Names, 0);
      for Node in vstView.LevelNodes(0) do
      begin
        NodeDatas := vstView.GetNodeData(Node);
        if Assigned(NodeDatas) then
        begin
          Element := nil;
          if (vstView.FocusedColumn > 0) and
            (Pred(vstView.FocusedColumn) <= High(ActiveRecords)) then
          begin
          ...
          if Assigned(Element) and (Element.Name <> 'Record Header') and
            not Element.Name.StartsWith('EDID') then
          begin
      ...
      begin
        NodeData := vstNav.GetNodeData(SelectedNodes[i]);
        if Assigned(NodeData) and not SourceMainRecord.Equals(NodeData.Element)
          and Supports(NodeData.Element, IwbMainRecord, MainRecords[j]) then
        begin
      ...
      with TfrmFileSelect.Create(Self) do
        try
          ...
          for i := Low(AllNodeDatas) to High(AllNodeDatas) do
          begin
      ...
      with TfrmFileSelect.Create(Self) do
        try
          ...
          try
            for j := Low(AllNodeDatas) to High(AllNodeDatas) do
            begin
              ...
              begin
                for k := Low(MainRecords) to High(MainRecords) do
                begin
                  ...
                  begin
                    ...
                    begin
                      ...
                      begin
                        ...
                        if Assigned(TargetMainRecord) and
                          MainRecords[k].Equals(TargetMainRecord) then
                        begin
                          if Element.IsRemoveable then
                          begin
                            if not EditWarn then
                              Exit;
                            Element.Remove;
    ...
    begin
      ...
      if (aExtension = '.pas') then
      begin
        ExecuteJv(ScriptName, aScript);
      end;
    end;

    procedure TfrmMain.ExecuteJv(const aScriptName: string; aScript: string);
    const
    ...
    begin
      ...
      try
        ...
        begin
          ...
          begin
            aScript := Copy(aScript, 1, i - 1) + s +
              Copy(aScript, i + Length(regexp.MatchedText), Length(aScript));
            regexp.Subject := aScript;
          end;
      ...
      p := Pos('Mode:', aScript);
      bShowMessages := not ContainsText
        (Copy(aScript, p, PosEx(#10, aScript, p) - p), 'Silent');
        ...
        try
          ...
          PerformLongAction(s, '',
            ...
            begin
              ...
              try
                try
                  if jvi.FunctionExists('', 'Initialize') then
                  begin
                    Inc(wbHideStartTime);
                    try
                  ...
                  if jvi.FunctionExists('', 'Process') then
                    ...
                    begin
                      ...
                      begin
                        ...
                        if Assigned(NodeData.Element) then
                          if NodeData.Element.ElementType in ScriptProcessElements
                          then
                          begin
                            if not bShowMessages then
                              wbProgressUnlock;
                            ...
                            Inc(Count);
                            wbCurrentProgress := 'Processed Records: ' +
                              Count.ToString;
                          end;
                  ...
                  if jvi.FunctionExists('', 'Finalize') then
                  begin
                    Inc(wbHideStartTime);
                    try
                  ...
                  begin
                    if Assigned(jvi.LastError) then
                      wbProgress('Exception in unit ' +
                        jvi.LastError.ErrUnitName + ' line ' +
                        IntToStr(jvi.LastError.ErrLine) + ': ' +
                        E.Message, True);
                    raise;
                  end;
                end;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if cbViewFilterKeepChildren.Checked then
          begin
            Node := GetLast(Unfiltered[i]);
            while Assigned(Node) and (Node <> Unfiltered[i]) do
            begin
              IsFiltered[Node] := False;
          ...
          if cbViewFilterKeepSiblings.Checked then
          begin
            Node := Unfiltered[i];
          ...
          if cbViewFilterKeepParentsSiblings.Checked then
          begin
            Node := NodeParent[Unfiltered[i]];
    ...
    begin
      if Now - LastHelpClick > 1 / 24 / 60 / 60 then
      begin
    ...
    begin
      if Now - LastVideosClick > 1 / 24 / 60 / 60 then
      begin
    ...
    procedure TfrmMain.bnMainMenuMouseDown(Sender: TObject;
    ...
    var
      Dummy: Boolean;
    begin
      if Now - LastNexusModsClick > 1 / 24 / 60 / 60 then
      begin
        ShellExecute(Handle, 'open', PChar(wbNexusModsUrl), '', '',
          SW_SHOWNORMAL);
    ...
    var
      Dummy: Boolean;
    begin
      if Now - LastGitHubClick > 1 / 24 / 60 / 60 then
      begin
    ...
    begin
      if Now - LastDiscordClick > 1 / 24 / 60 / 60 then
      begin
        ShellExecute(Handle, 'open', PChar(wbDiscordUrl), '', '',
          SW_SHOWNORMAL);
    ...
    begin
      if Now - LastPatreonClick > 1 / 24 / 60 / 60 then
      begin
        ShellExecute(Handle, 'open', PChar(wbPatreonUrl), '', '',
          SW_SHOWNORMAL);
    ...
    begin
      if Now - LastKoFiClick > 1 / 24 / 60 / 60 then
      begin
    ...
    begin
      if Now - LastPayPalClick > 1 / 24 / 60 / 60 then
      begin
    ...
    var
      ...
      ScriptEngine: string;
    begin
      with TfrmScript.Create(Self) do
        try
          Path := wbScriptsPath;
          LastUsedScript := Settings.ReadString('View', 'LastUsedScript', '');
          chkScriptsSubDir.Checked := Settings.ReadBool('View',
            'IncludeScriptsFromSubDir', False);
          if ShowModal <> mrOK then
            Exit;
          Scr := Script;
          ScriptName := LastUsedScript;
          Settings.WriteString('View', 'LastUsedScript', LastUsedScript);
          Settings.WriteBool('View', 'IncludeScriptsFromSubDir',
            chkScriptsSubDir.Checked);
          Settings.UpdateFile;
          CreateActionsForScripts;
        finally
          Free;
    ...
    begin
      ...
      if FindFirst(wbScriptsPath + '*.pas', faAnyfile, F) = 0 then
        try
          slScript := TStringList.Create;
          repeat
            Scr := wbScriptsPath + F.Name;
            slScript.LoadFromFile(Scr);
            for i := 0 to Pred(slScript.Count) do
            begin
              s := Trim(slScript[i]);
              if sameText(Copy(s, 1, Length(HotkeyToken)), HotkeyToken) then
              begin
                s := Copy(s, Succ(Length(HotkeyToken)), Length(s));
                ShortCut := TextToShortCut(s);
                if (ShortCut <> 0) and
                  (ScriptHotkeys.IndexOfObject(TObject(ShortCut)) = -1) then
                begin
    ...
    begin
      with TfrmModGroupSelect.Create(Self) do
        try
          ...
          Caption :=
            'Reloading ModGroups - Which ModGroups do you want to activate?';
          PresetCategory := 'ActiveModGroups';
          if (Length(AllModGroups) < 1) or (ShowModal = mrOK) then
          begin
            SaveModGroupsSelection(SelectedModGroups);
            WasModGroupsExist := ModGroupsExist;
            ModGroupsExist := SelectedModGroups.Activate;
            if WasModGroupsExist or ModGroupsExist then
            begin
    ...
    begin
      ...
      CopyInto(False, False, False, False, False, Elements, AfterCopyDisable);
    ...
    begin
      ...
      CopyInto(Sender = mniRefByCopyAsNewInto, False, False,
        (Sender = mniRefByDeepCopyOverrideInto) or
        (Sender = mniRefByDeepCopyOverrideIntoWithOverwriting),
        (Sender = mniRefByCopyOverrideIntoWithOverwriting) or
        (Sender = mniRefByDeepCopyOverrideIntoWithOverwriting), Elements);
    ...
    begin
      ...
      PerformLongAction('Mark Modified', '',
        procedure
        var
          MainRecords: TDynMainRecords;
          i: Integer;
    ...
    begin
      ...
      if Length(MainRecords) = 1 then
        DialogResult :=
          MessageDlg('Are you sure you want to permanently remove ' +
          MainRecords[0].Name + ' from file "' + MainRecords[0]._File.FileName +
          '"?', mtConfirmation, [mbYes, mbNo], 0)
      else
        DialogResult :=
          MessageDlg('Are you sure you want to permanently remove the ' +
          Length(MainRecords).ToString +
          ' selected records from their containing file(s)?', mtConfirmation,
          [mbYes, mbNo], 0);
      ...
      try
        ...
        begin
          ...
          if Assigned(MainRecord) then
          begin
            if not Supports(MainRecord.Container, IwbContainerElementRef,
              Container) then
              Container := nil;
    ...
    begin
      ...
      if WasModGroupsEnabled <> ModGroupsEnabled then
      begin
        ResetAllConflict;
        PostResetActiveTree;
        InvalidateElementsTreeView(NoNodes);
    ...
    begin
      (Sender as TMenuItem).Checked := True;
      if OnlyShowMasterAndLeafs <> mniMasterAndLeafsEnabled.Checked then
      begin
    ...
    begin
      ...
      if Assigned(NodeData) and Supports(NodeData.Element,
        IwbContainerElementRef, Container) then
      begin
        Element := Container.Add(StringReplace((Sender as TMenuItem).Caption,
          '&', '', [rfReplaceAll]), False);
        if Assigned(Element) then
        begin
    ...
    begin
      MMMESM := -1;
      for i := Low(Files) to High(Files) do
        if sameText(Files[i].FileName, 'Mart''s Monster Mod.esm') then
        begin
          MMMESM := i;
          Break
        end;
      ...
      if Supports(Files[MMMESM].GroupBySignature['SCPT'],
        IwbContainerElementRef, Group) then
        for j := 0 to Pred(Group.ElementCount) do
          if Supports(Group.Elements[j], IwbMainRecord, MainRecord) then
      ...
      for i := MMMESM to High(Files) do
        if (i = MMMESM) or Files[i].HasMaster('Mart''s Monster Mod.esm') then
          if Supports(Files[i].GroupBySignature['NPC_'], IwbContainerElementRef,
            Group) then
            for j := 0 to Pred(Group.ElementCount) do
              if Supports(Group.Elements[j], IwbMainRecord, MainRecord) then
                if not StrContaines(MainRecord.EditorID, 'Adven') and
                  ...
                  StrContaines(MainRecord.EditorID, 'Raider')) then
                begin
    ...
    procedure TfrmMain.mniNavBatchChangeReferencingRecordsClick
      (Sender: TObject);
      ...
      begin
        for i := Low(Files) to High(Files) do
          if AnsiSameText(Files[i].FileName, s) then
          begin
            Result := Files[i];
            Exit;
          end;
    ...
    var
      ...
      ReplaceList: array of record rlOldRecord: IwbMainRecord;
      ...
      try
        ...
        try
          ...
          try
            ...
            for i := 1 to Pred(CSV.Count) do
            begin // ignore first line
              Line.CommaText := CSV[i];
              if Line.Count <> 7 then
              begin
                AddMessage('Skipping line ' + IntToStr(i + 1) +
                  ': 7 values expected but ' + IntToStr(Line.Count) +
                  ' found.');
                Continue;
              end;
              ...
              if not Assigned(OldMaster) then
              begin
                AddMessage('Skipping line ' + IntToStr(i + 1) + ': Old Master "'
                  + s + '" is not loaded.');
                Continue;
              end
              else if OldMaster.LoadOrder < 0 then
              begin
                AddMessage('Skipping line ' + IntToStr(i + 1) + ': Old Master "'
                  + s + '" does not have a load order assigned.');
                Continue;
              end;

              s := Trim(Line[5]);
              NewMaster := FindFile(s);
              if not Assigned(NewMaster) then
              begin
                AddMessage('Skipping line ' + IntToStr(i + 1) + ': New Master "'
                  + s + '" is not loaded.');
                Continue;
              end
              else if NewMaster.LoadOrder < 0 then
              begin
                AddMessage('Skipping line ' + IntToStr(i + 1) + ': New Master "'
                  + s + '" does not have a load order assigned.');
                Continue;
              ...
              s := Trim(Line[2]);
              j := StrToIntDef(s, -1);
              if (j < 0) or (j > $FFFFFF) then
              begin
                AddMessage('Skipping line ' + IntToStr(i + 1) + ': Old FormID "'
                  + s + '" is not in the valid range.');
                Continue;
              end;
              OldRecord := OldMaster.RecordByFormID
                [TwbFormID.FromCardinal(j).ChangeFileID(OldMaster.FileFileID
                [True]), True, True];
              if not Assigned(OldRecord) then
              begin
                AddMessage('Skipping line ' + IntToStr(i + 1) +
                  ': Old Record with FormID "' + s +
                  '" was not found in old Master "' +
                  OldMaster.FileName + '".');
                Continue;
              end;
              ...
              if (j < 0) or (j > $FFFFFF) then
              begin
                AddMessage('Skipping line ' + IntToStr(i + 1) + ': New FormID "'
                  + s + '" is not in the valid range.');
                Continue;
              end;
              NewRecord := NewMaster.RecordByFormID
                [TwbFormID.FromCardinal(j).ChangeFileID(NewMaster.FileFileID
                [True]), True, True];
              if not Assigned(NewRecord) then
              begin
                AddMessage('Skipping line ' + IntToStr(i + 1) +
                  ': New Record with FormID "' + s +
                  '" was not found in new Master "' +
                  NewMaster.FileName + '".');
                Continue;
              end;

              if OldRecord.Equals(NewRecord) then
              begin
                AddMessage('Skipping line ' + IntToStr(i + 1) +
                  ': Old and new Record are identical".');
                Continue;
              end;

              s := Trim(Line[0]);
              if not sameText(OldRecord.Signature, s) then
                AddMessage('Warning line ' + IntToStr(i + 1) +
                  ': Old Record do not have expected Signature ("' +
                  OldRecord.Signature + '" vs. "' + s + '")".');
              if not sameText(NewRecord.Signature, s) then
                AddMessage('Warning line ' + IntToStr(i + 1) +
                  ': New Record do not have expected Signature ("' +
                  NewRecord.Signature + '" vs. "' + s + '")".');

              s := Trim(Line[3]);
              if not sameText(OldRecord.EditorID, s) then
                AddMessage('Warning line ' + IntToStr(i + 1) +
                  ': Old Record does not have expected EditorID ("' +
                  OldRecord.EditorID + '" vs. "' + s + '")".');

              s := Trim(Line[4]);
              if not sameText(NewRecord.EditorID, s) then
                AddMessage('Warning line ' + IntToStr(i + 1) +
                  ': New Record does not have expected EditorID ("' +
                  NewRecord.EditorID + '" vs. "' + s + '")".');

              ReferencedBy := nil;
              SetLength(ReferencedBy, OldRecord.ReferencedByCount);
              k := 0;

              for j := 0 to Pred(OldRecord.ReferencedByCount) do
              begin
                RefRecord := OldRecord.ReferencedBy[j];
                if _File.Equals(RefRecord._File) then
                begin
              ...
              if k < 1 then
              begin
                AddMessage('Skipping line ' + IntToStr(i + 1) + ': Old Record "'
                  + OldRecord.Name +
                  '" is not referenced by any record in file "' +
                  _File.Name + '".');
                Continue;
              end;

              with ReplaceList[l] do
              begin
              ...
              if not NewMaster.Equals(_File) then
                if not NewMasters.Find(NewMaster._File.FileName, k) then
                  NewMasters.AddObject(NewMaster._File.FileName,
                    Pointer(NewMaster._File));
            end;
          finally
            FreeAndNil(Line);
          end;
        ...
        if AddRequiredMasters(NewMasters, _File) then
          for i := 0 to Pred(l) do
            with ReplaceList[i] do
            begin
              ShowChangeReferencedBy(rlOldRecord.LoadOrderFormID,
                rlNewRecord.LoadOrderFormID, rlReferencedBy, True);
              RefRecord := _File.RecordByFormID[rlOldRecord.LoadOrderFormID,
                False, True];
              if Assigned(RefRecord) and _File.Equals(RefRecord._File) then
              begin
                AddMessage('Changing FormID [' +
                  RefRecord.LoadOrderFormID.ToString(True) + '] to [' +
                  rlNewRecord.LoadOrderFormID.ToString(True) + ']');
    ...
    begin
      PerformLongAction('Building reachable information', '',
        procedure
        var
          i: Integer;
          _File: IwbFile;
        ...
        begin
          ...
          begin
            ...
            if not(csRefsBuild in _File.ContainerStates) then
            begin
              wbCurrentAction := 'Building reference information for ' +
                _File.Name;
              wbProgress(wbCurrentAction);
              DoProcessMessages;
              _File.BuildRef;
          ...
          begin
            _File := Modules[i]._File;
            wbCurrentAction := 'Building reachable information for ' +
              _File.Name;
            wbProgress(wbCurrentAction);
            DoProcessMessages;
    ...
    begin
      with TfrmModuleSelect.Create(nil) do
        try
          Caption := 'Build reference information for:';

          AllModules := wbModulesByLoadOrder.FilteredByFlag(mfValid).FilteredBy(
            function(a: PwbModuleInfo): Boolean
            begin
              Result := Assigned(a.miFile);
              if Result then
          ...
          PerformLongAction('Building reference information', '',
            procedure
            var
              i: Integer;
              _File: IwbFile;
    ...
    begin
      ...
      try
        InvalidateElementsTreeView(SelectedNodes);
        SelectedNodes := nil;
        for i := Low(CellNodes) to High(CellNodes) do
        begin
    ...
    begin
      ...
      if (Length(Nodes) > 1) or (GetKeyState(VK_SHIFT) < 0) then
      begin
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            if s = '' then
            begin
              s := MainRecord._File.FileFormIDtoLoadOrderFormID
                (MainRecord._File.NewFormID, True).ToString(False);
              if not InputQuery('New FormID generated',
                'Please verify the newly generated FormID. The FormID needs to be a load order corrected form ID.',
                s) then
                Exit;
            end;
            NewFormID := TwbFormID.FromStr(s);
        ...
        AddMessage('Changing FormID [' + OldFormID.ToString(True) +
          '] in file "' + MainRecord._File.FileName + '" to [' +
          NewFormID.ToString(True) + ']');
        ...
        try
          ...
          begin
            if Files[i].LoadOrder >= _OldFile.LoadOrder then
              Break;
            if Files[i].LoadOrderFileID = NewFileID then
            begin
        ...
        AddMessage('Record is referenced by ' + IntToStr(Length(ReferencedBy)) +
          ' other record(s)');
        try
          if Master.OverrideCount <> 0 then
          begin
            k := -1;
            ...
            begin
              ...
              if Overrides[i].Equals(MainRecord) then
                k := i;
            end;
            // if it is not the last override and user confirms
            if (k < Pred(Length(Overrides))) and
              (MessageDlg('Record ' + MainRecord.Name +
              ' has later overrides, update them too?', mtConfirmation,
            ...
            begin
              ...
              for i := k to Pred(Length(Overrides)) do
              begin
          ...
          if Length(ReferencedBy) > 0 then
            ShowChangeReferencedBy(OldFormID, NewFormID, ReferencedBy,
              Assigned(_File));
        except
          on E: Exception do
          begin
      ...
      begin
        ...
        begin
          ...
          if Supports(NamedDef, IwbIntegerDef, IntegerDef) and
            Supports(IntegerDef.Formater[Element], IwbFlagsDef, Flags) then
          begin
            ...
            with TfrmFileSelect.Create(Self) do
              try
                ...
                for i := 0 to Pred(Flags.FlagCount) do
                begin
                  CheckListBox1.AddItem(Flags.Flags[i, False], nil);
                  CheckListBox1.Checked[i] := (i < Length(EditValue)) and
                    (EditValue[i + 1] = '1');
                end;
          ...
          // localization editor
          else if Element._File.IsLocalized and Assigned(Element.ValueDef) and
            (Element.ValueDef.DefType = dtLString) then
          begin
            with TfrmLocalization.Create(Self) do
              try
          ...
          // string editor
          else if not InputQuery('Edit Value', 'Please change the value:',
            EditValue) then
            Exit;
    ...
    begin
      ...
      if Column > High(ActiveRecords) then
        Exit;
      if not Supports(ActiveRecords[Column].Element, IwbMainRecord, MainRecord)
      then
        Exit;
      ...
      CopyInto(AsNew, AsWrapper, False,
        (Sender = mniViewHeaderDeepCopyAsOverride) or
        (Sender = mniViewHeaderDeepCopyAsOverrideWithOverwriting),
        (Sender = mniViewHeaderCopyAsOverrideWithOverwriting) or
        (Sender = mniViewHeaderDeepCopyAsOverrideWithOverwriting),
        [MainRecord]);
    ...
    begin
      ...
      DialogResult := MessageDlg('Are you sure you want to permanently remove '
        + Element.Name + ' from file "' + Element._File.FileName + '"?',
        mtConfirmation, [mbYes, mbNo], 0);
    ...
    procedure TfrmMain.mniNavGenerateLODClick(Sender: TObject);
      ...
      begin
        if aName = '888' then
          Result := ifR8G8B8
        else if aName = '8888' then
          Result := ifA8R8G8B8
        else if aName = '565' then
          Result := ifR5G6B5
        else if aName = 'DXT1' then
          Result := ifDXT1
        else if aName = 'DXT3' then
          Result := ifDXT3
        else if aName = 'DXT5' then
          Result := ifDXT5
        else if aName = 'BC4' then
          Result := ifATI1n
        else if aName = 'BC5' then
          Result := ifATI2n
        else
          Result := ifDXT5;
      end;
    ...
    begin
            ...
            begin
              for j := 0 to Pred(Group.ElementCount) do
                ...
                begin
                  ...
                  if (wbIsSkyrim or wbIsFallout3 or wbIsFallout4) and
                    not wbContainerHandler.ResourceExists
                    (wbLODSettingsFileName(MainRecord.EditorID)) then
                    Continue;
                  if MainRecord.Signature = 'WRLD' then
                  begin
                    // do not list worldspace if Use LOD Data flag of parent world is set - FO4 has a orphaned LOD data for Diamond City
                    if MainRecord.ElementExists['Parent\WNAM'] and
                      (MainRecord.ElementNativeValues['Parent\PNAM\Flags'] and
                      $2 = $2) then
                      Continue;
                    SetLength(Worldspaces, Succ(Length(Worldspaces)));
                    Worldspaces[High(Worldspaces)] := MainRecord;
      ...
      begin
        with TfrmFileSelect.Create(Self) do
          try
            Width := 450;
            for i := Low(Worldspaces) to High(Worldspaces) do
              CheckListBox1.AddItem(Worldspaces[i].Name,
                TObject(Pointer(Worldspaces[i])));
            CheckListBox1.Sorted := True;
            ...
            try
              for i := 0 to Pred(CheckListBox1.Count) do
                if CheckListBox1.Checked[i] then
                  wbGenerateLODTES4
                    (IwbMainRecord(Pointer(CheckListBox1.Items.Objects[i])
                    ), Settings)
            finally
              Self.Enabled := True;
              Self.Caption := Application.Title
      ...
      if wbIsSkyrim or wbIsFallout3 or wbIsFallout4 then
      begin
        with TfrmLODGen.Create(Self) do
          try
            j := -1;
            for i := Low(Worldspaces) to High(Worldspaces) do
            begin
              clbWorldspace.AddItem(Worldspaces[i].Name,
                TObject(Pointer(Worldspaces[i])));
              // default selected worldspace at the top
              if (Worldspaces[i].LoadOrderFormID.ToCardinal = $0000003C) or
                ((wbGameMode = gmFNV) and
                (Worldspaces[i].LoadOrderFormID.ToCardinal = $000DA726)) then
                j := i;
            end;
            ...
            begin
              ...
              fDefaultUVRange := 1.1;
              iDefaultAtlasDiffuseFormat := ifDXT5;
              // DXT5 generally seems better with tree LOD
              iDefaultAtlasNormalFormat := ifATI2n;
            end;

            if Assigned(Sender) and (wbGameMode in [gmSSE, gmTES5VR]) then
            begin
              ...
              cbObjectsLOD.Checked := Settings.ReadBool(Section,
                'ObjectsLOD', True);

            cbBuildAtlas.Checked := Settings.ReadBool(Section,
              'BuildAtlas', True);
            cmbAtlasWidth.ItemIndex := IndexOf(cmbAtlasWidth.Items,
              Settings.ReadString(Section, 'AtlasWidth',
              IntToStr(iDefaultAtlasWidth)));
            cmbAtlasHeight.ItemIndex := IndexOf(cmbAtlasHeight.Items,
              Settings.ReadString(Section, 'AtlasHeight',
              IntToStr(iDefaultAtlasHeight)));
            cmbAtlasTextureSize.ItemIndex := IndexOf(cmbAtlasTextureSize.Items,
              Settings.ReadString(Section, 'AtlasTextureSize', '512'));
            cmbAtlasTextureUVRange.ItemIndex :=
              IndexOf(cmbAtlasTextureUVRange.Items, Settings.ReadString(Section,
              'AtlasTextureUVRange', FloatToStrF(fDefaultUVRange,
              ffFixed, 99, 1)));
            cmbCompDiffuse.ItemIndex := IndexOf(cmbCompDiffuse.Items,
              ImageFormatToStr(TImageFormat(Settings.ReadInteger(Section,
              'AtlasDiffuseFormat', Integer(iDefaultAtlasDiffuseFormat)))));
            cmbCompDiffuseChange(nil);
            cmbCompNormal.ItemIndex := IndexOf(cmbCompNormal.Items,
              ImageFormatToStr(TImageFormat(Settings.ReadInteger(Section,
              'AtlasNormalFormat', Integer(iDefaultAtlasNormalFormat)))));
            cmbCompSpecular.ItemIndex := IndexOf(cmbCompSpecular.Items,
              ImageFormatToStr(TImageFormat(Settings.ReadInteger(Section,
              'AtlasSpecularFormat', Integer(iDefaultAtlasSpecularFormat)))));
            cmbDefaultAlphaThreshold.ItemIndex :=
              IndexOf(cmbDefaultAlphaThreshold.Items,
              Settings.ReadString(Section, 'DefaultAlphaThreshold',
              IntToStr(iDefaultAlphaThreshold)));
            cbNoTangents.Checked := Settings.ReadBool(Section,
              'ObjectsNoTangents', False);
            cbNoVertexColors.Checked := Settings.ReadBool(Section,
              'ObjectsNoVertexColors', False);
            cbUseAlphaThreshold.Checked := Settings.ReadBool(Section,
              'ObjectsUseAlphaThreshold', False);
            cbUseBacklightPower.Checked := Settings.ReadBool(Section,
              'ObjectsUseBacklightPower', False);
            cbChunk.Checked := Settings.ReadBool(Section, 'Chunk', False);
            cmbLODLevel.ItemIndex := IndexOf(cmbLODLevel.Items,
              Settings.ReadString(Section, 'LODLevel', ''));
            ...
            cbTrees3D.Checked := Settings.ReadBool(Section, 'Trees3D',
              False { wbGameMode in [gmSSE] } );
            cmbTreesLODBrightness.ItemIndex :=
              IndexOf(cmbTreesLODBrightness.Items, Settings.ReadString(Section,
              'TreesBrightness', '0'));
            if wbIsFallout4 then
            begin
            ...
            Settings.WriteString(Section, 'AtlasTextureSize',
              cmbAtlasTextureSize.Text);
            Settings.WriteString(Section, 'AtlasTextureUVRange',
              cmbAtlasTextureUVRange.Text);
            Settings.WriteInteger(Section, 'AtlasDiffuseFormat',
              Integer(StrToImageFormat(cmbCompDiffuse.Text)));
            Settings.WriteInteger(Section, 'AtlasNormalFormat',
              Integer(StrToImageFormat(cmbCompNormal.Text)));
            Settings.WriteInteger(Section, 'AtlasSpecularFormat',
              Integer(StrToImageFormat(cmbCompSpecular.Text)));
            Settings.WriteString(Section, 'DefaultAlphaThreshold',
              cmbDefaultAlphaThreshold.Text);
            Settings.WriteBool(Section, 'ObjectsNoTangents',
              cbNoTangents.Checked);
            Settings.WriteBool(Section, 'ObjectsNoVertexColors',
              cbNoVertexColors.Checked);
            Settings.WriteBool(Section, 'ObjectsUseAlphaThreshold',
              cbUseAlphaThreshold.Checked);
            Settings.WriteBool(Section, 'ObjectsUseBacklightPower',
              cbUseBacklightPower.Checked);
            ...
            Settings.WriteBool(Section, 'Trees3D', cbTreesLOD.Checked and
              cbTrees3D.Checked);
            Settings.WriteString(Section, 'TreesBrightness',
              cmbTreesLODBrightness.Text);
            Settings.UpdateFile;

            lodTypes := [];
            if cbObjectsLOD.Checked then
              lodTypes := lodTypes + [lodObjects];
            if cbTreesLOD.Checked then
              lodTypes := lodTypes + [lodTrees];
              ...
              for i := 0 to Pred(clbWorldspace.Count) do
                if clbWorldspace.Checked[i] then
                  if wbIsSkyrim or wbIsFallout3 then
                    wbGenerateLODTES5
                      (IwbMainRecord(Pointer(clbWorldspace.Items.Objects[i])),
                      lodTypes, Files, Settings)
    ...
    var
      ...
      Race: string;
      FormID: TwbFormID;
      FormIDs: array of record FormID: TwbFormID;
      LoadOrder: Integer;
    end;
    begin
      ...
      FormIDs := nil;
      for i := Low(Files) to High(Files) do
        if Supports(Files[i].GroupBySignature['LVLI'], IwbContainerElementRef,
          Group) then
          for j := 0 to Pred(Group.ElementCount) do
            if Supports(Group.Elements[j], IwbMainRecord, MainRecord) then
        ...
        if Supports(Files[i].GroupBySignature['NPC_'], IwbContainerElementRef,
          ...
          for j := 0 to Pred(Group.ElementCount) do
            ...
            begin
              ...
              Race := '';
              if Supports(MainRecord.RecordBySignature['RNAM'],
                IwbContainerElementRef, Container) then
              ...
              if Supports(MainRecord.ElementByName['Items'],
                IwbContainerElementRef, Container) then
                for k := 0 to Pred(Container.ElementCount) do
                  if Supports(Container.Elements[k], IwbContainerElementRef,
                    Container2) then
                    if Container2.ElementCount = 2 then
                    begin
                      if Supports(Container2.Elements[0].LinksTo, IwbMainRecord,
                        MainRecord2) then
                      begin
                        if MainRecord2.Signature = 'LVLI' then
                          if LVLIs.Find(MainRecord2.EditorID + Race, l) then
                          begin
                            with FormIDs[Cardinal(LVLIs.Objects[l])] do
                              if LoadOrder <= Files[i].LoadOrder then
                                try
                                  Container2.Elements[0].EditValue :=
                                    FormID.ToString(False)
                                except
                                  on E: Exception do
                                    PostAddMessage('Error updating Item ' +
                                      MainRecord2.Name + ' for ' +
                                      MainRecord.Name + ': ' + E.Message);
                                end;
                          end;
                      end;
                    end;
    ...
    begin
      ...
      begin
        ...
        if ContainsChilds then
          DialogResult :=
            MessageDlg('Are you sure you want to permanently remove ' +
            Element.Name + ' and all other records it contains?', mtWarning,
            [mbYes, mbNo], 0)
        else
          DialogResult :=
            MessageDlg('Are you sure you want to permanently remove ' +
            Element.Name + '?', mtConfirmation, [mbYes, mbNo], 0);
      end
      else
      begin
        if ContainsChilds then
          DialogResult :=
            MessageDlg('Are you sure you want to permanently remove the ' +
            IntToStr(Length(Selection)) +
            ' removeable selected records and all other records they contain?',
            mtWarning, [mbYes, mbNo], 0)
        else
          DialogResult :=
            MessageDlg('Are you sure you want to permanently remove the ' +
            IntToStr(Length(Selection)) + ' removeable selected records?',
            mtConfirmation, [mbYes, mbNo], 0);
      end;
    ...
    begin
      ...
      try
          ...
          try
            ...
            begin
              ...
              if Supports(NodeData.Element, IwbMainRecord, MainRecord) and
                ...
                not MainRecord.IsVisibleWhenDistant and IsExterior(MainRecord)
                and Supports(MainRecord.RecordBySignature['NAME'],
                IwbContainerElementRef, NameRec) and
                Supports(NameRec.LinksTo, IwbMainRecord, MainRecord2) and
                MainRecord2.HasVisibleWhenDistantMesh then
              begin
        ...
        AddMessage('[Setting VWD for all REFR with VWD Mesh] ' +
          ' Processed Records: ' + IntToStr(Count) + ' Change Records: ' +
          IntToStr(ChangeCount) + ' Elapsed Time: ' + FormatDateTime('nn:ss',
          Now - wbStartTime));
        vstNav.Invalidate;
      finally
        vstNav.EndUpdate;
    ...
    begin
      ...
      vstNav.BeginUpdate;
      try
        PerformLongAction(sJustWaitScan, '',
          procedure
          var
            i, j: Integer;
          begin
            ...
            try
              ...
              begin
                ...
                begin
                  ...
                  if Supports(NodeData.Element, IwbMainRecord, MainRecord) and
                    (MainRecord.Signature = 'REFR') and IsExterior(MainRecord)
                  then
                  begin
            ...
            if Length(Elements) > 1 then
            begin
              wbMergeSortPtr(@Elements[0], Length(Elements),
                CompareElementsFormIDAndLoadOrder);

              j := 0;
              for i := Succ(Low(Elements)) to High(Elements) do
              begin
                if (Elements[j] as IwbMainRecord).LoadOrderFormID <>
                  (Elements[i] as IwbMainRecord).LoadOrderFormID then
                  Inc(j);
                if j <> i then
                  Elements[j] := Elements[i];
              end;
            ...
            begin
              ...
              begin
                ...
                if not MainRecord.IsVisibleWhenDistant and
                  Supports(MainRecord.RecordBySignature['NAME'],
                  IwbContainerElementRef, NameRec) and Supports(NameRec.LinksTo,
                  IwbMainRecord, MainRecord2) and MainRecord2.HasVisibleWhenDistantMesh
                then
                begin

                  if MainRecord.HasErrors then
                    AddMessage
                      ('[Setting VWD for all REFR with VWD Mesh] Skipping: ' +
                      MainRecord.Name)
                  else
                  begin
                    if j <> i then
            ...
            if Length(Elements) > 0 then
              CopyInto(False, False, False, False, False, Elements,
                SetVWDCallback);
          end);
    ...
    begin
      DoSetActiveRecord(nil);
      PerformActionOnSelectedFiles('sorting masters',
        procedure(aFile: IwbFile)
        begin
          aFile.SortMasters;
        end);
    ...
    begin
      ...
      for i := Low(Selected) to High(Selected) do
        if (Selected[i].Signature = 'REFR') and Selected[i].IsEditable then
        begin
          ...
          if not Assigned(Selected[i].Container.Container) then
            Continue;
          if not Supports(Selected[i].Container.Container, IwbGroupRecord,
            GroupRecord) then
            Continue;
          ...
          for j := Low(Cells) to Pred(k) do
            if MainRecord.Equals(Cells[i]) then
            begin
              FoundIt := True;
              Break;
            end;
    ...
    procedure TfrmMain.LoadModGroupsSelection(const aModGroups
      : TwbModGroupPtrs);
    var
      i, j: Integer;
    begin
    ...
    function TfrmMain.LOOTDirtyInfo(const aInfo: TLOOTPluginInfo;
    aFileChanged: Boolean): string;
    ...
    begin
      Result := '';
      if (aInfo.ITM <> 0) or (aInfo.UDR <> 0) or (aInfo.NAV <> 0) then
      begin
        if aFileChanged then
          Result := CRLF + Format(StringOfChar(' ', 2) + '- name: ''%s''',
            [aInfo.Plugin]) + CRLF;
        ...
        Result := Result + CRLF + Format(StringOfChar(' ', 8) + 'crc: 0x%s',
          [IntToHex(aInfo.CRC32, 8)]);
        Result := Result + CRLF +
          Format(StringOfChar(' ', 8) + 'util: ''[%sEdit v%s](%s)''',
          [wbAppName, VersionString.ToString, wbNexusModsUrl]);
        if aInfo.ITM <> 0 then
          Result := Result + CRLF + Format(StringOfChar(' ', 8) + 'itm: %d',
            [aInfo.ITM]);
        if aInfo.UDR <> 0 then
          Result := Result + CRLF + Format(StringOfChar(' ', 8) + 'udr: %d',
            [aInfo.UDR]);
        if aInfo.NAV <> 0 then
          Result := Result + CRLF + Format(StringOfChar(' ', 8) + 'nav: %d',
            [aInfo.NAV]);
      end
      else if (aInfo.ITM = 0) and (aInfo.UDR = 0) and (aInfo.NAV = 0) then
      begin
        if aFileChanged then
          Result := CRLF + Format(StringOfChar(' ', 2) + '- name: ''%s''',
            [aInfo.Plugin]) + CRLF;
        Result := Result + StringOfChar(' ', 4) + 'clean:';
        Result := Result + CRLF + Format(StringOfChar(' ', 6) + '- crc: 0x%s',
          [IntToHex(aInfo.CRC32, 8)]);
        Result := Result + CRLF +
          Format(StringOfChar(' ', 8) + 'util: ''%sEdit v%s''',
          [wbAppName, VersionString.ToString]);
      end;
    end;
    ...
    begin
      Result := '';
      if (aInfo.ITM <> 0) or (aInfo.UDR <> 0) then
      begin
        Result := Result + CRLF + aInfo.Plugin;
        Result := Result + CRLF +
          Format('  IF CHECKSUM("%s", %s) DIRTY: %d ITM, %d UDR records. Needs %sEdit cleaning: "http://cs.elderscrolls.com/index.php?title=TES4Edit_Cleaning_Guide"',
          [aInfo.Plugin, IntToHex(aInfo.CRC32, 8), aInfo.ITM, aInfo.UDR,
          wbAppName]);
      end;
    end;
    ...
    var
      ...
      begin
        ...
        // skip navmeshes
        if MainRecord.Signature = 'NAVM' then
        begin
          Result := False;
          Inc(DeletedNAVM);
        end
        // skip injected or bad refs (crashes after cleaning TES4 Battlehorn DLC)
        else if MainRecord.IsInjected or (not Assigned(LinksToRecord)) then
        begin
          Result := False;
          Inc(NotDeletedCount);
        end
        // skip refs of TREEs with LOD in FNV
        else if (wbGameMode in [gmFNV]) and (LinksToRecord.Signature = 'TREE')
          and LinksToRecord.Flags.HasLODtree then
        begin
          Result := False;
          Inc(NotDeletedCount);
        end;
    ...
    begin
      ...
      if not FilterApplied or FilterConflictAll or FilterConflictThis or
        FilterByInjectStatus or FilterByPersistent or FilterByVWD or
        (FilterByNotReachableStatus and ReachableBuild) or
        FilterByReferencesInjectedStatus or FilterByEditorID or FilterByName or
        FilterBySignature or FilterByBaseEditorID or FilterByBaseName or
        FilterScaledActors or FilterByBaseSignature or FlattenBlocks or
        FlattenCellChilds or AssignPersWrldChild or ModGroupsEnabled or
        OnlyShowMasterAndLeafs or wbQuickShowConflicts or not InheritConflictByParent
      then
      begin

        MessageDlg
          ('To use this function you need to apply a filter with *only* the option "Conflict status inherited by parent" active and ModGroups, "Show Master and Leafs", and "Quick Show Conflict" mode disabled.',
          mtError, [mbOk], 0);
        Exit;
      end;
      ...
      try
              ...
              if Supports(NodeData.Element, IwbMainRecord, MainRecord) then
                ...
                begin
                  if Assigned(MainRecord._File) then
                    with MainRecord._File do
                    begin
                      Plugin := FileName;
                      PluginCRC32 := CRC32;
                    end;
                  if IsEditable and
                    (IsDeleted { or (GetPosition(Position) and (Position.z = -30000.0)) and (MainRecord.ElementNativeValues['XESP\Reference'] <> $14) } )
                    and ((Signature = 'REFR') or (Signature = 'PGRE') or
                    (Signature = 'PMIS') or (Signature = 'ACHR') or
                    (Signature = 'ACRE') or (Signature = 'NAVM') or
                    ...
                    begin
                      ...
                      begin
                        IsDeleted := True;
                        IsDeleted := False;
                        if (wbIsSkyrim or wbIsFallout3 or wbIsFallout4 or
                          wbIsFallout76) and
                          ((Signature = 'ACHR') or (Signature = 'ACRE')) then
                          IsPersistent := True
                        else if wbGameMode = gmTES4 then
                          IsPersistent := False;
                        if not IsPersistent then
                          if wbUDRSetZ and GetPosition(Position) then
                          begin
                        ...
                        if wbUDRSetXESP and Supports(Add('XESP', True),
                          IwbContainerElementRef, Cntr) then
                        begin
                          Cntr.ElementNativeValues['Reference'] := $14;
                          Cntr.ElementNativeValues['Flags'] := 1;
                        end;

                        if wbUDRSetScale then
                        begin
                        ...
                        if wbUDRSetMSTT and wbIsFallout3 then
                        begin
                          Element := ElementBySignature['NAME'];
                          if Assigned(Element) then
                            if Supports(Element.LinksTo, IwbMainRecord,
                              LinksToRecord) then
        ...
        PostAddMessage('[' + Operation + 'ing and Disabling References done] ' +
          ' Processed Records: ' + IntToStr(Count) + ', ' + Operation +
          'ed Records: ' + IntToStr(UndeletedCount) + ', Elapsed Time: ' +
          FormatDateTime('nn:ss', Now - wbStartTime));
        if DeletedNAVM > 0 then
          PostAddMessage('<Warning: Plugin contains ' + IntToStr(DeletedNAVM) +
            ' deleted NavMeshes which can not be undeleted>');
        if NotDeletedCount > 0 then
          PostAddMessage('<Warning: Plugin contains ' +
            IntToStr(NotDeletedCount) +
            ' deleted references which can not be undeleted>');
        ...
        begin
          ...
          for i := Low(LOOTPluginInfos) to High(LOOTPluginInfos) do
            if (LOOTPluginInfos[i].Plugin = Plugin) and
              (LOOTPluginInfos[i].CRC32 = PluginCRC32) then
            begin
              DirtyInfo := @LOOTPluginInfos[i];
              Break;
            end;
          if not Assigned(DirtyInfo) then
          begin
    ...
    begin
      with TfrmModuleSelect.Create(Self) do
        try
          ...
          MissingCurrent := AllModules.FilteredByFlag
            (mfModGroupMissingCurrentCRC);

          if (Length(MissingAny) > 0) and (Length(MissingCurrent) > 0) then
          begin
            if MessageDlg
              ('Do you wish to add CRCs to ModGroup Items which currently do not contain any CRCs?',
              mtConfirmation, mbYesNo, 0) <> mrYes then
              MissingAny := nil
            else if MessageDlg
              ('Do you wish to update CRCs in ModGroup Items which already contain CRCs, but are missing the current one?',
              mtConfirmation, mbYesNo, 0) <> mrYes then
              MissingCurrent := nil;
          end;

          if Length(MissingAny) > 0 then
          begin
            if Length(MissingCurrent) > 0 then
            begin
              Caption :=
                'Please select the modules for which you want to add or update the current CRC to/in ModGroup Items...';
              AllModules := AllModules.FilteredBy(
                function(aModule: PwbModuleInfo): Boolean
                begin
                  Result := aModule.miFlags * [mfModGroupMissingAnyCRC,
                    mfModGroupMissingCurrentCRC] <> [];
                end);
            end
            else
            begin
              Caption :=
                'Please select the modules for which you want to add the current CRC to ModGroups';
          ...
          begin
            ...
            begin
              Caption :=
                'Please select the modules for which you want to update the current CRC in ModGroups...';
      ...
      with TfrmModGroupSelect.Create(Self) do
        try
          AllModGroups := wbModGroupsByName(False);
          AllModGroups.ExcludeAll(mgfTagged);
          AllModGroups.FlagModGroupsNeedingCRCUpdateForTaggedFiles
            (Length(MissingAny) > 0, Length(MissingCurrent) > 0);
          ...
          UpdatedCount := SelectedModGroups.UpdateCRC(Length(MissingAny) > 0,
            Length(MissingCurrent) > 0);
          case UpdatedCount of
            0:
              ShowMessage('No ModGroups have been updated.');
            1:
              ShowMessage('One ModGroup has been updated.');
          else
            ShowMessage(UpdatedCount.ToString +
              ' ModGroups have been updated.');
          end;
        finally
          Free;
        end;
    ...
    begin
      ...
      try
          ...
          try
            ...
            begin
              ...
              begin
                ...
                { and (NodeData.ConflictAll = caNoConflict) } and
                  ...
                  not(Supports(NodeData.Element, IwbMainRecord, MainRecord) and
                  MainRecord.MasterOrSelf.IsInjected) then
                begin
                  MainRecord := nil;

                  if Assigned(NodeData.Element._File) then
                    with NodeData.Element._File do
                    begin
                      Plugin := FileName;
                      PluginCRC32 := CRC32;
                    end;
                  ...
                  begin
                    if not HideRemoveMessage then
                      PostAddMessage(Operation + 'ing: ' +
                        NodeData.Element.Name);
                    if not AutoModeCheckForITM then
                    begin
                      if Assigned(NodeData.Container) and
                        not NodeData.Container.Equals(NodeData.Element) then
        ...
        PostAddMessage('[' + Operation +
          'ing "Identical to Master" records done] ' + ' Processed Records: ' +
          IntToStr(Count) + ', ' + Operation + 'ed Records: ' +
          IntToStr(RemovedCount) + ', Elapsed Time: ' + FormatDateTime('nn:ss',
          Now - wbStartTime));
        // Does not show up if handling "a lot" of records !
    ...
    begin
      ...
      for i := Low(LOOTPluginInfos) to High(LOOTPluginInfos) do
      begin
        FileChanged := (i = 0) or not sameText(LOOTPluginInfos[i].Plugin,
          LOOTPluginInfos[Pred(i)].Plugin);
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            ViewFocusedElement := NodeDatas[Pred(vstView.FocusedColumn)
              ].Element;
          end;
    ...
    begin
      ...
      if Assigned(NodeDatas) then
        ...
        begin
          Element := NodeDatas[i].Element;
          if Assigned(Element) and Element.IsRemoveable then
          begin
            if not EditWarn then
              Exit;
            Element.Remove;
    ...
    function CompareViewRow(List: TStringList; Index1, Index2: Integer)
      : Integer;
    var
    ...
    begin
      ...
      try
        ...
        vstNav.TreeOptions.AutoOptions := vstNav.TreeOptions.AutoOptions +
    ...
    procedure TfrmMain.mniNavLocalizationSwitchClick(Sender: TObject);
      ...
      procedure GatherLStrings(const aElement: IwbElement;
      var lst: TDynElements);
      var
        Container: IwbContainerElementRef;
        i: Integer;
      begin
        if Assigned(aElement.ValueDef) and
          (aElement.ValueDef.DefType = dtLString) then
        begin
    ...
    begin
      ...
      try
        ...
        begin
          ...
          with TfrmLocalizePlugin.Create(Self) do
            try
              ...
              if fTranslate then
                ...
                begin
                  j := 0;
                  if clbFrom.Checked[i] then
                    j := j or 1;
                  if clbTo.Checked[i] then
                    j := j or 2;
        ...
        try
          ...
          begin
            ...
            for i := 0 to Pred(lFiles.Count) do
            begin
              if Integer(lFiles.Objects[i]) and 1 > 0 then
              begin
                wblf := TwbLocalizationFile.Create
                  (wbLocalizationHandler.StringsPath + lFiles[i]);
                for j := 0 to Pred(wblf.Count) do
                  lFrom.Add(AnsiLowerCase(wblf.Items[j]));
                wblf.Destroy;
              end;

              if Integer(lFiles.Objects[i]) and 2 > 0 then
              begin
                wblf := TwbLocalizationFile.Create
                  (wbLocalizationHandler.StringsPath + lFiles[i]);
          ...
          if fLocalize and fTranslate then
          begin
            FreeAndNil(lFrom);
            FreeAndNil(lTo);
          end;
          ...
          wbLocalizationHandler.NoTranslate := False;
          Enabled := True;
          PostAddMessage('[Processing done] ' + ' Localizable Strings: ' +
            IntToStr(Length(lstrings)) + ' Translated: ' + IntToStr(Translated)
    ...
    begin
      with TfrmLogAnalyzer.Create(Self) do
      begin
        Caption := StringReplace((Sender as TMenuItem).Caption, '&', '',
          [rfReplaceAll]);
    ...
    var
      ...
      begin
        ...
        if lblFilterHint.Visible then
        begin
          ShowMessage
            ('Please ensure the treeview is not fossilized (remove the filter) before using this function.');
          Exit;
        end;
        ...
        begin
          with TfrmModuleSelect.Create(Self) do
            try
              ...
              AllowCancel;
              Caption :=
                'Please select the master you want to inject new records into...';
              if ShowModal <> mrOK then
                Exit;
              TargetFile := SelectedModules[0]._File;

              if MessageDlg('Do you want to try and preserve ObjectIDs?',
                mtConfirmation, mbYesNo, 0, mbNo) = mrYes then
                PreserveObjectID := True;
              if PreserveObjectID then
                if MessageDlg
                  ('Do you want to abort if not all ObjectIDs can be preserved?',
        ...
        begin
          s := '';
          TargetIsESL := TargetFile.IsESL or
            TargetFile.LoadOrderFileID.IsLightSlot;
          repeat
            if s <> '' then
            ...
            if TargetIsESL then
            begin
              if not InputQuery('Start from...',
                'Please enter the new module specific start FormID in hex. e.g. 800. Specify only the last 3 digits. (Target is ESL)',
                s) then
                Exit;
            end
            else
            begin
              if not InputQuery('Start from...',
                'Please enter the new module specific start FormID in hex. e.g. 200000. Specify only the last 6 digits.',
                s) then
                Exit;
            end;

            StartFormID := TwbFormID.FromStrDef(s, 0);
          until (StartFormID.FileID.FullSlot = 0) and
            not StartFormID.IsHardcoded and
            (not TargetIsESL or (StartFormID.ObjectID <= $FFF));
        end;

        SetLength(MainRecords, SourceFile.RecordCount);
        j := 0;
        for i := Pred(SourceFile.RecordCount) downto 0 do
        begin
          MainRecords[j] := SourceFile.Records[i];
          if MainRecords[j].LoadOrderFormID.FileID = SourceFile.LoadOrderFileID
          then
            Inc(j);
        end;
        if j < 1 then
        ...
        if Sender = mniNavCompactFormIDs then
          EndFormID := TwbFormID.FromCardinal($FFF)
            .ChangeFileID(TargetFile.LoadOrderFileID)
        else if not TargetFile.Equals(SourceFile) then
        begin
          if TargetFile.IsESL then
            EndFormID := TwbFormID.FromCardinal($FFF)
              .ChangeFileID(TargetFile.LoadOrderFileID)
          else
            EndFormID := TwbFormID.FromCardinal($FFFFFF)
              .ChangeFileID(TargetFile.LoadOrderFileID);
        end
        else
        begin
        ...
        try
          ...
          j := 0;
          i := 0;
          for k := High(MainRecords) downto Low(MainRecords) do
          begin
            ...
            begin
              ...
              repeat
                ...
                begin
                  if NewFormID.IsNull then
                    NewFormID := OldFormID.ChangeFileID
                      (TargetFile.LoadOrderFileID)
                  else if AllOrNothing then
                  begin
                    ShowMessage
                      (Format('The FormID [%s] which should be assigned to: ' +
                      CRLF + CRLF + '%s' + CRLF + CRLF + 'is already in use by:'
                      + CRLF + CRLF + '%s' + CRLF + CRLF + 'Operation aborted.',
                      [NewFormID.ToString, MainRecord.Name,
                      TargetMainRecord.Name]));
                    Exit;
                  end
                  else
                  begin
                ...
                TargetMainRecord := TargetFile.ContainedRecordByLoadOrderFormID
                  [NewFormID, True];
              until not Assigned(TargetMainRecord);
              TargetMainRecord := nil;
            end;

            if NewFormID > EndFormID then
            begin
              ShowMessage
                ('The file contains too many new records for this operation.');
              Exit;
            end;
          ...
          if AnyDelayed then
            ...
            begin
              ...
              repeat
                NewFormID := StartFormID + j;
                Inc(j);
              until not Assigned(TargetFile.ContainedRecordByLoadOrderFormID
                [NewFormID, True]);
          ...
          begin
            s := '';
            if PreserveObjectID and not AllOrNothing then
            begin
              case PreservedCount of
                0:
                  s := ' No ObjectIDs could be preserved.';
                1:
                  s := ' 1 ObjectID could be preserved.';
              else
                if PreservedCount = Length(MainRecords) then
                  s := ' All ObjectIDs could be preserved.'
                else
                  s := ' ' + PreservedCount.ToString +
                    ' ObjectIDs could be preserved.';
              end;
            end;
            Result := MessageDlg('This operation will modify the FormID of ' +
              i.ToString + ' record(s).' + s + CRLF +
              'Record(s) with the following signature(s) are affected: ' +
              Signatures.DelimitedText + CRLF + CRLF +
              'WARNING: This will break existing save games that contain these FormID(s) and any module which uses "'
              + SourceFile.FileName + '" as master and references them.' + CRLF
              + CRLF + 'Are you sure you wish to continue?', mtWarning, mbYesNo,
              0, mbNo) = mrYes;
          end;
    ...
    begin
      ...
      begin
        ...
        PerformLongAction('Changing FormIDs', 'Processed Records: 0',
          procedure
          var
            AnyErrors: Boolean;
            i, j, k, l: Integer;
          ...
          begin
            ...
            begin
              ...
              wbProgress('Changing FormID [' + OldFormID.ToString(True) +
                '] in file "' + MainRecord._File.FileName + '" to [' +
                NewFormID.ToString(True) + ']');
              ...
              try
                ...
                MainRecord.LoadOrderFormID := NewFormID;
                if Length(Overrides) > 0 then
                begin
                  wbProgress('Record has ' + Length(Overrides).ToString +
                    ' override(s)');
                ...
                if Length(ReferencedBy) > 0 then
                begin
                  wbProgress('Record is referenced by ' + Length(ReferencedBy)
                    .ToString + ' other record(s)');
                  ShowChangeReferencedBy(OldFormID, NewFormID,
                    ReferencedBy, True);
                end;
              except
                on E: Exception do
    ...
    begin
      Result := not MainRecord.IsMaster and not MainRecord.Master.IsPersistent;
    end;
    ...
    begin
      ...
      if Assigned(MasterPos) <> Assigned(ThisPos) then
      begin
        Result := True;
        Exit;
      end;
    ...
    type
      TCheckFilterNode = reference to function(aCheckConflict: Boolean)
        : Boolean;
    var
    ...
    begin
      ...
      if not FilterPreset then
      begin

        with TfrmFilterOptions.Create(nil) do
          try
            ...
            FilterByReferencesInjectedStatus :=
              cbByReferencesInjectedStatus.Checked;
      ...
      if FilterConflictThis then
        if FilterConflictThisSet = [Low(TConflictThis) .. High(TConflictThis)]
        then
      ...
      if FilterByBaseEditorID then
      begin
        FilterBaseFormID := TwbFormID.Null;
        if Length(FilterBaseEditorID) in [8, 9] then
          try
      ...
      if FilterScaledActors then
        if Assigned(BaseSignatures) then
        begin
      ...
      if Assigned(Signatures) or Assigned(BaseSignatures) then
      begin
        ...
        else { Signatures must be assigned }
        begin
          ...
          if wbVWDAsQuestChildren and not TopLevelGroups.Find('QUST', Dummy)
          then
        ...
        for i := Pred(TopLevelGroups.Count) downto 0 do
          if wbFindRecordDef(TopLevelGroups[i], MainRecordDef) then
          begin
      ...
      FilterRequiresBaseRecord := FilterByBaseEditorID or FilterByBaseName or
        FilterByHasVWDMesh;

      FilterRequiresReference := FilterByBaseFormID or
        FilterRequiresBaseRecord or FilterScaledActors or FilterByPersistent or
        FilterByVWD or FilterByHasPrecombinedMesh or Assigned(BaseSignatures);

      FilterRequiresMainRecord := FilterRequiresReference or FilterByEditorID or
        FilterByName or Assigned(Signatures) or FilterDeleted or FilterScripted;

      FilterByStatus := FilterByInjectStatus or
        FilterByReferencesInjectedStatus or FilterByNotReachableStatus;

      FilterByAnythingNotConflict := FilterByStatus or FilterRequiresMainRecord;
      ...
      begin
        ...
        begin
          ...
          if (aCheckConflict and
            ((FilterConflictAll and not(NodeData.ConflictAll
            in FilterConflictAllSet)) or (FilterConflictThis and
            not(NodeData.ConflictThis in FilterConflictThisSet)))) or
            (FilterByAnythingNotConflict and
            ((FilterByStatus and ((FilterByInjectStatus and
            ((nnfInjected in NodeData.Flags) <> FilterInjectStatus)) or
            (FilterByReferencesInjectedStatus and ((nnfReferencesInjected
            in NodeData.Flags) <> FilterReferencesInjectedStatus)) or
            (FilterByNotReachableStatus and ReachableBuild and
            ((nnfNotReachable in NodeData.Flags) <>
            FilterNotReachableStatus)))) or

            (FilterRequiresMainRecord and (not Supports(NodeData.Element,
            IwbMainRecord, MainRecord) or (FilterRequiresReference and
            not MainRecord.Def.IsReference) or (FilterRequiresBaseRecord and
            not Supports(MainRecord.BaseRecord, IwbMainRecord, BaseRecord)) or

            (FilterDeleted and not MainRecord.IsDeleted) or
            (Assigned(Signatures) and not Signatures.Find(MainRecord.Signature,
            Dummy)) or (FilterByEditorID and (Pos(AnsiUpperCase(FilterEditorID),
            AnsiUpperCase(MainRecord.EditorID)) < 1)) or (FilterByName and
            (Pos(AnsiUpperCase(FilterName), AnsiUpperCase(MainRecord.DisplayName
            [True])) < 1)) or

            (FilterRequiresReference and ((FilterByVWD and
            (MainRecord.IsVisibleWhenDistant <> FilterVWD)) or
            (FilterByBaseFormID and (MainRecord.BaseRecordID <>
            FilterBaseFormID)) or (Assigned(BaseSignatures) and
            not BaseSignatures.Find(MainRecord.BaseRecordSignature, Dummy)) or
            (FilterScaledActors and
            // BaseSignatures will have been set that only actors get this far
            (not Supports(MainRecord.RecordBySignature['XSCL'], IwbRecord,
            Rec) or SameValue(Rec.NativeValue, 1))) or

            (FilterRequiresBaseRecord and ((FilterByBaseEditorID and
            (Pos(AnsiUpperCase(FilterBaseEditorID),
            AnsiUpperCase(BaseRecord.EditorID)) < 1)) or (FilterByBaseName and
            (Pos(AnsiUpperCase(FilterBaseName),
            AnsiUpperCase(BaseRecord.DisplayName[True])) < 1)) or
            (FilterByHasVWDMesh and (BaseRecord.HasVisibleWhenDistantMesh <>
            FilterHasVWDMesh)))) or

            (FilterByPersistent and ((MainRecord.IsPersistent <>
            FilterPersistent) or (FilterUnnecessaryPersistent and
            (not IsUnnecessaryPersistent(MainRecord) or
            (FilterMasterIsTemporary and (not IsMasterTemporary(MainRecord) and
            not(FilterIsMaster and MainRecord.IsMaster))))) or
            (FilterPersistentPosChanged and not IsPositionChanged(MainRecord))))
            or (FilterByHasPrecombinedMesh and (MainRecord.HasPrecombinedMesh <>
            FilterHasPrecombinedMesh)))) or (FilterScripted and
            not CustomScriptFilter(MainRecord)))))) then
          begin
            vstNav.DeleteNode(Node);
            Result := True;
          end;
      ...
      try
        ...
        begin
          if (Sender = mniNavFilterApplySelected) or
            ...
            (Sender = mniNavFilterConflictsSelected) then
          begin
              ...
              try
                ...
                for i := 0 to Pred(CheckListBox1.Items.Count) do
                  CheckListBox1.Checked[i] :=
                    IwbFile(Pointer(CheckListBox1.Items.Objects[i])).IsTagged;

                Caption :=
                  'What files should be added to the navigation treeview before applying the filter?';
                ...
                for i := 0 to Pred(CheckListBox1.Items.Count) do
                  if CheckListBox1.Checked[i] then
                    FilterFiles.Add
                      (IwbFile(Pointer(CheckListBox1.Items.Objects[i])));
              finally
                Free;
              end;

          end;
          PerformLongAction('Applying Filter', '[Pass 1] Processed Records: 0',
            procedure
            var
              i, j: Integer;
              Count: Cardinal;
            ...
            begin
              vstNav.BeginUpdate;
              try
                ReInitTree(FilterNoGameMaster or wbTranslationMode,
                  FilterFiles);
                ...
                if Assigned(TopLevelGroups) then
                begin
                  ...
                  begin
                    ...
                    if Assigned(NodeData) and Assigned(NodeData.Element) and
                      (NodeData.Element.ElementType = etFile) then
                    begin
                      ...
                      begin
                        ...
                        NodeData := vstNav.GetNodeData(Node);
                        if Assigned(NodeData) and Assigned(NodeData.Element) and
                          (NodeData.Element.ElementType = etGroupRecord) then
                        begin
                          GroupRecord := NodeData.Element as IwbGroupRecord;
                          if GroupRecord.GroupType = 0 then
                          begin
                            if not TopLevelGroups.Find
                              (GroupRecord.GroupLabelSignature, Dummy) then
                              vstNav.DeleteNode(Node);
                          end;
                        end;
                        Node := NextNode;
                ...
                while Assigned(Node) do
                begin
                  wbCurrentProgress := '[Pass 1] Processed Records: ' +
                    Count.ToString;
                  Inc(Count);
                  wbTick;
                  ...
                  begin
                    ...
                    if NodeData.Element.ElementType = etMainRecord then
                    begin
                      MainRecord := NodeData.Element as IwbMainRecord;

                      if FilterConflictOnly then
                        if MainRecord.MasterOrSelf.OverrideCount < 2 then
                        begin
                      ...
                      if FilterOnlyOne and (Node.ChildCount = 0) then
                      begin
                        Master := MainRecord.MasterOrSelf;
                        if Master.OverrideCount > 0 then
                        begin
                          ...
                          if not Master.IsHidden then
                            Inc(j);
                          for i := 0 to Pred(Master.OverrideCount) do
                            if not Master.Overrides[i].IsHidden then
                            begin
                              Inc(j);
                              if j > 1 then
                                Break;
                      ...
                      if not(FlattenCellChilds and AssignPersWrldChild and
                        (MainRecord.Signature = 'CELL')) then
                        if CheckFilterNode(False) then
                        begin
                          // filter early
                          Node := NextNode;
                          Continue;
                      ...
                      if FilterConflictAll or FilterConflictThis or InheritConflictByParent
                      then
                      begin
                        ConflictLevelForMainRecord(MainRecord,
                          NodeData.ConflictAll, NodeData.ConflictThis);
                        if not(FlattenCellChilds and AssignPersWrldChild and
                          (MainRecord.Signature = 'CELL')) then
                          if Node.ChildCount = 0 then
                            if (FilterConflictAll and not(NodeData.ConflictAll
                              in FilterConflictAllSet)) or
                              (FilterConflictThis and not(NodeData.ConflictThis
                              in FilterConflictThisSet)) then
                            begin
                              // filter early
                              vstNav.DeleteNode(Node);
                              Node := NextNode;
                      ...
                      if FlattenCellChilds and AssignPersWrldChild then
                        ...
                        else if (MainRecord.Signature = 'CELL') and
                          Supports(MainRecord.Container, IwbGroupRecord,
                          GroupRecord) then
                          case GroupRecord.GroupType of
                            5:
                              begin { exterior cell }
                                if not PersCellChecked then
                                begin
                                  ...
                                  begin
                                    ...
                                    if Assigned(NodeData2) and
                                      Supports(NodeData2.Element,
                                      IwbGroupRecord, GroupRecord) and
                                      (GroupRecord.GroupType = 5) then
                                    begin
                                      ...
                                      begin
                                        ...
                                        if Assigned(NodeData2) and
                                        Supports(NodeData2.Element,
                                        IwbMainRecord, MainRecord2) and
                                        (MainRecord2.Signature = 'WRLD') then
                                        begin

                                        Node2 := vstNav.GetFirstChild(Node2);

                                        while Assigned(Node2) and
                                        not Assigned(PersCellNode) do
                                        begin
                                        NodeData2 := vstNav.GetNodeData(Node2);
                                        if Assigned(NodeData2) and
                                        Supports(NodeData2.Element,
                                        ...
                                        if Assigned(PersCellNode) then
                                        begin
                                        Node2 := vstNav.GetFirstChild
                                        (PersCellNode);
                                        PersCellNode := nil;
                                        ...
                                        Node2 := vstNav.GetLastChild
                                        (PersCellNode);
                                        while Assigned(Node2) do
                                        begin
                                        NextNode2 :=
                                        vstNav.GetPreviousSibling(Node2);

                                        NodeData2 := vstNav.GetNodeData(Node2);
                                        if Assigned(NodeData2) and
                                        Supports(NodeData2.Element,
                                        IwbMainRecord, MainRecord2) and
                                        MainRecord2.GetPosition(Position) then
                                        begin

                                        GridCell :=
                                        wbPositionToGridCell(Position);
                                        with GridCell do
                                        begin
                                        Inc(X, 500);
                                        Inc(Y, 500);
                                ...
                                if Assigned(PersCellNode) and
                                  MainRecord.GetGridCell(GridCell) then
                                begin
                                  ...
                                  begin
                                    ...
                                    if (X >= Low(Cells)) and (X <= High(Cells))
                                      and (Y >= Low(Cells[X])) and
                                      (Y <= High(Cells[X])) then
                                    begin

                                      for i := Low(Cells[X, Y])
                                        to High(Cells[X, Y]) do
                                      begin

                                        Node2 := Cells[X, Y, i];
                                        { NodeData2 := }
                                        vstNav.GetNodeData(Node2);
                                        vstNav.MoveTo(Node2, Node,
                    ...
                    else if NodeData.Element.ElementType = etGroupRecord then
                      if Supports(NodeData.Element, IwbGroupRecord, GroupRecord)
                      then
                    ...
                    begin
                      if (FlattenBlocks or FlattenCellChilds) and
                        Supports(NodeData.Element, IwbGroupRecord, GroupRecord)
                        and ((FlattenBlocks and (GroupRecord.GroupType
                        in [2 .. 5])) or (FlattenCellChilds and
                        (GroupRecord.GroupType in [8 .. 10]))) then
                      begin
                      ...
                      else if InheritConflictByParent and (PersCellNode <> Node)
                      then
                        InheritStateFromChildren(Node, NodeData);
                    end
                    else if NodeData.Element.Skipped then
                    begin
                      vstNav.DeleteNode(Node)
                    end
                    else if (FlattenBlocks or FlattenCellChilds) and
                      Supports(NodeData.Element, IwbGroupRecord, GroupRecord)
                      and ((FlattenBlocks and (GroupRecord.GroupType in [2 .. 5]
                      )) or (FlattenCellChilds and (GroupRecord.GroupType
                      in [8 .. 10]))) then
                      vstNav.DeleteNode(Node);
                  end
                  else
                ...
                begin
                  ...
                  Node := NextNode;
                  Inc(Count2);
                  wbCurrentProgress := '[Pass 2] Processed Records: ' +
                    Count2.ToString;
                  wbTick;
                end;

                wbCurrentProgress := '[Pass 1] Processed Records: ' +
                  Count.ToString + ', [Pass 2] Processed Records: ' +
                  Count2.ToString + ', Remaining unfiltered nodes: ' +
                  CountUnfiltered.ToString;

                for i := Low(Files) to High(Files) do
                  if (FileFiltered[i] > 0) and
                    (FileFiltered[i] < Files[i].RecordCount) then
                    wbProgress(Format('[%s] Filtered %.0n of %.0n records',
                      [Files[i].FileName, Min(Files[i].RecordCount,
                      FileFiltered[i]) + 0.0, Files[i].RecordCount + 0.0]));
    ...
    begin
      ...
      FilterConflictAllSet := [];
      FilterConflictThisSet := [ctIdenticalToMasterWinsConflict, ctConflictWins,
        ctConflictLoses];
    ...
    begin
      ...
      if ModGroupsEnabled or OnlyShowMasterAndLeafs or wbQuickShowConflicts then
      begin
    ...
    begin
      with TfrmOptions.Create(Self) do
        try
          ...
          pnlFontViewer.Font := Self.Font;
          LoadFont(Settings, 'UI', 'FontViewer', pnlFontViewer.Font);
          if wbTranslationMode then
          begin
          ...
          edUDRSetScaleValue.Text := FloatToStrF(wbUDRSetScaleValue, ffFixed,
            99, wbFloatDigits);
          cbUDRSetZ.Checked := wbUDRSetZ;
          edUDRSetZValue.Text := FloatToStrF(wbUDRSetZValue, ffFixed, 99,
            wbFloatDigits);
          ...
          if (wbShrinkButtons <> cbShrinkButtons.Checked) then
            if cbShrinkButtons.Checked then
              ShrinkButtons
            else
              ExpandButtons;
          ...
          wbUDRSetScaleValue := StrToFloatDef(edUDRSetScaleValue.Text,
            wbUDRSetScaleValue);
          ...
          wbUDRSetMSTTValue := StrToInt64Def('$' + edUDRSetMSTTValue.Text,
            wbUDRSetMSTTValue);
          ...
          Settings.WriteBool('Options', 'ActorTemplateHide',
            wbActorTemplateHide);
          ...
          Settings.WriteBool('Options', 'FocusAddedElement',
            wbFocusAddedElement);
          Settings.WriteBool('Options', 'RequireCtrlForDblClick',
            wbRequireCtrlForDblClick);
          Settings.WriteBool('Options', 'RemoveOffsetData', wbRemoveOffsetData);
          Settings.WriteBool('Options', 'ShowFlagEnumValue',
            wbShowFlagEnumValue);
          Settings.WriteBool('Options', 'ShowGroupRecordCount',
            wbShowGroupRecordCount);
          Settings.WriteBool('Options', 'ShowFileFlags', wbShowFileFlags);
          Settings.WriteInteger('Options', 'AutoCompareSelectedLimit',
            wbAutoCompareSelectedLimit);
          Settings.WriteInteger('Options', 'NavChangeDelay',
            tmrPendingSetActive.Interval);
          Settings.WriteBool('Options', 'SimpleRecords', wbSimpleRecords);
          Settings.WriteBool('Options', 'ClampFormID', wbClampFormID);
          Settings.WriteBool('Options', 'ResetModifiedOnSave',
            wbResetModifiedOnSave);
          Settings.WriteBool('Options', 'AlwaysSaveOnam', wbAlwaysSaveOnam or
            wbAlwaysSaveOnamForce);
          Settings.WriteBool('Options', 'AlignArrayElements',
            wbAlignArrayElements);
          Settings.WriteBool('Options', 'ManualCleaningHide',
            wbManualCleaningHide);
          Settings.WriteBool('Options', 'ManualCleaningAllow',
            wbManualCleaningAllow);
          Settings.WriteBool('Options', 'CollapseRecordHeader',
            wbCollapseRecordHeader);
          Settings.WriteBool('Options', 'CollapseObjectBounds',
            wbCollapseObjectBounds);
          Settings.WriteBool('Options', 'CollapseModels', wbCollapseModels);
          Settings.WriteBool('Options', 'CollapseFactions', wbCollapseFactions);
          Settings.WriteBool('Options', 'CollapseFactionRelations',
            wbCollapseFactionRelations);
          Settings.WriteBool('Options', 'CollapseItems', wbCollapseItems);
          Settings.WriteBool('Options', 'CollapseLeveledItems',
            wbCollapseLeveledItems);
          Settings.WriteBool('Options', 'CollapseEquipSlots',
            wbCollapseEquipSlots);
          Settings.WriteBool('Options', 'CollapseObjectProperties',
            wbCollapseObjectProperties);
          Settings.WriteBool('Options', 'CollapseScriptProperties',
            wbCollapseScriptProperties);
          Settings.WriteBool('Options', 'CollapseConditions',
            wbCollapseConditions);
          Settings.WriteBool('Options', 'CollapseBenignArray',
            wbCollapseBenignArray);
          ...
          Settings.WriteFloat('Options', 'UDRSetScaleValue',
            wbUDRSetScaleValue);
          ...
          Settings.WriteInteger('Options', 'UDRSetMSTTValue',
            wbUDRSetMSTTValue);
          for ct := Low(TConflictThis) to High(TConflictThis) do
            Settings.WriteInteger('ColorConflictThis',
              GetEnumName(TypeInfo(TConflictThis), Integer(ct)),
              Integer(wbColorConflictThis[ct]));
          for ca := Low(TConflictAll) to High(TConflictAll) do
            Settings.WriteInteger('ColorConflictAll',
              GetEnumName(TypeInfo(TConflictAll), Integer(ca)),
              Integer(wbColorConflictAll[ca]));
    ...
    begin
{$IFDEF USE_CODESITE}
      mniNavOtherCodeSiteLogging.Checked :=
        not mniNavOtherCodeSiteLogging.Checked;
...
{$ENDIF}
    ...
    function TfrmMain.NodeDatasForContainer(const aContainer: IwbDataContainer)
      : TDynViewNodeDatas;
    var
      i, l: Integer;
      p: string;
    ...
    function TfrmMain.NodeDatasForMainRecord(const aMainRecord: IwbMainRecord)
      : TDynViewNodeDatas;
    var
      Master: IwbMainRecord;
      Rec: IwbMainRecord;
    ...
    begin
      ...
      begin
        ...
        for i := Low(Files) to High(Files) do
          ...
          begin
            ...
            if sameText(ExtractFileExt(aMainRecord.GetFile.FileName), csDotExe)
              and not sameText(ExtractFileExt(Files[i].FileName), csDotExe) then
              Continue;
            // skip .exe file header by default
            if not sameText(ExtractFileExt(aMainRecord.GetFile.FileName),
              csDotExe) and sameText(ExtractFileExt(Files[i].FileName), csDotExe)
            then
              Continue;
      ...
      if ModGroupsEnabled and (Length(MainRecords) > 2) then
      begin
          ...
          begin
            ...
            with Modules[i]^ do
              for j := Low(miModGroupTargets) to High(miModGroupTargets) do
                Include(miModGroupTargets[j].miFlags,
        ...
        j := 0;
        for i := Low(Modules) to High(Modules) do
          if not Assigned(Modules[i]) or
            not(mfEphemeralModGroupTagged in Modules[i].miFlags) then
          begin
            if i <> j then
      ...
      j := 0;
      for i := Low(MainRecords) to High(MainRecords) do
        if not MainRecords[i].IsHidden then
        begin
          if i <> j then
            MainRecords[j] := MainRecords[i];
          Inc(j);
    ...
    procedure TfrmMain.PerformActionOnSelectedFiles(const aDesc: string;
    const aAction: TProc<IwbFile>);
    var
      Nodes: TNodeArray;
      NodeData: PNavNodeData;
    ...
    begin
      ...
      begin
        NodeData := vstNav.GetNodeData(Nodes[i]);
        if Assigned(NodeData) and Supports(NodeData.Element, IwbFile, _File)
        then
    ...
    TargetNode: PVirtualNode; TargetColumn: Integer;
    const SourceElement: IwbElement): Boolean;
    var
      TargetIndex: Integer;
      TargetElement: IwbElement;
      NewElement: IwbElement;
    ...
    begin
      ...
      if GetTargetElement(TargetTree, TargetNode, TargetColumn, TargetIndex,
        TargetElement) then
      begin
        ...
        if not AddRequiredMasters(SourceElement, TargetElement._File, False)
        then
          Exit;
        ...
        try
          ...
          if Assigned(NewElement) and (TargetIndex >= 0) and
            (TargetIndex < High(Integer)) then
          begin
            TargetNodeDatas := vstView.GetNodeData(TargetNode);
            if Assigned(TargetNodeDatas) then
            begin
              TargetNodeData := @TargetNodeDatas[Pred(TargetColumn)];
              if vnfIsAligned in TargetNodeData.ViewNodeFlags then
                if Supports(TargetElement, IwbContainerElementRef,
                  TargetContainer) then
                begin
    ...
    procedure TfrmMain.PerformLongAction(const aDesc, aProgress: string;
    const aAction: TProc);
    var
      HadTick: Boolean;
      HadLastMsg: Boolean;
    ...
    begin
      ...
      try
        ...
        begin
          ...
          s := s + ', Elapsed Time: ' + FormatDateTime('nn:ss',
            Now - wbLocalStartTime);
          wbProgress(s);
        end;
      finally
        Enabled := WasEnabled;
    ...
    begin
      ...
      begin
        if lvReferencedBy.Tag <> lvReferencedBy.Items.Count then
        begin
          lvReferencedBy.Items.BeginUpdate;
          try
            lvReferencedBy.Items.Clear;
            ...
            begin
              ...
              begin
                for i := 0 to Pred(ActiveMaster.ReferencedByCount) do
                  with lvReferencedBy.Items.Add do
                  begin
      ...
      else if pgMain.ActivePage = tbsView then
        CheckViewForChange;
    end;
    ...
    begin
      ...
      mniMainLocalization.Visible :=
        (wbIsSkyrim or wbIsFallout4 or wbIsFallout76);
      ...
      mniMainPluggyLink.Visible := (wbGameMode = gmTES4) or
        FileExists(wbDataPath + 'xEdit\xEditLink.ini');
      if wbGameMode <> gmTES4 then
      ...
      mniMainPluggyLinkInventory.Visible := mniMainPluggyLink.Visible and
        (wbGameMode = gmTES4);
      mniMainPluggyLinkSpell.Visible := mniMainPluggyLink.Visible and
        (wbGameMode = gmTES4);
      mniMainPluggyLinkEnchantment.Visible := mniMainPluggyLink.Visible and
        (wbGameMode = gmTES4);
...
{$ENDIF}
      ...
      mniNavHidden.Checked := Assigned(Element) and
        (esHidden in Element.ElementStates);

      mniNavChangeFormID.Visible := not wbTranslationMode and wbEditAllowed and
        Assigned(Element) and (Element.ElementType = etMainRecord) and
        Element.IsEditable;
      ...
      mniNavRenumberFormIDsFrom.Visible := not wbTranslationMode and
        wbEditAllowed and Assigned(Element) and (Element.ElementType = etFile)
        and Element.IsEditable;

      mniNavCompactFormIDs.Visible := mniNavRenumberFormIDsFrom.Visible and
        wbIsEslSupported and Supports(Element, IwbFile, _File) and
        not _File.IsESL;

      mniNavRenumberFormIDsInject.Visible :=
        mniNavRenumberFormIDsFrom.Visible and Supports(Element, IwbFile, _File)
        and (_File.MasterCount[True] > 0);

      mniNavChangeReferencingRecords.Visible := not wbTranslationMode and
        wbEditAllowed and Assigned(Element) and
        (Element.ElementType = etMainRecord) and
        ((Element as IwbMainRecord).MasterOrSelf.ReferencedByCount > 0);

      mniNavCheckForErrors.Visible := not wbTranslationMode and
        wbEditAllowed and Assigned(Element);

      mniNavCheckForCircularLeveledLists.Visible :=
        mniNavCheckForErrors.Visible;

      mniNavSetVWDAuto.Visible := mniNavCheckForErrors.Visible and
        (wbGameMode = gmTES4);
      mniNavSetVWDAutoInto.Visible := mniNavCheckForErrors.Visible and
        (wbGameMode = gmTES4);
      mniNavLOManagersDirtyInfo.Visible := mniNavCheckForErrors.Visible and
        (Length(LOOTPluginInfos) <> 0);

      if wbManualCleaningAllow then
      begin
        ...
        mniNavUndeleteAndDisableReferences.Visible :=
          mniNavCheckForErrors.Visible;
      ...
      begin
        ...
        mniNavFilterForCleaningSelectedObsolete.Visible :=
          not wbManualCleaningHide;
        mniNavRemoveIdenticalToMasterObsolete.Visible :=
          (not wbManualCleaningHide) and mniNavCheckForErrors.Visible;
        mniNavUndeleteAndDisableReferencesObsolete.Visible :=
          (not wbManualCleaningHide) and mniNavCheckForErrors.Visible;
      end;

      mniNavRemove.Visible := not wbTranslationMode and wbEditAllowed and
        (Length(RemoveableSelection(nil)) > 0);
      mniNavMarkModified.Visible := not wbTranslationMode and wbEditAllowed and
        (Length(EditableSelection(nil)) > 0);

      mniNavCompareTo.Visible := Supports(Element, IwbFile);
      mniNavCreateDeltaPatch.Visible := not wbTranslationMode and
        Supports(Element, IwbFile);
      mniNavAddMasters.Visible := mniNavCheckForErrors.Visible and
        Supports(Element, IwbFile);
      ...
      mniNavGenerateLOD.Visible := mniNavCompareTo.Visible and
        (wbGameMode in [gmTES4, gmFO3, gmFNV, gmTES5, gmEnderal, gmTES5VR,
        gmSSE, gmFO4, gmFO4VR]);
      ...
      if not wbTranslationMode and wbEditAllowed then
        if Supports(Element, IwbContainerElementRef, Container) then
          if Container.IsElementEditable(nil) then
          begin
      ...
      mniNavCopyAsOverride.Visible := mniNavCheckForErrors.Visible and
        not mniNavAddMasters.Visible;
      mniNavCopyAsOverrideWithOverwrite.Visible := mniNavCopyAsOverride.Visible;
      mniNavDeepCopyAsOverride.Visible := mniNavCopyAsOverride.Visible and
        SelectionIncludesAnyDeepCopyRecords;
      mniNavDeepCopyAsOverrideWithOverwriting.Visible :=
        mniNavDeepCopyAsOverride.Visible;
      mniNavCopyAsNewRecord.Visible := mniNavCopyAsOverride.Visible and
        not SelectionIncludesNonCopyNewRecords;

      if mniNavDeepCopyAsOverride.Visible and SelectionIncludesOnlyDeepCopyRecords
      then
      begin
      ...
      if mniNavCopyAsOverride.Visible and Supports(Element, IwbMainRecord,
        MainRecord) then
        mniNavCopyAsWrapper.Visible := (MainRecord.Signature = 'LVLN') or
          (MainRecord.Signature = 'LVLC') or (MainRecord.Signature = 'LVLI') or
          (MainRecord.Signature = 'LVSP');
      mniNavCopyAsSpawnRateOverride.Visible := mniNavCopyAsWrapper.Visible;

      mniNavCopyIdle.Visible := mniNavCheckForErrors.Visible and
        not mniNavAddMasters.Visible;

      mniNavCleanupInjected.Visible := mniNavCopyAsOverride.Visible and
      ...
      begin
        ...
        mniNavCompareSelected.Caption := 'Compare Selected (' + Length(Nodes)
          .ToString + ')';
      end;
      ...
      begin
        ...
        begin
          ...
          Element := NodeData.Element;
          if Element.ElementType <> etFile then
          begin
            Nodes := nil;
            Break;
          end;
      ...
      mniNavCellChildNotVWD.Visible := mniNavCheckForErrors.Visible and
        SelectionIncludesOnlyREFR(NoNodes);
      mniNavCellChildVWD.Visible := mniNavCellChildNotVWD.Visible;
      if mniNavCellChildNotVWD.Visible then
      begin
      ...
      mniNavCreateSEQFile.Visible := wbIsSkyrim and Assigned(Element) and
        (Element.ElementType = etFile);

      mniNavLocalization.Visible :=
        (wbIsSkyrim or wbIsFallout4 or wbIsFallout76);
      mniNavLocalizationSwitch.Visible := Assigned(Element) and
        (Element.ElementType = etFile) and (Element._File.LoadOrder > 0);
      ...
      mniNavCreateMergedPatch.Visible := not wbTranslationMode and
        wbEditAllowed;
    end;
    ...
    begin
      ...
      mniRefByCopyOverrideInto.Visible := not wbTranslationMode and
        wbEditAllowed and (Length(Selected) > 0);
      mniRefByCopyOverrideIntoWithOverwriting.Visible :=
        mniRefByCopyOverrideInto.Visible;
      mniRefByDeepCopyOverrideInto.Visible :=
        mniRefByCopyOverrideInto.Visible and
        ByRefSelectionIncludesAnyDeepCopyRecords(Selected);
      mniRefByDeepCopyOverrideIntoWithOverwriting.Visible :=
        mniRefByDeepCopyOverrideInto.Visible;

      mniRefByCopyAsNewInto.Visible := mniRefByCopyOverrideInto.Visible and
        not ByRefSelectionIncludesNonCopyNewRecords(Selected);
      mniRefByCopyDisabledOverrideInto.Visible :=
        mniRefByCopyOverrideInto.Visible;
      mniRefByRemove.Visible := mniRefByCopyOverrideInto.Visible;
      mniRefByMarkModified.Visible := mniRefByCopyOverrideInto.Visible;

      if mniRefByDeepCopyOverrideInto.Visible and
        ByRefSelectionIncludesOnlyDeepCopyRecords(Selected) then
      ...
      begin
        ...
        for i := Succ(Low(Selected)) to High(Selected) do
        begin
          Rec := Selected[i];
          if Sig <> Rec.Signature then
          begin
            mniRefByCompareSelected.Visible := False;
            Break;
          end
    ...
    begin
      ...
      mniViewHeaderCopyAsNewRecord.Visible :=
        not((MainRecord.Signature = 'CELL') or (MainRecord.Signature = 'WRLD')
        or (MainRecord.Signature = 'PGRD') or (MainRecord.Signature = 'NAVM') or
        (MainRecord.Signature = 'NAVI') or (MainRecord.Signature = 'LAND') or
        (MainRecord.Signature = 'ROAD'));
      mniViewHeaderCopyAsWrapper.Visible := (MainRecord.Signature = 'LVLC') or
        (MainRecord.Signature = 'LVLI') or (MainRecord.Signature = 'LVSP') or
        (MainRecord.Signature = 'LVLN');
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          mniViewSetToDefault.Visible := not wbTranslationMode and
            Assigned(Element) and Element._File.IsEditable and
            (Supports(Element.ValueDef, IwbStructDef, StructDef) and
            (StructDef.OptionalFromElement <> -1));
          mniViewRemove.Visible := not wbTranslationMode and Assigned(Element)
            and Element.IsRemoveable;
          mniViewMoveUp.Visible := not wbTranslationMode and Assigned(Element)
            and Element.CanMoveUp;
          mniViewMoveDown.Visible := not wbTranslationMode and Assigned(Element)
            and Element.CanMoveDown;
          mniViewRemoveFromSelected.Visible := not wbTranslationMode and
            mniViewRemove.Visible and ComparingSiblings;
          mniViewCopyMultipleToSelectedRecords.Visible :=
            not wbTranslationMode and ComparingSiblings;
          mniViewCopyToSelectedRecords.Visible :=
            mniViewCopyMultipleToSelectedRecords.Visible and Assigned(Element);
          mniViewCompareReferencedRow.Visible := not wbTranslationMode and
            (Length(GetUniqueLinksTo(NodeDatas, Length(ActiveRecords))) > 1);
          mniViewNextMember.Visible := not wbTranslationMode and
            Assigned(Element) and Element.CanChangeMember;
          mniViewPreviousMember.Visible := not wbTranslationMode and
            Assigned(Element) and Element.CanChangeMember;
        end;
        mniViewAdd.Visible := not wbTranslationMode and
          GetAddElement(TargetNode, TargetIndex, TargetElement) and
          TargetElement.CanAssign(TargetIndex, nil, True) and
    ...
    procedure TfrmMain.PostPluggyChange(aFormID, aBaseFormID, aInventoryFormID,
      aEnchantmentFormID, aSpellFormID: TwbFormID);
    begin
    ...
    begin
      ...
      begin
        aFiles := nil;
        wbModulesByLoadOrder.FilteredByFlag(mfTaggedForPluginMode).FilteredBy(
          function(aModule: PwbModuleInfo): Boolean
          begin
            Result := False;
      ...
      try
        ...
        begin
          _File := aFiles[i];
          if aNoGameMaster and
            (_File.FileStates * [fsIsGameMaster, fsIsHardcoded] <> []) then
            Continue;
      ...
      try
        ...
        begin
          ...
          if not Assigned(ViewFocusedElement) then
            if (Column > 0) and (Pred(Column) <= High(ActiveRecords)) then
            begin
              NodeDatas := vstView.GetNodeData(Node);
        ...
        else if Length(ActiveRecords) > 0 then
        begin
        ...
        vstView.FocusedColumn := Column;
        // vstView.OffsetXY := OffsetXY;
        if mniViewColumnWidthFitText.Checked or mniViewColumnWidthFitSmart.Checked
        then
          UpdateColumnWidths
        else
          with vstView.Header, Columns do
    ...
    begin
      ...
      for i := Low(Files) to High(Files) do
        with Files[i] do
          if IsESM and (not(fsIsHardcoded in FileStates)) and
            sameText(ExtractFileExt(FileName), '.esp') then
          begin
            AddMessage('[' + FormatDateTime('nn:ss', Now - wbStartTime) +
              '] Removing ESM Flag: ' + FileName);
            IsESM := False;
            Result := True;
          end;
    end;
    ...
    procedure TfrmMain.mniMarkallfileswithoutONAMasmodifiedClick
      (Sender: TObject);
    var
      i: Integer;
    begin
    ...
    function TfrmMain.SaveChanged(aSilent: Boolean = False;
    aShowMessageIfNothing: Boolean = False): TwbSaveResult;
    var
      i, j: Integer;
      FileStream: TBufferedFileStream;
    ...
    const
      ResetModifiedFromBool: array [Boolean] of TwbResetModified = (rmNo,
        rmSetInternal);
    begin
      ...
      with TfrmFileSelect.Create(nil) do
        try
          try
            for i := Low(Files) to High(Files) do
              if (Files[i].IsEditable) and (esUnsaved in Files[i].ElementStates)
                or wbTestWrite then
              begin
                CheckListBox1.AddItem(Files[i].FileNameOnDisk,
                  Pointer(Files[i]));
                CheckListBox1.Checked[Pred(CheckListBox1.Count)] := esUnsaved
                  in Files[i].ElementStates;
                SetLength(FileType, Succ(Length(FileType)));
                FileType[High(FileType)] := 0;
              end;
            ...
            if Assigned(wbLocalizationHandler) then
              try
                for i := 0 to Pred(wbLocalizationHandler.Count) do
                  try
                    if wbLocalizationHandler[i].Modified or wbTestWrite then
                    begin
                      CheckListBox1.AddItem(wbLocalizationHandler[i].Name,
                        Pointer(wbLocalizationHandler[i]));
                      CheckListBox1.Checked[Pred(CheckListBox1.Count)] :=
                        wbLocalizationHandler[i].Modified;
                      SetLength(FileType, Succ(Length(FileType)));
                      FileType[High(FileType)] := 1;
                    end;
                  except
                    on E: Exception do
                      wbProgress
                        ('Error while trying to access wbLocalizationHandler[%d]: [%s] %s',
                        [i, E.ClassName, E.Message]);
                  end;
              except
                on E: Exception do
                  wbProgress
                    ('Error while trying to iterate over wbLocalizationHandler: [%s] %s',
            ...
            if Assigned(Settings) then
              cbBackup.Checked := not Settings.ReadBool(frmMain.Name,
                'DontBackup', not cbBackup.Checked);
              ...
              for i := 0 to Pred(CheckListBox1.Items.Count) do
                ...
                begin
                  ...
                  begin
                    ...
                    s := Copy(s, Length(wbDataPath) + 1, Length(s));
                    // relative path to string file from Data folder
                    u := s;
                    if NeedsRename then
                      s := s + t;
                    ...
                    try
                      ...
                      begin
                        j := 0;
                        while FileExists(wbDataPath + s) do
                        begin
                          Inc(j);
                          s := u + t + '_' + j.ToString;
                        end;
                      end;
                      FileStream := TBufferedFileStream.Create(wbDataPath + s,
                        fmCreate, 1024 * 1024);
                      try
                        PostAddMessage('[' + FormatDateTime('nn:ss',
                          Now - wbStartTime) + '] Saving: ' + s);
                      ...
                      begin
                        ...
                        NeedsRename := False;
                        PostAddMessage('[' + FormatDateTime('nn:ss',
                          Now - wbStartTime) + '] Error saving ' + s + ': ' +
                          E.Message);
                      end;
                    end;
                  ...
                  begin
                    ...
                    u := s;
                    NeedsRename :=
                      FileExists(wbDataPath + CheckListBox1.Items[i]);
                    if NeedsRename then
                    begin
                      s := s + t;
                      j := 0;
                    ...
                    try
                      ...
                      if NeedsRename then
                        ...
                        begin
                          ...
                          PostAddMessage('[' + FormatDateTime('nn:ss',
                            Now - wbStartTime) +
                            '] File has not changed, removing: ' + s);
                        end;
                  ...
                  if NeedsRename and TryDirectRename then
                    try
          ...
          if AnyErrors then
            AddMessage('[' + FormatDateTime('nn:ss', Now - wbStartTime) +
              '] Errors have occured. At least one file was not saved.');
          if SavedAny then
          begin
            AddMessage('[' + FormatDateTime('nn:ss', Now - wbStartTime) +
              '] Done saving.');
    ...
    function TfrmMain.SelectionIncludesAnyNotVWD(Selection: TNodeArray)
      : Boolean;
    var
      i: Integer;
      NodeData: PNavNodeData;
    ...
    begin
      ...
      begin
        ...
        begin
          if Supports(NodeData.Element, IwbMainRecord, MainRecord) then
          begin
            if not MainRecord.IsVisibleWhenDistant then
            begin
              Result := True;
              Exit;
            end;
    ...
    begin
      ...
      begin
        ...
        begin
          if Supports(NodeData.Element, IwbMainRecord, MainRecord) then
          begin
            if MainRecord.IsVisibleWhenDistant then
            begin
              Result := True;
              Exit;
            end;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          begin
            Signature := MainRecord.Signature;
            if (Signature = 'CELL') or (Signature = 'WRLD') or
              (Signature = 'ROAD') or (Signature = 'LAND') or
              (Signature = 'PGRD') or (Signature = 'NAVM') or
              (Signature = 'NAVI') then
              Exit;
          end;
    ...
    begin
      ...
      if (ActiveContainer = aContainer) and
        (Assigned(ActiveContainer) = (Length(ActiveRecords) > 0)) then
        Exit;
      ...
      try
        ...
        try
          ...
          begin
            ...
            begin
              ...
              ActiveRecords[0].Container :=
                ActiveContainer as IwbContainerElementRef;
            end;
            ...
            begin
              ...
              try
                ...
                begin
                  Text := '';
                  Width := Trunc(ColumnWidth *
                    (GetCurrentPPIScreen / PixelsPerInch));
                  Options := Options - [coDraggable, coShowDropMark];
                ...
                for i := Low(ActiveRecords) to High(ActiveRecords) do
                  ...
                  begin
                    ...
                    Style := vsOwnerDraw;
                    Width := Trunc
                      (ColumnWidth * (GetCurrentPPIScreen / PixelsPerInch));
            ...
            vstView.NodeDataSize := SizeOf(TViewNodeData) *
              Length(ActiveRecords);
            if Supports(ActiveContainer.Def, IwbStructDef) then
              vstView.RootNodeCount := (ActiveContainer.Def as IwbStructDef)
                .MemberCount + ActiveContainer.AdditionalElementCount
            else
        ...
        tbsReferencedBy.TabVisible := wbLoaderDone and
          (lvReferencedBy.Items.Count > 0);
        if tbsReferencedBy.TabVisible then
          tbsReferencedBy.Caption := Format('Referenced By (%d)',
            [lvReferencedBy.Items.Count]);
      finally
        lvReferencedBy.Items.EndUpdate;
      end;
    end;
    ...
    begin
      ...
      try
        ...
        try
          ...
          vstView.NodeDataSize := SizeOf(TViewNodeData) * Length(ActiveRecords);
          vstView.RootNodeCount := (aMainRecords[0].Def as IwbRecordDef)
            .MemberCount + aMainRecords[0].AdditionalElementCount;
          InitConflictStatus(vstView.RootNode, False, @ActiveRecords[0]);
          ExpandView;
          UpdateColumnWidths;
        finally
    ...
    begin
      UserWasActive := True;
      if Assigned(aContainer) and (tmrPendingSetActive.Interval > 0) then
      begin
    ...
    begin
      UserWasActive := True;
      if Assigned(aMainRecord) and (tmrPendingSetActive.Interval > 0) then
      begin
        PendingContainer := nil;
    ...
    begin
      UserWasActive := True;
      if (Length(aMainRecords) > 0) and (tmrPendingSetActive.Interval > 0) then
      begin
        PendingContainer := nil;
    ...
    begin
      ...
      for i := Low(Files) to High(Files) do
        with Files[i] do
          if (not IsESM) and (not(fsIsHardcoded in FileStates)) then
          begin
            AddMessage('[' + FormatDateTime('nn:ss', Now - wbStartTime) +
              '] Setting ESM Flag: ' + FileName);
            IsESM := True;
            Result := True;
          end
          else
    ...
    begin
      ...
      for i := Low(Files) to High(Files) do
        with Files[i] do
          if IsEditable and (FileStates * [fsIsGameMaster, fsIsHardcoded,
            fsIsOfficial] = []) then
          begin
            if MasterCount[True] > 0 then
            begin
              Elements[0].MarkModifiedRecursive(AllElementTypes);
              AddMessage('[' + FormatDateTime('nn:ss', Now - wbStartTime) +
                '] Updating ONAM in: ' + FileName);
              Result := True;
            end;
          end;
    end;
    ...
    function TfrmMain.GetViewNodePositionLabel
      (aNode: PVirtualNode = nil): string;
    var
      Node: PVirtualNode;
    begin
      ...
      while Assigned(Node) and (Node <> vstView.RootNode) do
      begin
    ...
    begin
      ...
      if (ActiveRecord = aMainRecord) and
        (Assigned(ActiveRecord) = (Length(ActiveRecords) > 0)) then
        Exit;
      ...
      try
        ...
        try
          ...
          begin
            ...
            begin
              ...
              ActiveRecords[0].Container :=
                ActiveRecord as IwbContainerElementRef;
            end;
            ...
            vstView.NodeDataSize := SizeOf(TViewNodeData) *
              Length(ActiveRecords);
            if Assigned(ActiveMaster) and Assigned(ActiveMaster.Def) then
            begin
              vstView.RootNodeCount := (ActiveMaster.Def as IwbRecordDef)
                .MemberCount + ActiveMaster.AdditionalElementCount;
              InitConflictStatus(vstView.RootNode, ActiveMaster.IsInjected and
                not(ActiveMaster.Signature = 'GMST'), @ActiveRecords[0]);
              ExpandView;
            end;

            SetViewNodePositionLabel(ViewLabel);
            if (vstView.FocusedColumn < 1) and (ColumnForViewFocusedElement < 1)
              and (ActiveIndex > NoColumn) then
        ...
        if wbLoaderDone and Assigned(ActiveMaster) and not wbBuildingRefsParallel
        then
        begin
          lvReferencedBy.Tag := ActiveMaster.ReferencedByCount;
          if pgMain.ActivePage = tbsReferencedBy then
    ...
    procedure TfrmMain.ShowChangeReferencedBy(OldFormID, NewFormID: TwbFormID;
    const ReferencedBy: TDynMainRecords; aSilent: Boolean);
    var
      Counter: Integer;
      i: Integer;
    ...
    begin
      with TfrmFileSelect.Create(nil) do
        try
          ...
          Counter := 0;
          for i := Low(ReferencedBy) to High(ReferencedBy) do
          begin
            CheckListBox1.AddItem(ReferencedBy[i].Name + ' - ' + ReferencedBy[i]
              ._File.Name, Pointer(ReferencedBy[i]));
            if ReferencedBy[i].IsEditable then
            begin
          ...
          begin
            if not aSilent then
              ShowMessage('There are ' + IntToStr(Length(ReferencedBy)) +
                ' records referencing FormID ' + OldFormID.ToString(True) +
                ' but non of them are in editable files.');
            Exit;
          end;
          ...
          begin
              ...
              begin
                ...
                for i := 0 to Pred(CheckListBox1.Count) do
                  try
                    CheckListBox1.Checked[i] :=
                      IwbMainRecord(Pointer(CheckListBox1.Items.Objects[i]))
                      .CompareExchangeFormID(OldFormID, NewFormID);
                    if CheckListBox1.Checked[i] then
                      Inc(Counter);
                    wbTick;
                  except
                    on E: Exception do
                    begin
                      wbProgress('Error updating FormID for ' +
                        CheckListBox1.Items[i] + ': ' + E.Message);
                      Error := True;
                    end;
                  end;

                wbProgress(IntToStr(Counter) + ' records out of ' +
                  IntToStr(Length(ReferencedBy)) +
                  ' total records which reference FormID [' +
                  OldFormID.ToString(True) + '] have been updated to [' +
                  NewFormID.ToString(True) + ']');
              end);
            ...
            begin
              if Error then
                ShowMessage
                  ('At least one record could not be updated. Check the message log for detailed error messages');
    ...
    begin
      ...
      if not aForce then
        ...
        begin
          LastShownOn := Settings.ReadInteger('DeveloperMessage',
            'LastShownOn', 0);
      ...
      if aForce or (i < wbDeveloperMessageVersion) then
        with TfrmDeveloperMessage.Create(Self) do
          try
            ...
            Settings.WriteInteger('DeveloperMessage', 'LastShownOn',
              Trunc(Date));

            if cbDontShowAgain.Checked then
              Settings.WriteInteger('DeveloperMessage', 'Version',
                wbDeveloperMessageVersion)
            else
    ...
    procedure TfrmMain.splElementsMouseDown(Sender: TObject;
    Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    begin
    ...
    var
      ...
      procedure CollectKeywords(const aElement: IwbElement;
      slKeywords: TwbFastStringListCS; var arKeywords: TDynMainRecords);
      var
        MainRecord: IwbMainRecord;
      ...
      begin
        ...
        if not Supports(MainRecord.ElementBySignature['KWDA'],
          IwbContainerElementRef, Keywords) then
          Exit;

        for i := 0 to Pred(Keywords.ElementCount) do
          if Supports(Keywords.Elements[i].LinksTo, IwbMainRecord, Keyword) then
          begin
            s := Keyword.LoadOrderFormID.ToString(False);
            if slKeywords.IndexOf(s) < 0 then
            begin
              SetLength(arKeywords, Succ(Length(arKeywords)));
              arKeywords[High(arKeywords)] := Keyword;
              slKeywords.AddObject(s, Pointer(Keyword));
              // uncounted ref, kept alive via arKeywords reference
            end;
          end;
      end;

      function CheckHasKeywords(const aElement: IwbElement;
      aKeywords: TwbFastStringListCS): Boolean;
      var
          ...
          begin
            ...
            begin
              ...
              case CompareStr(aKeywords[i], slItemKeywords[Pred(j)]) of
                ...
                { aKeywords > slItemKeywords }
                1 .. High(Integer):
                  ; // additional keyword in slItemKeywords, keep looping
              end;
            end;
            if not FoundIt then
              Exit(False);
      ...
      procedure ShowKeywordSelection(slKeywords: TwbFastStringListCS;
      var arKeywords: TDynMainRecords);
      var
        i: Integer;
      ...
      begin
        ...
        try
          sl2.CommaText := Settings.ReadString(Signature + ' Spreadsheet',
            'Keywords', '');
          ...
          with TfrmFileSelect.Create(nil) do
            try
              ...
              for i := Low(arKeywords) to High(arKeywords) do
              begin
                CheckListBox1.AddItem(arKeywords[i].Name,
                  Pointer(arKeywords[i]));
              ...
              if ShowModal = mrOK then
                with CheckListBox1 do
                  for i := 0 to Pred(Count) do
                    if Checked[i] then
                      slKeywords.AddObject
                        (IwbMainRecord(Pointer(Items.Objects[i]))
                        .LoadOrderFormID.ToString(False), Items.Objects[i]);
          ...
          Settings.WriteString(Signature + ' Spreadsheet', 'Keywords',
            sl2.CommaText);
          Settings.UpdateFile;
        finally
          sl2.Free;
    ...
    begin
      ...
      try
        ...
        vstSpreadsheet :=
          ((Sender as TTabSheet).Controls[0] as TVirtualEditTree);
          ...
          try
            ...
            try
              ...
              begin
                ...
                Settings.WriteString(Signature + ' Spreadsheet', 'Selection',
                  sl2.CommaText);
                Settings.UpdateFile;
              end
              else
            ...
            try
              vstSpreadsheet.Clear;
              vstSpreadsheet.NodeDataSize := vstSpreadsheet.Header.Columns.Count
                * SizeOf(TSpreadSheetNodeData);
              ...
              for i := 0 to Pred(CheckListBox1.Count) do
                ...
                begin
                  ...
                  begin
                    Element := Group.Elements[j];
                    if not Assigned(slKeywords) or
                      CheckHasKeywords(Element, slKeywords) then
                    begin
    ...
    var
      ...
      ClientWidth: Integer;
    begin
      if vstView.Header.Columns.Header.States * [hsAutoSizing,
      ...
      try
        ...
        begin
          ...
          then
            ...
            Columns[0].Width :=
              Trunc(ColumnWidth * (GetCurrentPPIScreen / PixelsPerInch));
          ...
          begin
            ...
            repeat
              ...
              if mniViewColumnWidthFitAll.Checked or mniViewColumnWidthFitSmart.Checked
              then
              begin
                MinWidth := 0;
                ...
                if MinWidth >= AvailableWidth then
                begin
                  for i := 1 to (Count - 2) do
              ...
              if mniViewColumnWidthFitText.Checked or
                mniViewColumnWidthFitSmart.Checked then
              begin
                AutoFitColumns(False, smaAllColumns, 1);
                if mniViewColumnWidthFitSmart.Checked then
                  for i := 1 to (Count - 2) do
                    Columns[i].Width := Max(Columns[i].MinWidth,
                      Min(Columns[i].Width, ClientWidth));
              end;
                ...
                begin
                  ...
                  begin
                    ...
                    for i := 1 to (Count - 3) do
                      with Columns[i] do
                      begin
                        Width := Max(MulDiv(Width, AvailableWidth, ColWidth),
                          MinWidth);
                        Inc(NewWidth, Width);
                      end;
      ...
      try
        ...
        for i := Low(Files) to High(Files) do
          ...
          begin
            ...
            if Files[i].UnsavedSince < Now then
            begin
              if sl.Count >= MaxSaveListCount then
                Inc(j)
              else
                sl.Add(Files[i].Name + ' (' + FormatDateTime('hh:nn',
                  Now - Files[i].UnsavedSince) + ')');
            end;
          end;
        if j > 0 then
        ...
        begin
          jbhSave.ActivateHint(bnMainMenu, sl.Text,
            'You have unsaved changes. Do you want to save now?', 30000);
          SetSaveInterval;
        end;
      finally
        sl.Free;
    ...
    begin
      if (ShowNexusModsHint <> 0) and (ShowNexusModsHint < Now) then
        if NexusModsVersion > VersionString then
        begin
          if not(jbhPatreon.Active or jbhGitHub.Active) then
          begin
            bnNexusMods.ShowHint := True;

            if wbShrinkButtons then
            begin
              bnNexusMods.HelpKeyword :=
                'A newer version is available on NexusMods: ' +
                NexusModsVersion;
              bnNexusMods.Flat := False;
            end
            else
              bnNexusMods.Hint := 'A newer version is available on NexusMods: '
                + NexusModsVersion;

            if Settings.ReadInteger('NexusMods', 'SnoozeDate', 0) <> Trunc(Now)
            then
              // if NexusModsVersion > TwbVersion(Settings.ReadString('NexusMods', 'SnoozeVersion', '')) then
              if wbShrinkButtons then
                jbhNexusMods.ActivateHint(bnNexusMods, bnNexusMods.HelpKeyword,
                  '', 20000)
              else
                jbhNexusMods.ActivateHint(bnNexusMods, bnNexusMods.Hint,
                  '', 20000);
            ShowNexusModsHint := 0;
          end;

          bnNexusMods.Font.Style := bnNexusMods.Font.Style +
            [fsBold, fsUnderline];
        ...
        begin
          bnNexusMods.ShowHint := True;
          if wbShrinkButtons then
            bnNexusMods.HelpKeyword := 'Current version on NexusMods: ' +
              NexusModsVersion
          else
            bnNexusMods.Hint := 'Current version on NexusMods: ' +
              NexusModsVersion;
          ShowNexusModsHint := 0;
        end;
      ...
      if (ShowGitHubHint <> 0) and (ShowGitHubHint < Now) then
        ...
        begin
          if not(jbhPatreon.Active or jbhNexusMods.Active) then
          begin
            bnGitHub.ShowHint := True;

            if wbShrinkButtons then
            begin
              bnGitHub.HelpKeyword := 'A newer version is available on GitHub: '
                + GitHubVersion;
              bnGitHub.Flat := False;
            end
            else
              bnGitHub.Hint := 'A newer version is available on GitHub: ' +
                GitHubVersion;

            if Settings.ReadInteger('GitHub', 'SnoozeDate', 0) <> Trunc(Now)
            then
              // if GitHubVersion > TwbVersion(Settings.ReadString('GitHub', 'SnoozeVersion', '')) then
              if wbShrinkButtons then
                jbhGitHub.ActivateHint(bnGitHub, bnGitHub.HelpKeyword,
                  '', 20000)
              else
        ...
        begin
          bnGitHub.ShowHint := True;
          if wbShrinkButtons then
            bnGitHub.HelpKeyword := 'Current version on GitHub: ' +
              GitHubVersion
          else
      ...
      if Assigned(NewMessages) and (NewMessages.Count > 0) then
      begin
        mmoMessages.Lines.AddStrings(NewMessages);
        NewMessages.Clear;
        ScrollToTheLastMessage;
        stbMain.Panels[0].Text := mmoMessages.Lines
          [Pred(mmoMessages.Lines.Count)];
        if pgMain.ActivePage <> tbsMessages then
          tbsMessages.Highlighted := True;
      end;
      ...
      if (wbToolMode in [tmOnamUpdate, tmMasterUpdate, tmMasterRestore,
        tmESMify, tmESPify, tmSortAndCleanMasters, tmCheckForITM, tmCheckForDR,
        tmCheckForErrors]) and wbLoaderDone and not wbMasterUpdateDone then
      begin
        wbMasterUpdateDone := True;
        ChangesMade := False;
        if wbLoaderError then
        begin
          wbDontSave := True;
          PostAddMessage('[' + FormatDateTime('nn:ss', Now - wbStartTime) +
            '] --= Error =--');
          PostAddMessage('[' + FormatDateTime('nn:ss', Now - wbStartTime) +
            '] An error occured while loading your active modules.');
          PostAddMessage('[' + FormatDateTime('nn:ss', Now - wbStartTime) +
            '] Please look at the log above to determine which of your modules caused that problem.');
          PostAddMessage('[' + FormatDateTime('nn:ss', Now - wbStartTime) +
            '] The most likely reason for this is a module file that contains structural errors.');
          PostAddMessage('[' + FormatDateTime('nn:ss',
            Now - wbStartTime) + ']');
          PostAddMessage('[' + FormatDateTime('nn:ss', Now - wbStartTime) +
            '] !!! No changes have been made to any of your active modules.');
          PostAddMessage('[' + FormatDateTime('nn:ss', Now - wbStartTime) +
            '] !!! You have to resolve the problem and run this program again.');
          PostAddMessage('[' + FormatDateTime('nn:ss',
            Now - wbStartTime) + ']');
          PostAddMessage('[' + FormatDateTime('nn:ss', Now - wbStartTime) +
            '] Loading and saving the problematic module in CS/GECK/CK can sometimes produce');
          PostAddMessage('[' + FormatDateTime('nn:ss', Now - wbStartTime) +
            '] a working version. But it is recommended to contact the author of the module');
          PostAddMessage('[' + FormatDateTime('nn:ss', Now - wbStartTime) +
            '] to get the original fixed.');
        end
        else
          try
            if (wbToolMode = tmSortAndCleanMasters) then
            begin
              for i := Low(Files) to High(Files) do
                if wbPluginsToUse.Find(Files[i].FileName, Dummy) and Files[i].IsEditable
                then
                begin
                  Files[i].SortMasters;
            ...
            else if (wbToolMode in [tmMasterRestore, tmESPify]) then
              ChangesMade := RestorePluginsFromMaster
            else if (wbToolMode in [tmCheckForErrors, tmCheckForITM,
              tmCheckForDR]) then
            begin
              ...
              pgMain.ActivePage := tbsMessages;
              try
                if wbToolMode = tmCheckForErrors then
                begin
                ...
                else if wbToolMode = tmCheckForITM then
                begin
                ...
                else if wbToolMode = tmCheckForDR then
                begin
            ...
            else if wbToolMode = tmMasterUpdate then
              ChangesMade := SetAllToMaster
            else if wbToolMode = tmOnamUpdate then
            begin
            ...
            begin
              PostAddMessage('[' + FormatDateTime('nn:ss', Now - wbStartTime) +
                '] You have to close this program to finalize renaming of the .save files.');
              PostAddMessage('[' + FormatDateTime('nn:ss', Now - wbStartTime) +
                '] It is still possible for the renaming to fail if any of your original module files is still open by another process.')
            end
            else
            begin
              PostAddMessage('[' + FormatDateTime('nn:ss', Now - wbStartTime) +
                '] None of your active modules required changes.');
            end;
            if (wbToolMode in [tmOnamUpdate, tmMasterUpdate]) then
            begin
              PostAddMessage('[' + FormatDateTime('nn:ss',
                Now - wbStartTime) + ']');
              PostAddMessage('[' + FormatDateTime('nn:ss', Now - wbStartTime) +
                '] !!! Remember to run this program again any time you make changes to your active mods. !!!.');
            end
            else if (wbToolMode in wbPluginModes) then
              AutoDone := True;
            ...
            PostAddMessage('[' + FormatDateTime('nn:ss', Now - wbStartTime) +
              '] --= Error =--');
            PostAddMessage('[' + FormatDateTime('nn:ss', Now - wbStartTime) +
              '] An error occured while trying to modify the file or saving the modified files.');
            PostAddMessage('[' + FormatDateTime('nn:ss', Now - wbStartTime) +
              '] Please look at the log above to determine which of your modules caused that problem.');
            PostAddMessage('[' + FormatDateTime('nn:ss', Now - wbStartTime) +
              '] The most likely reason for this is a module file that contains structural errors.');
    ...
    procedure TfrmMain.vstSpreadSheetAmmoInitNode(Sender: TBaseVirtualTree;
    ...
    procedure TfrmMain.vstSpreadsheetArmorInitNode(Sender: TBaseVirtualTree;
    ParentNode, Node: PVirtualNode; var InitialStates: TVirtualNodeInitStates);
    var
      NodeDatas: PSpreadSheetNodeDatas;
      MainRecord: IwbMainRecord;
    ...
    procedure TfrmMain.vstViewBeforeCellPaint(Sender: TBaseVirtualTree;
    TargetCanvas: TCanvas; Node: PVirtualNode; Column: TColumnIndex;
    CellPaintMode: TVTCellPaintMode; CellRect: TRect; var ContentRect: TRect);
    var
      NodeDatas: PViewNodeDatas;
    ...
    begin
      ...
      if Column >= 0 then
      begin
        if not Assigned(NodeDatas[Column].Element) or (Column = ActiveIndex)
        then
        begin
          ...
          if NodeDatas[Column].ConflictAll >= caNoConflict then
            TargetCanvas.Brush.Color :=
              wbLighter(ConflictAllToColor(NodeDatas[Column]
              .ConflictAll), Factor)
          else
            Exit;
    ...
    begin
      ...
      if NodeDatas[0].ConflictAll >= caNoConflict then
        ItemColor :=
          wbLighter(ConflictAllToColor(NodeDatas[0].ConflictAll), 0.85)
      else
        Exit;
    ...
    begin
      ...
      if (HotColumn < Low(ActiveRecords)) or (HotColumn > High(ActiveRecords))
      then
        Exit;
    ...
    begin
      ...
      if (Pred(vstView.HotColumn) < Low(ActiveRecords)) or
        (Pred(vstView.HotColumn) > High(ActiveRecords)) then
        Exit;
      ...
      if Assigned(Element) and not Element.Equals(ActiveRecord) then
      begin
        ForwardHistory := nil;
    ...
    procedure TfrmMain.vstViewCollapsed(Sender: TBaseVirtualTree;
    Node: PVirtualNode);
    var
      NodeDatas: PViewNodeDatas;
      i: Integer;
    ...
    procedure TfrmMain.vstCreateEditor(const aElement: IwbElement;
    out EditLink: IVTEditLink);
    var
{$IFNDEF LiteVersion}
      i: Integer;
...
{$ENDIF}
    begin
      if EditInfoCacheLGeneration <> wbLocalizationHandler.Generation then
      begin
        EditInfoCacheID := 0;
        EditInfoCache := nil;
...
{$IFNDEF LiteVersion}
        ...
        etComboBox:
          begin
            ...
            EditLink := ComboLink;
            if aElement.ElementID <> EditInfoCacheID then
            begin
              EditInfoCacheID := aElement.ElementID;
              EditInfoCache := aElement.EditInfo;
            end;
            with ComboLink.Properties do
            begin
              with Items do
              begin
                Clear;
        ...
        etCheckComboBox:
          begin
            ...
            with CheckComboLink.Properties do
            begin
              with Items do
              begin
                Clear;
...
{$ELSE}
        ...
        etCheckComboBox:
          begin
            ...
            with CheckComboLink.PickList do
            begin
              Clear;
              AddStrings(EditInfoCache);
            end;
...
{$ENDIF}
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if Assigned(ViewFocusedElement) and Assigned(Def) and
            ViewFocusedElement.IsEditable then
            if Def.DefType in [dtInteger, dtFlag, dtFloat] then
            begin
        ...
        with TfrmViewElements.Create(nil) do
        begin
          ...
          for i := Low(ActiveRecords) to High(ActiveRecords) do
            AddElement(NodeDatas[i].Element, vstView.FocusedColumn = Succ(i),
              ModalEdit and Assigned(NodeDatas[i].Element) and
              NodeDatas[i].Element.IsEditable);
    ...
    procedure TfrmMain.vstViewDragDrop(Sender: TBaseVirtualTree;
    ...
    begin
      ...
      if GetSourceElement(Source, SourceElement) and
        PerformDrop(Sender, Sender.DropTargetNode, Sender.DropTargetColumn,
        SourceElement) then
      begin
        PostResetActiveTree;
        InvalidateElementsTreeView(NoNodes);
    ...
    procedure TfrmMain.vstViewDragOver(Sender: TBaseVirtualTree;
    ...
    begin
      ...
      Accept := GetSourceElement(Source, SourceElement) and
        GetTargetElement(Sender, TargetNode, TargetColumn, TargetIndex,
        TargetElement) and (TargetElement <> SourceElement) and
        TargetElement.CanAssign(TargetIndex, SourceElement, True);
    end;

    procedure TfrmMain.vstViewEditing(Sender: TBaseVirtualTree;
    Node: PVirtualNode; Column: TColumnIndex; var Allowed: Boolean);
    var
      NodeDatas: PViewNodeDatas;
      Element: IwbElement;
    ...
    procedure TfrmMain.vstViewExpanded(Sender: TBaseVirtualTree;
    Node: PVirtualNode);
    var
      NodeDatas: PViewNodeDatas;
      i: Integer;
    ...
    procedure TfrmMain.vstViewFocusChanged(Sender: TBaseVirtualTree;
    Node: PVirtualNode; Column: TColumnIndex);
    var
      NodeDatas: PViewNodeDatas;
    begin
      if Column <> LastViewColumn then
      begin
        if ComparingSiblings then
          vstView.Invalidate
        else
    ...
    procedure TfrmMain.vstViewFocusChanging(Sender: TBaseVirtualTree;
    OldNode, NewNode: PVirtualNode; OldColumn, NewColumn: TColumnIndex;
    var Allowed: Boolean);
    begin
      Allowed := False;
      // if NewColumn < 1 then
      // Exit;
      if (NewColumn = Pred(TVirtualEditTree(Sender).Header.Columns.Count)) and
        (Length(ActiveRecords) > 1) then
        Exit;
      Allowed := True;
    end;
    ...
    procedure TfrmMain.vstViewGetHint(Sender: TBaseVirtualTree;
    Node: PVirtualNode; Column: TColumnIndex;
    var LineBreakStyle: TVTTooltipLineBreakStyle; var HintText: string);
    begin
      if GetKeyState(VK_SHIFT) < 0 then
    ...
    procedure TfrmMain.vstViewHeaderClick(Sender: TVTHeader;
        ...
        if Column = 0 then
          ...
          begin
            ...
            case Button of
              mbLeft:
                begin
                  ColWidth := (vstView.ClientWidth - vstView.Header.Columns[0]
                    .Width) div (vstView.Header.Columns.Count - 2);
    ...
    procedure TfrmMain.vstViewHeaderDropped(Sender: TVTHeader;
    SourceColumn, TargetColumn: TColumnIndex; var Handled: Boolean);
    var
      TargetElement: IwbElement;
      SourceElement: IwbElement;
    begin
      ...
      if TargetElement.CanAssign(Low(Integer), SourceElement, False) then
      begin
    ...
    procedure TfrmMain.vstViewHeaderMouseDown(Sender: TVTHeader;
    Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    var
      Column: Integer;
      Element: IwbElement;
    ...
    begin
      ...
      begin
        ...
        Dec(Column);
        if (Column >= Low(ActiveRecords)) and (Column <= High(ActiveRecords))
        then
        begin
          Element := ActiveRecords[Column].Element;
          if not Supports(Element, IwbMainRecord, MainRecord) then
    ...
    var PaintInfo: THeaderPaintInfo; var Elements: THeaderPaintElements);
    begin
      if Assigned(PaintInfo.Column) and (PaintInfo.Column.Index > 0) and
        (PaintInfo.Column.Index <= Length(ActiveRecords)) then
      begin

        with PaintInfo.TargetCanvas.Font do
        begin
          ...
          if ActiveRecords[Pred(PaintInfo.Column.Index)].Element.IsNotReachable
          then
            Style := Style + [fsStrikeOut]
          else
            Style := Style - [fsStrikeOut];

          if ActiveRecords[Pred(PaintInfo.Column.Index)].Element.ReferencesInjected
          then
        ...
        if ActiveRecords[0].ConflictAll >= caNoConflict then
          Sender.Background :=
            wbLighter(ConflictAllToColor(ActiveRecords[0].ConflictAll), 0.85);
        PaintInfo.TargetCanvas.Brush.Color := Sender.Background;
        Sender.Font.Color :=
          wbDarker(ConflictThisToColor(ActiveRecords[Pred(PaintInfo.Column.
          Index)].ConflictThis));
      end;
    end;

    procedure TfrmMain.vstViewInitChildren(Sender: TBaseVirtualTree;
    Node: PVirtualNode; var ChildCount: Cardinal);
    begin
      InitChildren(Sender.GetNodeData(Node), Length(ActiveRecords), ChildCount);
    end;

    procedure TfrmMain.vstViewInitNode(Sender: TBaseVirtualTree;
    ParentNode, Node: PVirtualNode; var InitialStates: TVirtualNodeInitStates);
    var
      NodeDatas: PViewNodeDatas;
    ...
    begin
      ...
      InitNodes(Node, NodeDatas, ParentDatas, Length(ActiveRecords), Node.Index,
        InitialStates);
    end;

    procedure TfrmMain.vstViewKeyDown(Sender: TObject; var Key: Word;
    Shift: TShiftState);
    var
      NodeDatas: PViewNodeDatas;
      Element: IwbElement;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if not ReferencesInjected then
          begin
            Element := NodeDatas[i].Element;
            if Assigned(Element) then
              ReferencesInjected := Element.ReferencesInjected;
      ...
      if ComparingSiblings and (Column >= 0) and (FocusedColumn >= 0) and
        (Column <= High(ActiveRecords)) and
        (FocusedColumn <= High(ActiveRecords)) then
    ...
    procedure TfrmMain.vstViewScroll(Sender: TBaseVirtualTree;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if NodeData.ConflictAll = caUnknown then
          begin
            ConflictLevelForMainRecord(MainRecord, NodeData.ConflictAll,
              NodeData.ConflictThis);
            if MainRecord.IsInjected then
    ...
    procedure TfrmMain.vstNavChange(Sender: TBaseVirtualTree;
    Node: PVirtualNode);
    var
      NodeData: PNavNodeData;
      Element: IwbElement;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if not(Element.ElementType in [etFile, etMainRecord, etStructChapter])
            and not Element.TreeHead then
            Element := nil;
        end;

        if NodeData.ConflictAll >= caNoConflict then
          lblPath.Color :=
            wbLighter(ConflictAllToColor(NodeData.ConflictAll), 0.85)
        else
          lblPath.Color := vstNav.Color;

        lblPath.Font.Color :=
          wbDarker(ConflictThisToColor(NodeData.ConflictThis));
      ...
      FirstNode := nil;
      SelectedNodes := vstNav.GetSortedSelection(True);
      if (Length(SelectedNodes) > 1) and
        (Length(SelectedNodes) < wbAutoCompareSelectedLimit) then
      begin
        SetLength(MainRecords, Length(SelectedNodes));
        j := 0;
        for i := Low(SelectedNodes) to High(SelectedNodes) do
        begin
          NodeData := vstNav.GetNodeData(SelectedNodes[i]);
          if Assigned(NodeData.Element) and
            (NodeData.Element.ElementType in [etMainRecord { , etFile } ]) then
          begin
            { if Supports(NodeData.Element, IwbFile, _File) then
      ...
      if Length(MainRecords) > 1 then
        ...
        SetActiveRecord(MainRecord)
      else if Supports(Element, IwbFile, _File) and (_File.ElementCount > 0) and
        Supports(_File.Elements[0], IwbMainRecord, MainRecord) then
      begin
        SetActiveRecord(MainRecord)
      end
      ...
      if tmrPendingSetActive.Interval < 1 then
      begin
        vstNav.Repaint;
        vstView.Repaint;
        Sleep(10);
    ...
    procedure TfrmMain.vstNavCompareNodes(Sender: TBaseVirtualTree;
    Node1, Node2: PVirtualNode; Column: TColumnIndex; var Result: Integer);
    var
      Element1: IwbElement;
      Element2: IwbElement;
    ...
    begin
      ...
      if Assigned(Element1) <> Assigned(Element2) then
      begin
      ...
      else if not Assigned(Element1) then
      begin
        Result := 0;
        Exit;
      end;

      if Element1.TreeHead then
      begin
        Result := -1;
        Exit;
      end
      else if Element2.TreeHead then
      begin
        Result := 1;
        Exit;
      end;
      ...
      if Assigned(SortElement1) <> Assigned(SortElement2) then
      begin
      ...
      else if not Assigned(SortElement1) then
      begin
        Result := 0;
        Exit;
      end;

      Result := CmpI32(Ord(SortElement1.ElementType),
        Ord(SortElement2.ElementType));
      if Result = 0 then
        case SortElement1.ElementType of
          etFile:
            begin
              ...
              case Column of
                1, 2:
                  Result := CompareText((SortElement1 as IwbFile).FileName,
                    (SortElement2 as IwbFile).FileName);
              else
                Result := CmpI32((SortElement1 as IwbFile).LoadOrder,
                  (SortElement2 as IwbFile).LoadOrder);
              end;
          ...
          etGroupRecord:
            begin
              ...
              case GroupRecord1.GroupType of
                0:
                  Result := CompareText(TwbSignature(GroupRecord1.GroupLabel),
                    TwbSignature(GroupRecord2.GroupLabel));
                2, 3:
                  Result := CmpI32(Integer(GroupRecord1.GroupLabel),
                    Integer(GroupRecord2.GroupLabel));
                4, 5:
                  begin
                    Result := CmpI32(LongRecSmall(GroupRecord1.GroupLabel).Hi,
                      LongRecSmall(GroupRecord2.GroupLabel).Hi);
                    if Result = 0 then
                      Result := CmpI32(LongRecSmall(GroupRecord1.GroupLabel).Lo,
          ...
          etMainRecord:
            begin
              ...
              case Column of
                1:
                  Result := CompareText(MainRecord1.EditorID,
                    MainRecord2.EditorID);
                2:
                  Result := CompareText(MainRecord1.DisplayNameKey,
                    MainRecord2.DisplayNameKey);
              end;
              if Result = 0 then
              begin
                Result := CmpI32(MainRecord1.SortPriority,
                  MainRecord2.SortPriority);
                if wbSortINFO and mniNavHeaderINFObyPreviousINFO.Checked and
                  (MainRecord1.Signature = 'INFO') and
                  (MainRecord2.Signature = 'INFO') then
                begin
                  if Supports(MainRecord1.Container, IwbGroupRecord,
                    GroupRecord1) then
                    GroupRecord1.Sort;
                  Result := CmpW32(MainRecord1.SortOrder,
                    MainRecord2.SortOrder);
                end;
                if Result = 0 then
                begin
                  Result := TwbFormID.Compare(MainRecord1.LoadOrderFormID,
                    MainRecord2.LoadOrderFormID);
                  if Result = 0 then
                    Result := CmpW32(Cardinal(Pointer(MainRecord1)),
                      Cardinal(Pointer(MainRecord2)));
                end;
              end;
            end
        else
          ...
          if (Result = 0) and Assigned(Element1.Container) and
            Assigned(Element2.Container) and
            (Element1.Container = Element2.Container) then
          begin
            Container := Element1.Container as IwbContainerElementRef;
            if Container.ElementType = etArray then
              Result := CmpI32(Container.IndexOf(Element1),
                Container.IndexOf(Element2));
          end;

          if Result = 0 then
            Result := CmpW32(Cardinal(Pointer(Element1)),
              Cardinal(Pointer(Element2)));
          Exit;
        end;

      if Result = 0 then
        if Element1 <> SortElement1 then
        begin
          if Element2 <> SortElement2 then
          begin
            ...
            if Result = 0 then
              Result := CmpW32(GroupRecord1.GroupLabel,
                GroupRecord2.GroupLabel);
          end
          else
          begin
    ...
    procedure TfrmMain.vstNavExpanding(Sender: TBaseVirtualTree;
    Node: PVirtualNode; var Allowed: Boolean);
    begin
    ...
    procedure TfrmMain.vstNavFocusChanged(Sender: TBaseVirtualTree;
    Node: PVirtualNode; Column: TColumnIndex);
    begin
      vstNavChange(Sender, Node);
    end;

    procedure TfrmMain.vstNavFreeNode(Sender: TBaseVirtualTree;
    Node: PVirtualNode);
    begin
      with PNavNodeData(Sender.GetNodeData(Node))^ do
      begin
        MissingElements := nil;
        Element := nil;
        Container := nil;
    ...
    begin
      ...
      begin
        if TextType = ttNormal then
        begin
          if Element.ElementType = etGroupRecord then
          begin
          ...
          else if Element.ElementType = etMainRecord then
          begin
            ...
            case Column of
              ...
              2:
                CellText := MainRecord.DisplayName[True];
            end;
            Exit;
          end
          ...
          begin
            ...
            case Column of
              - 1, 0:
                CellText := Element.Name;
              1:
                CellText := Chapter.ChapterTypeName;
              2:
                CellText := Chapter.ChapterName;
            end;
            Exit;
          end
          else if Element.ElementType = etFile then
          begin
            ...
            case Column of
              ...
              1:
                begin
                  s := '';
                  if wbShowFileFlags and Assigned(_File.Header) then
                  begin
              ...
              2:
                if not(fsIsHardcoded in _File.FileStates) then
        ...
        begin
          if (Column < 1) and (Element.ElementType = etMainRecord) then
          begin
            if Supports(Element.Container, IwbGroupRecord, GroupRecord) and
              (GroupRecord.GroupType in [1, 8 .. 10]) then
            begin
              MainRecord := Element as IwbMainRecord;
    ...
    procedure TfrmMain.vstNavHeaderClick(Sender: TVTHeader;
    HitInfo: TVTHeaderHitInfo);
    begin
      with HitInfo do
      begin
    ...
    procedure TfrmMain.vstNavIncrementalSearch(Sender: TBaseVirtualTree;
    Node: PVirtualNode; const SearchText: string; var Result: Integer);
    var
      Element: IwbElement;
      MainRecord: IwbMainRecord;
      ...
      if Assigned(Element) then
        ...
        begin
          ...
          case vstNav.Header.SortColumn of
            ...
            1:
              CompareText := MainRecord.EditorID;
            2:
              CompareText := MainRecord.DisplayName[True];
          end;
        end
        else if Element.ElementType = etFile then
        begin
    ...
    begin
      ...
      if Assigned(NodeData) and Supports(NodeData.Container,
        IwbContainerElementRef, Container) then
      begin
        ...
        begin
          ...
          begin
            ...
            begin
              if Assigned(ChildNodeData.Element) then
              begin
                if not Container.Equals(ChildNodeData.Element.Container) then
                begin
                  Sender.DeleteChildren(ChildNode);
                  vstNavFreeNode(Sender, ChildNode);
                  ChildNode.States := ChildNode.States -
                    [vsInitialized, vsChecking, vsCutOrCopy, vsDeleting,
                    vsHasChildren, vsExpanded, vsHeightMeasured];
                end
                else
          ...
          j := 0;
          for i := 0 to Pred(Integer(ChildCount)) do
            if not Container.Elements[i].Found then
            begin
    ...
    procedure TfrmMain.vstNavInitNode(Sender: TBaseVirtualTree;
    ParentNode, Node: PVirtualNode; var InitialStates: TVirtualNodeInitStates);
    var
      NodeData: PNavNodeData;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          else if Assigned(Container) and
            (Node.Index < Cardinal(Container.ElementCount)) then
          begin
            Element := Container.Elements[Node.Index];
            if Assigned(Element) and (Element.ElementType = etMainRecord) then
              if Integer(Succ(Node.Index)) < Container.ElementCount then
              begin
                if Supports(Container.Elements[Succ(Node.Index)],
                  IwbGroupRecord, GroupRecord) then
                begin
                  if (not(GroupRecord.GroupType in ParentedGroupRecordType)) or
                    ((Element as IwbMainRecord).FormID.ToCardinal <>
                    GroupRecord.GroupLabel) then
                    GroupRecord := nil;
                end;
              end;
          end;
        ...
        if not Assigned(GroupRecord) then
          ...
          begin
            ...
            begin
              ...
              while not FoundGroup and Assigned(SiblingNode) do
              begin
              ...
              if FoundGroup and Assigned(SiblingNode) then
              begin
      ...
      if not(Element.ElementType in [etMainRecord, etStructChapter]) and
        not Element.TreeHead then
      begin
        if Supports(Element, IwbContainerElementRef, Container) and
      ...
      else if Assigned(GroupRecord) then
      begin
        if GroupRecord.ElementCount > 0 then
          Include(InitialStates, ivsHasChildren);
        ...
        if Supports(Element, IwbContainerElementRef, Container) and
          ...
          for i := 0 to Pred(Container.ElementCount) do
            if (Container.Elements[i].TreeBranch) and
              Supports(Container.Elements[i], IwbContainerElementRef,
              Container2) and (Container2.ElementCount > 0) then
            begin
              Include(InitialStates, ivsHasChildren);
      ...
      if Supports(Element, IwbGroupRecord, GroupRecord) and
        (GroupRecord.GroupType in ParentedGroupRecordType) then
      begin
        FoundGroup := False;
        if Node.Index > 0 then
        begin
          Container := PNavNodeData(Sender.GetNodeData(Node.Parent))
            .Container as IwbContainerElementRef;
          if Assigned(Container) and
            (Integer(Node.Index) < Container.ElementCount) then
          begin
            Element := Container.Elements[Pred(Node.Index)];
            if (Element.ElementType = etMainRecord) and
              ((Element as IwbMainRecord).FormID.ToCardinal = GroupRecord.
              GroupLabel) then
            begin
              FoundGroup := True;
            end;
        ...
        begin
          ...
          if not FoundGroup then
          begin
            if Assigned(MainRecord) and Assigned(ParentNodeData) then
            begin
              for i := High(ParentNodeData.MissingElements)
                downto Low(ParentNodeData.MissingElements) do
      ...
      begin
        ...
        if wbLoaderDone and wbTranslationMode and Assigned(Element) and
          (InitialStates * [ivsHidden, ivsHasChildren] = []) and
          (Element.ElementType = etMainRecord) then
        begin
    ...
    procedure TfrmMain.vstNavKeyDown(Sender: TObject; var Key: Word;
    Shift: TShiftState);
    var
      R: TRect;
      p: TPoint;
      ...
      if wbLoaderDone then
        case Key of
          ...
          VK_INSERT:
            begin
              pmuNavPopup(nil);
              if mniNavAdd.Enabled and mniNavAdd.Visible then
              begin
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if wbLoaderDone then
            if NodeData.ConflictThis = ctUnknown then
            begin
              ConflictLevelForMainRecord(MainRecord, NodeData.ConflictAll,
                NodeData.ConflictThis);
              if MainRecord.IsInjected then
        ...
        else if NodeData.Element.ElementType = etFile then
        begin
          if Column = 2 then
            if MonospaceFontName <> '' then
              TargetCanvas.Font.Name := MonospaceFontName;
    ...
    procedure TfrmMain.vstSpreadSheetCheckHotTrack(Sender: TBaseVirtualTree;
    HotNode: PVirtualNode; HotColumn: TColumnIndex; var Allow: Boolean);
    var
      NodeDatas: PSpreadSheetNodeDatas;
      Element: IwbElement;
    begin
      ...
      if (HotColumn < 1) or (HotColumn >= TVirtualEditTree(Sender)
        .Header.Columns.Count) then
        Exit;
    ...
    procedure TfrmMain.vstSpreadSheetCompareNodes(Sender: TBaseVirtualTree;
    Node1, Node2: PVirtualNode; Column: TColumnIndex; var Result: Integer);
    var
    ...
    begin
      ...
      case Column of
        0:
          Result := CompareText(Element1._File.FileName,
            Element2._File.FileName);
        1:
          Result := TwbFormID.Compare((Element1 as IwbMainRecord)
            .LoadOrderFormID, (Element2 as IwbMainRecord).LoadOrderFormID);
      else
        Result := CompareStr(Element1.SortKey[True], Element2.SortKey[True]);
      end;
    end;

    procedure TfrmMain.vstSpreadSheetDragAllowed(Sender: TBaseVirtualTree;
    Node: PVirtualNode; Column: TColumnIndex; var Allowed: Boolean);
    var
      NodeDatas: PSpreadSheetNodeDatas;
    begin
    ...
    procedure TfrmMain.vstSpreadSheetDragDrop(Sender: TBaseVirtualTree;
    Source: TObject; DataObject: IDataObject; Formats: TFormatArray;
    Shift: TShiftState; Pt: TPoint; var Effect: Integer; Mode: TDropMode);
    var
      NodeDatas: PSpreadSheetNodeDatas;
    ...
    begin
      ...
      NodeDatas := Sender.GetNodeData(TVirtualEditTree(Sender)
        .DragSelection[0]);
    ...
    procedure TfrmMain.vstSpreadSheetDragOver(Sender: TBaseVirtualTree;
    Source: TObject; Shift: TShiftState; State: TDragState; Pt: TPoint;
    Mode: TDropMode; var Effect: Integer; var Accept: Boolean);
    var
      NodeDatas: PSpreadSheetNodeDatas;
    ...
    procedure TfrmMain.vstSpreadSheetEditing(Sender: TBaseVirtualTree;
    Node: PVirtualNode; Column: TColumnIndex; var Allowed: Boolean);
    var
      NodeDatas: PSpreadSheetNodeDatas;
      Element: IwbElement;
    ...
    procedure TfrmMain.vstSpreadSheetFreeNode(Sender: TBaseVirtualTree;
    Node: PVirtualNode);
    var
      NodeDatas: PSpreadSheetNodeDatas;
      i: Integer;
    ...
    procedure TfrmMain.vstSpreadSheetGetEditText(Sender: TBaseVirtualTree;
    Node: PVirtualNode; Column: TColumnIndex; var CellText: string);
    var
      NodeDatas: PSpreadSheetNodeDatas;
      Element: IwbElement;
    ...
    procedure TfrmMain.vstSpreadSheetGetText(Sender: TBaseVirtualTree;
    Node: PVirtualNode; Column: TColumnIndex; TextType: TVSTTextType;
    var CellText: string);
    var
      NodeDatas: PSpreadSheetNodeDatas;
    ...
    begin
      ...
      if (Column < 0) or (Column >= TVirtualEditTree(Sender)
        .Header.Columns.Count) then
        Exit;
      ...
      case Column of
        0:
          CellText := Element._File.Name;
        1:
          CellText := (Element as IwbMainRecord).LoadOrderFormID.ToString(True);
      else
        Element := NodeDatas[Column].Element;
        if not Assigned(Element) then
          Exit;
        if Element.Def.CanContainFormIDs then
        begin
          Element := Element.LinksTo;
          if Supports(Element, IwbMainRecord, MainRecord) then
          begin
    ...
    begin
      ...
      NodeDatas := TVirtualEditTree(Sender)
        .GetNodeData(TVirtualEditTree(Sender).HotNode);
      if not Assigned(NodeDatas) then
        Exit;
    ...
    procedure TfrmMain.vstSpreadSheetIncrementalSearch(Sender: TBaseVirtualTree;
    Node: PVirtualNode; const SearchText: string; var Result: Integer);
    var
      CompareText: string;
      s: string;
    ...
    procedure TfrmMain.vstSpreadSheetCreateEditor(Sender: TBaseVirtualTree;
    Node: PVirtualNode; Column: TColumnIndex; out EditLink: IVTEditLink);
    var
      NodeDatas: PSpreadSheetNodeDatas;
      Element: IwbElement;
    ...
    procedure TfrmMain.vstSpreadSheetWeaponInitNode(Sender: TBaseVirtualTree;
    ParentNode, Node: PVirtualNode; var InitialStates: TVirtualNodeInitStates);
    var
      NodeDatas: PSpreadSheetNodeDatas;
      MainRecord: IwbMainRecord;
    ...
    procedure TfrmMain.vstSpreadSheetNewText(Sender: TBaseVirtualTree;
    Node: PVirtualNode; Column: TColumnIndex; NewText: string);
    var
      NodeDatas: PSpreadSheetNodeDatas;
      Element: IwbElement;
    ...
    var
      ...
      i: Integer;
    begin
      if sameText(Identifier, 'wbGameMode') and (Args.Count = 0) then
      begin
        Value := wbGameMode;
        Done := True;
      end
      else if sameText(Identifier, 'wbGameName') and (Args.Count = 0) then
      begin
        Value := wbGameName;
        Done := True;
      end
      else if sameText(Identifier, 'wbGameMasterEsm') and (Args.Count = 0) then
      begin
        Value := wbGameMasterEsm;
        Done := True;
      end
      else if sameText(Identifier, 'wbGameName2') and (Args.Count = 0) then
      begin
        Value := wbGameName2;
        Done := True;
      end
      else if sameText(Identifier, 'wbAppName') and (Args.Count = 0) then
      begin
        Value := wbAppName;
        Done := True;
      end
      else if sameText(Identifier, 'wbLoadBSAs') and (Args.Count = 0) then
      begin
        Value := wbLoadBSAs;
        Done := True;
      end
      else if sameText(Identifier, 'wbSimpleRecords') and (Args.Count = 0) then
      begin
        Value := wbSimpleRecords;
        Done := True;
      end
      else if sameText(Identifier, 'wbTrackAllEditorID') and (Args.Count = 0)
      then
      begin
        Value := wbTrackAllEditorID;
        Done := True;
      end
      else if sameText(Identifier, 'wbRecordDefMap') and (Args.Count = 0) then
      begin
        Value := O2V(_wbRecordDefMap);
        Done := True;
      end
      else if (sameText(Identifier, 'ProgramPath') and (Args.Count = 0)) or
        (sameText(Identifier, 'wbProgramPath') and (Args.Count = 0)) then
      begin
        Value := wbProgramPath;
        Done := True;
      end
      else if (sameText(Identifier, 'ScriptsPath') and (Args.Count = 0)) or
        (sameText(Identifier, 'wbScriptsPath') and (Args.Count = 0)) then
      begin
        Value := wbScriptsPath;
        Done := True;
      end
      else if (sameText(Identifier, 'wbDataPath') and (Args.Count = 0)) or
        (sameText(Identifier, 'DataPath') and (Args.Count = 0)) then
      begin
        Value := wbDataPath;
        Done := True;
      end
      else if (sameText(Identifier, 'wbTempPath') and (Args.Count = 0)) or
        (sameText(Identifier, 'TempPath') and (Args.Count = 0)) then
      begin
        Value := wbTempPath;
        Done := True;
      end
      else if sameText(Identifier, 'wbOutputPath') and (Args.Count = 0) then
      begin
        Value := wbOutputPath;
        Done := True;
      end
      else if (sameText(Identifier, 'wbSettingsFileName') and (Args.Count = 0))
      then
      begin
        Value := wbSettingsFileName;
        Done := True;
      end
      else if (sameText(Identifier, 'wbSettings') and (Args.Count = 0)) then
      begin
        Value := O2V(Settings);
        Done := True;
      end
      else if sameText(Identifier, 'FilterApplied') and (Args.Count = 0) then
      begin
        Value := FilterApplied;
        Done := True;
      end
      else if sameText(Identifier, 'frmMain') and (Args.Count = 0) then
      begin
        Value := O2V(frmMain);
        Done := True;
      end
      else if sameText(Identifier, 'AddMessage') then
      begin
        if (Args.Count = 1) and VarIsStr(Args.Values[0]) then
        begin
      ...
      else if sameText(Identifier, 'ClearMessages') and (Args.Count = 0) then
      begin
        mmoMessages.Clear;
        Done := True;
        DoProcessMessages;
      end
      else if sameText(Identifier, 'FileCount') and (Args.Count = 0) then
      begin
        Value := Length(Files);
        Done := True;
      end
      else if sameText(Identifier, 'FileByIndex') then
      begin
        if (Args.Count = 1) and VarIsNumeric(Args.Values[0]) and
          (Args.Values[0] < Length(Files)) then
        begin
          ...
          JvInterpreterError(ieDirectInvalidArgument, 0);
        // or  ieNotEnoughParams, ieIncompatibleTypes or others.
      end
      else if sameText(Identifier, 'FileByLoadOrder') then
      begin
        if (Args.Count = 1) and VarIsNumeric(Args.Values[0]) and
          (Args.Values[0] < Length(Files)) then
        begin
          for i := Low(Files) to High(Files) do
            if Files[i].LoadOrder = Integer(Args.Values[0]) then
            begin
              Value := Files[i];
              Break;
            end;
      ...
      else if sameText(Identifier, 'IsPositionChanged') and (Args.Count = 1)
      then
      begin
      ...
      else if sameText(Identifier, 'AddNewFile') and (Args.Count = 0) then
      begin
        AddNewFile(_File, False);
        Value := _File;
        Done := True;
      end
      else if sameText(Identifier, 'AddNewFile') and (Args.Count = 1) then
      begin
        AddNewFile(_File, Args.Values[0]);
        Value := _File;
        Done := True;
      end
      else if sameText(Identifier, 'AddNewFileName') and (Args.Count = 1) then
      begin
        Value := AddNewFileName(Args.Values[0], False);
        Done := True;
      end
      else if sameText(Identifier, 'AddNewFileName') and (Args.Count = 2) then
      begin
        Value := AddNewFileName(Args.Values[0], Args.Values[1]);
        Done := True;
      end
      else if sameText(Identifier, 'AddRequiredElementMasters') and
        (Args.Count = 3) then
      begin
        Value := False;
      ...
      else if sameText(Identifier, 'RemoveNode') and (Args.Count = 1) then
      begin
        Value := False;
        if Supports(IInterface(Args.Values[0]), IwbElement, Element) then
        begin
      ...
      else if sameText(Identifier, 'ConflictThisForMainRecord') and
        (Args.Count = 1) then
      begin
        if Supports(IInterface(Args.Values[0]), IwbMainRecord, MainRecord) then
        begin
      ...
      else if sameText(Identifier, 'ConflictAllForMainRecord') and
        (Args.Count = 1) then
      begin
        if Supports(IInterface(Args.Values[0]), IwbMainRecord, MainRecord) then
        begin
      ...
      else if sameText(Identifier, 'ConflictThisForNode') and (Args.Count = 1)
      then
      begin
        if Supports(IInterface(Args.Values[0]), IwbElement, Element) then
        begin
      ...
      else if sameText(Identifier, 'ConflictAllForNode') and (Args.Count = 1)
      then
      begin
        if Supports(IInterface(Args.Values[0]), IwbElement, Element) then
        begin
      ...
      else if sameText(Identifier, 'ConflictAllForElements') and
        ((Args.Count = 3) or (Args.Count = 4)) then
      begin
        ...
        begin
          ...
          if Assigned(List) then
            ...
            begin
              if not Supports(IInterface(Pointer(List[i])), IwbElement, Element)
              then
                Continue;
        ...
        begin
          for i := 0 to 1 do
          begin
            if not Supports(IInterface(Args.Values[i]), IwbElement, Element)
            then
              Continue;
            SetLength(NodeDatas, Succ(Length(NodeDatas)));
            NodeDatas[Pred(Length(NodeDatas))].Element := Element;
        ...
        if Length(NodeDatas) > 0 then
          if Assigned(NodeDatas[0].Container) then
            Value := ConflictLevelForChildNodeDatas(NodeDatas,
              Args.Values[i + 1], Args.Values[i + 2])
          else
            Value := ConflictLevelForNodeDatas(@NodeDatas[0], Length(NodeDatas),
              Args.Values[i + 1], Args.Values[i + 2]);
        Done := True;
      end
      else if sameText(Identifier, 'JumpTo') and (Args.Count = 2) then
      begin
        if Supports(IInterface(Args.Values[0]), IwbMainRecord, MainRecord) then
        begin
          vstNav.EndUpdate;
          if not vstNav.Enabled then
            vstNav.Enabled := True;
      ...
      else if sameText(Identifier, 'ApplyFilter') and (Args.Count = 0) then
      begin
      ...
      else if sameText(Identifier, 'RemoveFilter') and (Args.Count = 0) then
      begin
        DoSetActiveRecord(nil);
      ...
      else if sameText(Identifier, 'ExecuteCaptureConsoleOutput') and
        (Args.Count = 1) then
      begin
        Value := ExecuteCaptureConsoleOutput(Args.Values[0]);
        Done := True;
      end
      else if sameText(Identifier, 'GenerateLODTES4') and (Args.Count = 1) then
      begin
        if Supports(IInterface(Args.Values[0]), IwbMainRecord, MainRecord) then
        begin
          if wbGameMode = gmTES4 then
      ...
      else if sameText(Identifier, 'GenerateLODTES5Trees') and (Args.Count = 1)
      then
      begin
        if Supports(IInterface(Args.Values[0]), IwbMainRecord, MainRecord) then
        begin
      ...
      else if sameText(Identifier, 'GenerateLODTES5Objects') and (Args.Count = 1)
      then
      begin
        if Supports(IInterface(Args.Values[0]), IwbMainRecord, MainRecord) then
        begin
      ...
      else if sameText(Identifier, 'wbGetUVRangeTexturesList') and
        (Args.Count = 3) then
      begin
        wbGetUVRangeTexturesList(TStrings(V2O(Args.Values[0])),
        // TStrings list of meshes
        TStrings(V2O(Args.Values[1])), // TStrings list of textures, output
        Single(Args.Values[2]) // UVRange
          );
        Done := True;
      end
      else if sameText(Identifier, 'wbBuildAtlasFromTexturesList') and
        (Args.Count = 7) then
      begin
        wbBuildAtlasFromTexturesList(TStrings(V2O(Args.Values[0])),
        // TStrings list of textures
      ...
      else if sameText(Identifier, 'wbBuildAtlasFromAtlasMap') and
        (Args.Count = 5) then
      begin
        wbBuildAtlasFromAtlasMap(TStrings(V2O(Args.Values[0])),
        // TStrings atlas map
      ...
      else if sameText(Identifier, 'dfFloatDecimalDigits') and (Args.Count = 0)
      then
      begin
    ...
    var
      i, v: Integer;
    begin
      if sameText(Identifier, 'ScriptProcessElements') then
      begin
        ScriptProcessElements := [];
        v := V2S(Value);
        for i := Integer(Low(TwbElementType))
          to Integer(High(TwbElementType)) do
      ...
      else if sameText(Identifier, 'wbOutputPath') then
      begin
        wbOutputPath := Value;
        Done := True;
      end
      else if sameText(Identifier, 'FilterScripted') then
      begin
        FilterScripted := Value;
        Done := True;
      end
      else if sameText(Identifier, 'FilterConflictAll') then
      begin
        FilterConflictAll := Value;
        Done := True;
      end
      else if sameText(Identifier, 'FilterConflictAllSet') then
      begin
        FilterConflictAllSet := [];
        v := V2S(Value);
      ...
      else if sameText(Identifier, 'FilterConflictThis') then
      begin
        FilterConflictThis := Value;
        Done := True;
      end
      else if sameText(Identifier, 'FilterConflictThisSet') then
      begin
        FilterConflictThisSet := [];
        v := V2S(Value);
      ...
      else if sameText(Identifier, 'FilterByInjectStatus') then
      begin
        FilterByInjectStatus := Value;
        Done := True;
      end
      else if sameText(Identifier, 'FilterInjectStatus') then
      begin
        FilterInjectStatus := Value;
        Done := True;
      end
      else if sameText(Identifier, 'FilterByNotReachableStatus') then
      begin
        FilterByNotReachableStatus := Value;
        Done := True;
      end
      else if sameText(Identifier, 'FilterNotReachableStatus') then
      begin
        FilterNotReachableStatus := Value;
        Done := True;
      end
      else if sameText(Identifier, 'FilterByReferencesInjectedStatus') then
      begin
        FilterByReferencesInjectedStatus := Value;
        Done := True;
      end
      else if sameText(Identifier, 'FilterReferencesInjectedStatus') then
      begin
        FilterReferencesInjectedStatus := Value;
        Done := True;
      end
      else if sameText(Identifier, 'FilterByEditorID') then
      begin
        FilterByEditorID := Value;
        Done := True;
      end
      else if sameText(Identifier, 'FilterEditorID') then
      begin
        FilterEditorID := Value;
        Done := True;
      end
      else if sameText(Identifier, 'FilterByName') then
      begin
        FilterByName := Value;
        Done := True;
      end
      else if sameText(Identifier, 'FilterName') then
      begin
        FilterName := Value;
        Done := True;
      end
      else if sameText(Identifier, 'FilterByBaseEditorID') then
      begin
        FilterByBaseEditorID := Value;
        Done := True;
      end
      else if sameText(Identifier, 'FilterBaseEditorID') then
      begin
        FilterBaseEditorID := Value;
        Done := True;
      end
      else if sameText(Identifier, 'FilterByBaseName') then
      begin
        FilterByBaseName := Value;
        Done := True;
      end
      else if sameText(Identifier, 'FilterBaseName') then
      begin
        FilterBaseName := Value;
        Done := True;
      end
      else if sameText(Identifier, 'FilterScaledActors') then
      begin
        FilterScaledActors := Value;
        Done := True;
      end
      else if sameText(Identifier, 'FilterBySignature') then
      begin
        FilterBySignature := Value;
        Done := True;
      end
      else if sameText(Identifier, 'FilterSignatures') then
      begin
        FilterSignatures := Value;
        Done := True;
      end
      else if sameText(Identifier, 'FilterByBaseSignature') then
      begin
        FilterByBaseSignature := Value;
        Done := True;
      end
      else if sameText(Identifier, 'FilterBaseSignatures') then
      begin
        FilterBaseSignatures := Value;
        Done := True;
      end
      else if sameText(Identifier, 'FilterByPersistent') then
      begin
        FilterByPersistent := Value;
        Done := True;
      end
      else if sameText(Identifier, 'FilterPersistent') then
      begin
        FilterPersistent := Value;
        Done := True;
      end
      else if sameText(Identifier, 'FilterUnnecessaryPersistent') then
      begin
        FilterUnnecessaryPersistent := Value;
        Done := True;
      end
      else if sameText(Identifier, 'FilterMasterIsTemporary') then
      begin
        FilterMasterIsTemporary := Value;
        Done := True;
      end
      else if sameText(Identifier, 'FilterIsMaster') then
      begin
        FilterIsMaster := Value;
        Done := True;
      end
      else if sameText(Identifier, 'FilterPersistentPosChanged') then
      begin
        FilterPersistentPosChanged := Value;
        Done := True;
      end
      else if sameText(Identifier, 'FilterDeleted') then
      begin
        FilterDeleted := Value;
        Done := True;
      end
      else if sameText(Identifier, 'FilterByVWD') then
      begin
        FilterByVWD := Value;
        Done := True;
      end
      else if sameText(Identifier, 'FilterVWD') then
      begin
        FilterVWD := Value;
        Done := True;
      end
      else if sameText(Identifier, 'FilterByHasVWDMesh') then
      begin
        FilterByHasVWDMesh := Value;
        Done := True;
      end
      else if sameText(Identifier, 'FilterHasVWDMesh') then
      begin
        FilterHasVWDMesh := Value;
        Done := True;
      end
      else if sameText(Identifier, 'FilterByHasPrecombinedMesh') then
      begin
        FilterByHasPrecombinedMesh := Value;
        Done := True;
      end
      else if sameText(Identifier, 'FilterHasPrecombinedMesh') then
      begin
        FilterHasPrecombinedMesh := Value;
        Done := True;
      end
      else if sameText(Identifier, 'FlattenBlocks') then
      begin
        FlattenBlocks := Value;
        Done := True;
      end
      else if sameText(Identifier, 'FlattenCellChilds') then
      begin
        FlattenCellChilds := Value;
        Done := True;
      end
      else if sameText(Identifier, 'AssignPersWrldChild') then
      begin
        AssignPersWrldChild := Value;
        Done := True;
      end
      else if sameText(Identifier, 'InheritConflictByParent') then
      begin
        InheritConflictByParent := Value;
        Done := True;
      end
      else if sameText(Identifier, 'dfFloatDecimalDigits') then
      begin
        Assert(dfFloatDecimalDigits > 0,
          'dfFloatDecimalDigits must be greater than 0');
    ...
    procedure HasUnitProc(const Name: string; NameType: TNameType; Flags: Byte;
    Param: Pointer);
    begin
      case NameType of
        ntContainsUnit:
    ...
    begin
      ...
      if sameText(UnitName, 'xEditAPI') or sameText(UnitName, 'UITypes') or
        IsUnitCompiledIn(HInstance, UnitName) then
      begin
    ...
    begin
      try
        ...
        begin
          Inc(wbShowStartTime);
          try
            if wbToolMode in [tmEdit] then
            begin
              // unchecked Show Tip checkbox, update setting
              if Assigned(frmTip) and not wbShowTip then
              begin
                Settings.WriteBool('Options', 'ShowTip', wbShowTip);
                Settings.UpdateFile;
              end;
            ...
            if (wbToolMode in [tmLODGen, tmScript]) then
            begin
            ...
            tbsWEAPSpreadsheet.TabVisible := (wbGameMode = gmTES4) or
              wbIsSkyrim;
            tbsARMOSpreadsheet.TabVisible := (wbGameMode = gmTES4) or
              wbIsSkyrim;
            tbsAMMOSpreadsheet.TabVisible := (wbGameMode = gmTES4) or
              wbIsSkyrim;

            if wbForceTerminate then
            begin
              GeneralProgressNoAbortCheck
                ('Loading of modules got terminated early. Editing is disabled.');
              Exit;
            end;
            ...
            if not(wbQuickClean or (wbToolMode in wbAutoModes)) then
              if wbQuickShowConflicts or wbAutoLoad then
              begin
                ModGroups := wbModGroupsByName;
                wbModGroupsByName(False).ShowValidationMessages;
              end
              else if wbToolMode in [tmView, tmEdit] then
              begin
                with TfrmModGroupSelect.Create(Self) do
                  try
                    AllModGroups := wbModGroupsByName;
            ...
            begin
              ...
              try
                with wbModulesByLoadOrder.FilteredByFlag(mfTaggedForPluginMode)
                  [0]._File do
                  BuildOrLoadRef(False);

                mniNavFilterForCleaning.Click;
                JumpTo(wbModulesByLoadOrder.FilteredByFlag
                  (mfTaggedForPluginMode)[0]._File.Header, False);
                vstNav.ClearSelection;
                vstNav.FocusedNode := vstNav.FocusedNode.Parent;
                vstNav.Selected[vstNav.FocusedNode] := True;
                DoSetActiveRecord(nil);
                ...
                with wbModulesByLoadOrder.FilteredByFlag(mfTaggedForPluginMode)
                  ...
                  begin
                    MarkModifiedRecursive([etFile, etMainRecord,
                      etGroupRecord]);
                    WasUnsaved := True;
                  end;
                ...
                begin
                  ...
                  begin
                    ...
                    with wbModulesByLoadOrder.FilteredByFlag
                      (mfTaggedForPluginMode)[0]._File do
                      BuildOrLoadRef(False);
                    ...
                    with wbModulesByLoadOrder.FilteredByFlag
                      ...
                      begin
                        MarkModifiedRecursive
                          ([etFile, etMainRecord, etGroupRecord]);
                        WasUnsaved := True;
                      end;
            ...
            begin
              pmuMainPopup(Self);
              if mniMainPluggyLinkReference.Visible then
              begin
        ...
        begin
          ...
          if Assigned(NewFile) and Assigned(MasterFile) and
            not MasterFile.Equals(NewFile) then
          begin
            if fsIsDeltaPatch in NewFile.FileStates then
              try

                PerformLongAction('Creating Delta Patch', '',
                  procedure
                  var
                    i: Integer;
                    Node: PVirtualNode;
                  ...
                  begin
                    ...
                    Include(PwbModuleInfo(MasterFile.ModuleInfo).miFlags,
                    ...
                    begin
                      NodeData := vstNav.GetNodeData(Node);
                      if Assigned(NodeData) then
                        if Supports(NodeData.Element, IwbMainRecord, MainRecord)
                        then
                          if MainRecord.Signature <> 'TES4' then
                            if not MainRecord.IsDeleted then
                              if NodeData.ConflictThis = ctOnlyOne then
                                if Supports
                                  (wbCopyElementToFile(NodeData.Element,
                                  NewFile, False, False, '', '', '', False),
                                  IwbMainRecord, MainRecord) then
                    ...
                    wbModulesByLoadOrder.ExcludeAll(mfTaggedForPluginMode);
                    Include(PwbModuleInfo(NewFile.ModuleInfo).miFlags,
                      mfTaggedForPluginMode);
                    mniNavFilterForCleaning.Click;
    ...
    begin
      if tmrPendingSetActive.Enabled then
        tmrPendingSetActiveTimer(tmrPendingSetActive)
      else if PendingResetActiveTree then
        ResetActiveTree;
    end;
    ...
    begin
      ...
      begin
        _File := nil;
        for i := Low(Files) to High(Files) do
          if Files[i].LoadOrderFileID = FileID then
          begin
            _File := Files[i];
            Break;
          end;
      ...
      begin
        if (FileID.FullSlot < Low(Files)) or (FileID.FullSlot > High(Files))
        then
          Exit;
    ...
    var
      StyleName: string;
    begin
      if Message.Msg = CM_CUSTOMSTYLECHANGED then
      begin
        wbDarkMode := wbIsDarkMode;
        StyleName := TStyleManager.ActiveStyle.Name;
        if Assigned(Settings) then
          if Settings.ReadString('UI', 'Theme', '') <> StyleName then
          begin
    ...
    constructor TLoaderThread.Create(aFileName: string; aMaster: string;
    aLoadOrder: Integer; aFileStates: TwbFileStates = []);
    begin
    ...
    begin
      ...
      try
        ...
        t := s;
        if (t = '') and (_LoaderProgressAction <> '') and
          ((lNow - _LoaderProgressLastShown) > 1 / 24 / 60 / 6 { 10 seconds } )
        then
          t := 'still ' + _LoaderProgressAction + '...';

        if t <> '' then
        begin
          frmMain.PostAddMessage('[' + FormatDateTime('nn:ss',
            lNow - wbStartTime) + '] Background Loader: ' + t);
          _LoaderProgressLastShown := lNow;
        end;
      finally
          ...
          { if ltLoadOrderOffset + ltLoadList.Count >= 255 then begin
            ...
            begin
              ...
              try
                ...
                try
                  if FindBSAs(wbTheGameIniFileName, ltDataPath, n, m) > 0 then
                  begin
                    for i := 0 to Pred(n.Count) do
                      ...
                      begin
                        ...
                        if wbArchiveExtension = '.bsa' then
                          wbContainerHandler.AddBSA
                            (MakeDataFileName(n[i], ltDataPath))
                        else if wbArchiveExtension = '.ba2' then
                          wbContainerHandler.AddBA2
                            (MakeDataFileName(n[i], ltDataPath))
                      end
                      else
              ...
              for i := 0 to Pred(ltLoadList.Count) do
              begin
                n := TStringList.Create;
                try
                  m := TStringList.Create;
                  try
                    ...
                    if HasBSAs(ChangeFileExt(ltLoadList[i], ''), ltDataPath,
                      wbGameMode in [gmTES5, gmEnderal], wbIsSkyrim, n, m) > 0
                    then
                    begin
                      for j := 0 to Pred(n.Count) do
                        ...
                        begin
                          ...
                          try
                            if wbArchiveExtension = '.bsa' then
                              wbContainerHandler.AddBSA
                                (MakeDataFileName(n[j], ltDataPath))
                            else if wbArchiveExtension = '.ba2' then
                              wbContainerHandler.AddBA2
                                (MakeDataFileName(n[j], ltDataPath))
                          except
                            on E: Exception do
                              LoaderProgress
                                (Format('[%s] Could not be loaded. <Error: [%s] %s>',
                                [n[j], E.ClassName, E.Message]));
                          end;
                        end
                        else
            ...
            begin
              ...
              if wbGameMode = gmTES3 then
                if (i = 0) and (ltMaster = '') and (ltLoadOrderOffset = 0) and
                  (ltLoadList.Count > 0) and
                  sameText(ltLoadList[0], wbGameMasterEsm) then
                begin
                ...
                if not wbIsPlugin(ltLoadList[i]) then
                  if wbToolSource in [tsSaves] then
                    if not FileExists(s) then
                      // Assume its a save in the save path
              ...
              begin
                ...
                begin
                  t := wbGameExeName;
                  LoaderProgress('loading "' + t + '"...');
                  _File := wbFile(t, 0, ltDataPath + ltLoadList[i],
                    [fsIsHardcoded], b);
                  SetLength(ltFiles, Succ(Length(ltFiles)));
                  ltFiles[High(ltFiles)] := _File;
                  frmMain.SendAddFile(_File);
...
{$IFDEF USE_PARALLEL_BUILD_REFS}
              ...
              try
                TParallel.&For(Low(ltFiles), High(ltFiles),
                procedure(i: Integer)var OnlyLoad: Boolean; _File: IwbFile;
                begin wbStartTime := StartTime;
                _wbProgressCallback := LoaderProgress;
                wbCurrentTick := GetTickCount64; try
{$ELSE}
              for i := Low(ltFiles) to High(ltFiles) do
{$ENDIF}
              begin
                _File := ltFiles[i];
                if (fsIsHardcoded in _File.FileStates) or not _File.IsNotPlugin
                then
                begin
                  try
                    OnlyLoad := False;

                    if not(OnlyLoad and (wbDontCache or wbDontCacheLoad)) then
                    begin
                      if OnlyLoad then
                        s := 'loading'
                      else
                      ...
                      LoaderProgress('[' + _File.FileName + '] Start ' + s +
                        ' reference info.');
                    ...
                    on E: Exception do
                    begin
                      LoaderProgressNoAbortCheck('Fatal: <' + E.ClassName + ': '
                        + E.Message + '>');
                      wbLoaderError := True;
                    end;
                  end;
...
{$IFDEF USE_PARALLEL_BUILD_REFS}
          ...
          end); finally wbBuildingRefsParallel := False; end;
{$ENDIF}
        end; end;

        except on E: EAbort do wbForceTerminate := True;
        on E: Exception do begin LoaderProgressNoAbortCheck('Fatal: <' +
          E.ClassName + ': ' + E.Message + '>'); wbLoaderError := True; end;
        end; finally wbCurrentTick := 0; _LoaderProgressAction := '';
        if ltMaster = '' then ltLoadOrderOffset := -1;
        frmMain.SendLoaderDone(wbStartTime, ltLoadOrderOffset);
        LoaderProgress('finished'); _wbProgressCallback := nil; end;
        {
        ...
        begin if Assigned(Element) and (Element.ElementType = etMainRecord)
        then (Element as IwbMainRecord).UpdateRefs; end;

        { TTabHistoryEntry }

        constructor TTabHistoryEntry.Create(aTabSheet: TTabSheet);
        begin tiTabSheet := aTabSheet; inherited Create; end;

        procedure TTabHistoryEntry.Show;
        begin frmMain.pgMain.ActivePage := tiTabSheet;
        frmMain.pgMainChange(frmMain.pgMain); end;

        { TCompareRecordsHistoryEntry }

        constructor TCompareRecordsHistoryEntry.Create(const aCompareRecords
          : TDynMainRecords); begin crRecords := aCompareRecords;
        inherited Create; end;

        function TCompareRecordsHistoryEntry.Remove(const aMainRecord
          : IwbMainRecord): Boolean; var i, j: Integer; begin j := 0;
        SetLength(crRecords, Length(crRecords));
        for i := Low(crRecords) to High(crRecords) do if not crRecords[i]
          .Equals(aMainRecord) then begin if i <> j then crRecords[j] :=
          crRecords[i]; Inc(j); end;
        if j <> Length(crRecords) then begin SetLength(crRecords, j);
        crRecordsChanged := True; end; Result := Length(crRecords) < 2; end;

        procedure TCompareRecordsHistoryEntry.Show; var i: Integer;
        begin with frmMain do begin vstNav.ClearSelection;
        for i := Low(crRecords) to High(crRecords) do begin vstNav.FocusedNode
          := FindNodeForElement(crRecords[i]);
        vstNav.Selected[vstNav.FocusedNode] := True; end;
        DoSetActiveRecord(crRecords); pgMain.ActivePage := tbsView;
        pgMainChange(pgMain); end; end;

        { THistoryEntry }

        function THistoryEntry.Remove(const aMainRecord: IwbMainRecord)
          : Boolean; begin Result := False; end;

        { TCompareRecordsPosHistoryEntry }

        constructor TCompareRecordsPosHistoryEntry.Create(const aCompareRecords
          : TDynMainRecords); var i: Integer; begin inherited;
        with frmMain, vstView, Header, Columns do begin crpOffsetXY := OffsetXY;
        crpFocusNode := FocusedNode; crpFocusColumn := FocusedColumn;
        if Assigned(crpFocusNode) then crpFocusRect :=
          GetDisplayRect(crpFocusNode, crpFocusColumn, False);
        SetLength(crpColumnWidths, Count);
        for i := 0 to Pred(Count) do crpColumnWidths[i] :=
          Items[i].Width; end; end;

        procedure TCompareRecordsPosHistoryEntry.Show; var i: Integer;
        Node: PVirtualNode; begin with frmMain, vstView, Header,
          Columns do begin
        ...
        if not crRecordsChanged then begin
          ...
          if Count <> Length(crpColumnWidths) then Exit;

        for i := 0 to Pred(Count) do Items[i].Width := crpColumnWidths[i];

        UpdateScrollBars(False);

        OffsetXY := crpOffsetXY;

        if Assigned(crpFocusNode) then begin Node :=
          vstView.GetNodeAt(crpFocusRect.Left + 2, crpFocusRect.Top + 2);
        if Assigned(Node) then FocusedNode := Node; end;
        FocusedColumn := crpFocusColumn;

        OffsetXY := crpOffsetXY; end; end; end;

        { TMainRecordPosHistoryEntry }

        constructor TMainRecordPosHistoryEntry.Create(const aMainRecord
          : IwbMainRecord); var i: Integer; begin inherited;
        with frmMain, vstView, Header, Columns do begin mrpOffsetXY := OffsetXY;
        mrpFocusNode := FocusedNode; mrpFocusColumn := FocusedColumn;
        if Assigned(mrpFocusNode) then mrpFocusRect :=
          GetDisplayRect(mrpFocusNode, mrpFocusColumn, False);
        SetLength(mrpColumnWidths, Count);
        for i := 0 to Pred(Count) do mrpColumnWidths[i] :=
          Items[i].Width; end; end;

        procedure TMainRecordPosHistoryEntry.Show; var i: Integer;
        Node: PVirtualNode; begin with frmMain, vstView, Header,
          Columns do begin inherited;

        if Count <> Length(mrpColumnWidths) then Exit;

        for i := 0 to Pred(Count) do Items[i].Width := mrpColumnWidths[i];

        UpdateScrollBars(False);

        OffsetXY := mrpOffsetXY;

        if Assigned(mrpFocusNode) then begin Node :=
          vstView.GetNodeAt(mrpFocusRect.Left + 2, mrpFocusRect.Top + 2);
        if Assigned(Node) then FocusedNode := Node; end;
        FocusedColumn := mrpFocusColumn;

        OffsetXY := mrpOffsetXY; end; end;

        { TMainRecordHistoryEntry }

        constructor TMainRecordHistoryEntry.Create(const aMainRecord
          : IwbMainRecord); begin mrRecord := aMainRecord;
        inherited Create; end;

        function TMainRecordHistoryEntry.GetTabSheet: TTabSheet;
        begin Result := frmMain.tbsView; end;

        function TMainRecordHistoryEntry.Remove(const aMainRecord
          : IwbMainRecord): Boolean;
        begin Result := mrRecord.Equals(aMainRecord); end;

        procedure TMainRecordHistoryEntry.Show;
        begin with frmMain do begin vstNav.ClearSelection;
        vstNav.FocusedNode := FindNodeForElement(mrRecord);
        vstNav.Selected[vstNav.FocusedNode] := True;
        DoSetActiveRecord(mrRecord); pgMain.ActivePage := GetTabSheet;
        pgMainChange(pgMain); end; end;

        { TMainRecordRefByHistoryEntry }

        function TMainRecordRefByHistoryEntry.GetTabSheet: TTabSheet;
        begin Result := frmMain.tbsReferencedBy; end;

        { TPluggyLinkThread }

        procedure TPluggyLinkThread.ChangeDetected; var s: string;
        FormID, BaseFormID, InventoryFormID, EnchantmentFormID,
          SpellFormID: TwbFormID; begin with TBufferedFileStream.Create(plFolder
          + 'Pluggy' + wbAppName + 'ViewWorld.csv', fmOpenRead or
          fmShareDenyNone) do try Position := Size - 2024;
        SetLength(s, 64 * 1024); SetLength(s, Read(s[1], 64 * 1024));
        finally Free; end; with TStringList.Create do try Text := s;
        if Count < 2 then Exit; CommaText := Strings[Pred(Count)];
        if Count < 2 then Exit; FormID := TwbFormID.FromStr(Strings[0]);
        BaseFormID := TwbFormID.FromStr(Strings[1]); finally Free; end;
        with TBufferedFileStream.Create(plFolder + 'Pluggy' + wbAppName +
          'ViewInventory.csv', fmOpenRead or fmShareDenyNone) do try Position :=
          Size - 2024; SetLength(s, 64 * 1024);
        SetLength(s, Read(s[1], 64 * 1024)); finally Free; end;
        with TStringList.Create do try Text := s; if Count < 2 then Exit;
        CommaText := Strings[Pred(Count)]; if Count < 2 then Exit;
        InventoryFormID := TwbFormID.FromStr(Strings[0]);
        EnchantmentFormID := TwbFormID.FromStr(Strings[1]); finally Free; end;
        with TBufferedFileStream.Create(plFolder + 'Pluggy' + wbAppName +
          'ViewSpells.csv', fmOpenRead or fmShareDenyNone) do try Position :=
          Size - 2024; SetLength(s, 64 * 1024);
        SetLength(s, Read(s[1], 64 * 1024)); finally Free; end;
        with TStringList.Create do try Text := s; if Count < 2 then Exit;
        CommaText := Strings[Pred(Count)]; if Count < 1 then Exit;
        SpellFormID := TwbFormID.FromStr(Strings[0]); finally Free; end;

        if (FormID <> plLastFormID) or (BaseFormID <> plLastBaseFormID) or
          (InventoryFormID <> plLastBaseFormID) or (EnchantmentFormID <>
          plLastBaseFormID) or (SpellFormID <> plLastBaseFormID) then begin

          plLastFormID := FormID; plLastBaseFormID := BaseFormID;
        plLastInventoryFormID := InventoryFormID;
        plLastEnchantmentFormID := EnchantmentFormID;
        plLastSpellFormID := SpellFormID;

        frmMain.PostPluggyChange(FormID, BaseFormID, InventoryFormID,
          EnchantmentFormID, SpellFormID); end; end;

        procedure TPluggyLinkThread.Execute; var WaitHandle: THandle;
        begin plFolder := wbMyGamesTheGamePath + 'Pluggy\User Files\';
        frmMain.PostAddMessage('[PluggyLink] Starting for: ' + plFolder);
        ChangeDetected; try WaitHandle := FindFirstChangeNotification(PChar
          (plFolder), False, FILE_NOTIFY_CHANGE_FILE_NAME or
          FILE_NOTIFY_CHANGE_LAST_WRITE);
        if WaitHandle = INVALID_HANDLE_VALUE then RaiseLastOSError;
        try repeat case WaitForSingleObject(WaitHandle, 1000) of WAIT_OBJECT_0
          : begin ChangeDetected; if not FindNextChangeNotification(WaitHandle)
        then RaiseLastOSError; end; WAIT_FAILED: RaiseLastOSError; end;
        until Terminated or wbForceTerminate;
        finally if not FindCloseChangeNotification(WaitHandle)
        then RaiseLastOSError; end;
        except on E: Exception do frmMain.PostAddMessage('[PluggyLink] Error: '
          + E.Message); end;
        frmMain.PostAddMessage('[PluggyLink] terminated'); end;

        { TwbComboEditLink }

        procedure TwbComboEditLink.SetBounds(R: TRect); var H: Integer; begin
        // Let's show from 1 to 32 lines to pick from
        H := PickList.Count; if H > 32 then H := 32 else if H < 1 then H := 1;
        H := H * TComboBox(FEdit).Font.Height; R.Bottom := R.Bottom + Abs(H);

        inherited; end;

        type TWinControlProtectedHacker = class(TWinControl); TMainWndProc =
        procedure(var Message: TMessage) of object;

        var CodePointer_TWinControl_MainWndProc: TMainWndProc;
        Trampoline_TWinControl_MainWndProc:
        procedure(Self: TWinControlProtectedHacker;
        var
            Message: TMessage);

          procedure Detour_TWinControl_MainWndProc(Self
            : TWinControlProtectedHacker;
        var
            Message: TMessage); begin case Message.Msg of WM_PAINT
            : begin LockProcessMessages;
          try Trampoline_TWinControl_MainWndProc(Self, Message);
          finally UnLockProcessMessages; end; end;
          else Trampoline_TWinControl_MainWndProc(Self, Message); end; end;

          { TGameLinkThread }

          procedure TGameLinkThread.ChangeDetected;
          var Stream: TBufferedFileStream; sl: TStringList;

          SelectedRefID: TwbFormID; SelectedBaseID: TwbFormID;
          begin Stream := TBufferedFileStream.Create(glFolder + 'xEditLink.ini',
            fmOpenRead or fmShareDenyNone); try sl := TStringList.Create;
          try sl.LoadFromStream(Stream);
          with TMemIniFile.Create('') do try SetStrings(sl);
          SelectedRefID := TwbFormID.FromStrDef(ReadString('Console',
            'selectedRefID', '00000000'));
          SelectedBaseID := TwbFormID.FromStrDef(ReadString('Console',
            'selectedBaseID', '00000000')); finally Free; end; finally sl.Free;
          end; finally Stream.Free; end;

          if not SelectedRefID.IsNull then if (SelectedRefID <> glLastFormID) or
            (SelectedBaseID <> glLastBaseFormID) then begin

            glLastFormID := SelectedRefID; glLastBaseFormID := SelectedBaseID;

          frmMain.PostPluggyChange(SelectedRefID, SelectedBaseID,
            TwbFormID.Null, TwbFormID.Null, TwbFormID.Null); end; end;

          procedure TGameLinkThread.Execute; var WaitHandle: THandle;
          begin glFolder := wbDataPath + 'xEdit\';
          frmMain.PostAddMessage('[GameLink] Starting for: ' + glFolder);
          ChangeDetected;
          try WaitHandle := FindFirstChangeNotification(PChar(glFolder), False,
          ...
          then RaiseLastOSError; end;
          except on E: Exception do frmMain.PostAddMessage('[GameLink] Error: '
            + E.Message); end; frmMain.PostAddMessage('[GameLink] terminated');

          end;

          { TMainRecordElementHistoryEntry }

          constructor TMainRecordElementHistoryEntry.Create(const aMainRecord
            : IwbMainRecord;
        const
        aElement:
          IwbElement); begin inherited Create(aMainRecord);
        mreElement := aElement; end;

        procedure TMainRecordElementHistoryEntry.Show;
        begin with frmMain do begin ViewFocusedElement := mreElement;
        NodeForViewFocusedElement := nil;
        ColumnForViewFocusedElement := NoColumn;

        inherited;

        if not Assigned(NodeForViewFocusedElement) and
          Assigned(ViewFocusedElement) and ViewFocusedElement.Equals(mreElement)
        then ResetActiveTree;

        ViewFocusedElement := nil; if Assigned(NodeForViewFocusedElement)
        then begin vstView.FocusedNode := NodeForViewFocusedElement;
        if ColumnForViewFocusedElement <> NoColumn then vstView.FocusedColumn :=
          ColumnForViewFocusedElement; vstView.TopNode := vstView.FocusedNode;
        vstView.ScrollIntoView(vstView.FocusedColumn, True,
          vstView.FocusedNode); end; end; end;

        { TwbCheckGitHubReleaseThread }

        procedure TwbCheckGitHubReleaseThread.Execute; var j: TJsonBaseObject;
        a: TJsonArray; i: Integer; s: string;

        v, vmax: TwbVersion; begin vmax := '';
        try j := TJsonBaseObject.ParseUtf8(GetUrlContent
          ('https://api.github.com/repos/TES5Edit/TES5Edit/releases'));
        try if j is TJsonArray then begin a := j as TJsonArray;
        for i := 0 to Pred(a.Count) do try s := a.O[i].s['tag_name'];
        if s.StartsWith('xedit-') then try v := Copy(s, Succ(Length('xedit-')),
          High(Integer)); if v > vmax then vmax := v; except end; except end;
        end; finally j.Free; end; except end; Synchronize(
          procedure
          begin
            if Assigned(frmMain) then
            begin
        ...
        procedure TwbCheckNexusModsReleaseThread.Execute; var i: Integer;
        s: string; vmax: TwbVersion;
        const csCheckFor = 'property="twitter:label1" content="version"';
        csExtractAfter = 'property="twitter:data1" content="';
        begin if wbNexusModsUrl = '' then Exit;

        vmax := ''; try s := GetUrlContent(wbNexusModsUrl);
        s := s.ToLowerInvariant; if s.Contains(csCheckFor) then begin i :=
          Pos(csExtractAfter, s); if i > 0 then begin Delete(s, 1,
          i + Pred(Length(csExtractAfter))); i := Pos('"', s);
        if i > 0 then begin Delete(s, i, High(Integer)); vmax := s; end; end;
        end; except end; Synchronize(
          procedure
          begin
            if Assigned(frmMain) then
            begin
              frmMain.NexusModsVersion := vmax;
              frmMain.ShowNexusModsHint := Now + (1 / 24 / 60 / 6);
              // 10 seconds
            end;
          end); end;
        ...
        Index:
          Integer;
        DPI:
          Integer = 0): Boolean of object;
        TUxThemeStyleHack = class(TUxThemeStyle);
        TCustomStyleHack = class(TCustomStyle);

        var Trampoline_TUxThemeStyle_DoDrawIcon:
        function(Self: TUxThemeStyleHack;
        DC:
          HDC;
        Details:
          TThemedElementDetails;
        ...
        Index:
          Integer;
        DPI:
          Integer = 0): Boolean; CodePointer_TUxThemeStyle_DoDrawIcon
          : TDoDrawIcon;

        function Detour_TUxThemeStyle_DoDrawIcon(Self: TUxThemeStyleHack;
        DC:
          HDC;
        Details:
          TThemedElementDetails;
        ...
        Index:
          Integer;
        DPI:
          Integer = 0): Boolean; var Icon: HICON; IW, IH: Integer;
        begin if Details.Element = teButton
        then begin if not ImageList_GetIconSize(himl, IW, IH) then Exit(False);
        Icon := ImageList_GetIcon(himl, Index, LR_DEFAULTCOLOR);
        Result := DrawIconEx(DC, R.Left, R.Top, Icon, IW, IH, 0, 0, DI_NORMAL);
        DestroyIcon(Icon);
        end else Result := Trampoline_TUxThemeStyle_DoDrawIcon(Self, DC,
          Details, R, himl, Index, DPI) end;

        initialization wbLockProcessMessages := LockProcessMessages;
        wbUnLockProcessMessages := UnLockProcessMessages;

        _LoaderProgressLock.Initialize;

        with TWinControlProtectedHacker(TWinControl.Create(nil))
          do try CodePointer_TWinControl_MainWndProc := MainWndProc;
        finally Free; end;

        with TUxThemeStyleHack(TUxThemeStyle.Create)
          do try CodePointer_TUxThemeStyle_DoDrawIcon := DoDrawIcon;
        finally Free; end;

        BeginHooks; try

          @Trampoline_TWinControl_MainWndProc :=
          InterceptCreate(@CodePointer_TWinControl_MainWndProc,
          @Detour_TWinControl_MainWndProc);
        @Trampoline_TUxThemeStyle_DoDrawIcon :=
          InterceptCreate(@CodePointer_TUxThemeStyle_DoDrawIcon,
          @Detour_TUxThemeStyle_DoDrawIcon);

        finally EndHooks; end;

        finalization _LoaderProgressLock.Free;
